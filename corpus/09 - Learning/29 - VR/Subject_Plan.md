...
mission: "The applied capstone of the 20–24 chain — VR hardware ecosystems (Quest, Vision Pro, Index, Pico), OpenXR / WebXR app architecture, locomotion + comfort, hand/eye/body tracking, mixed-reality passthrough, architectural visualization in VR, networking + avatars, and turning all of it into a business."
status: active
tags: [vr, virtual-reality, openxr, webxr, quest, vision-pro, mixed-reality, passthrough, archviz, business, applied, subject-plan, curriculum]
type: subject-plan
subject: "29 - VR"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/29 - VR/LEARNING_PATH]]*
...
|---|---|---|
| **VR & 3D Engineering foundations** | [[../28 - VR & 3D Engineering/Subject_Plan]] | Math, shaders, engine architectures |
| 3D modelling / DCC | [[../27 - 3D Modelling/Subject_Plan]] | Revit / Blender → VR pipelines |
| Holographics literacy | [[../31 - Holographics/Subject_Plan]] | Light-field & holographic siblings of VR |
| C# (Unity) | [[../10 - C#/Subject_Plan]] | Quest dev path |
| C++ / Unreal | [[../09 - C++/Subject_Plan]] | High-end Unreal XR |
| TypeScript | [[../13 - TypeScript/Subject_Plan]] | WebXR + three.js / @react-three/xr |
| App architectures | [[../22 - App Architectures & Frameworks/Subject_Plan]] | React / Flutter side of mixed apps |
| Networking / DDS | [[../32 - Robotics/22.5 - ROS 2 & Middleware - Nodes, Topics, Services, Actions, DDS]] | Multi-user VR networking parallels |
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/29 - VR/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[29.1 - VR Hardware Ecosystems & Standards]] - Shared vision-pro/openxr focus
- [[29.2 - Immersive App Architectures - OpenXR, WebXR, Unity XR, Unreal XR]] - Shared openxr/webxr focus
- [[29.5 - Mixed Reality & Passthrough Pipelines]] - Shared mixed-reality/passthrough focus
- [[29.6 - Architectural Visualization in VR - Revit, IFC, USD to Quest & Vision Pro]] - Shared vision-pro/business focus
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/29 - VR/LEARNING_PATH]] - Shared vision-pro/archviz focus
