...
mission: "Make VR social — synchronize sub-20 ms hand-tracking, persistent spatial anchors, voice + spatial audio, avatar IK, and the modern multi-user backends (Photon Fusion, Mirror, Netcode for GameObjects, Microsoft Mesh, Spatial.io)."
status: skeleton
tags: [vr, networking, multiplayer, avatars, photon-fusion, mirror, microsoft-mesh, spatial-io, dds, voip]
chapter: "29.7"
prev: "[[29.6 - Architectural Visualization in VR - Revit, IFC, USD to Quest & Vision Pro]]"
next: "[[29.8 - VR as a Business - Productization, Distribution, Monetization]]"
subject: "29 - VR"
type: chapter
---
...
- [[../32 - Robotics/22.5 - ROS 2 & Middleware - Nodes, Topics, Services, Actions, DDS]]
