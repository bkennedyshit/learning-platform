...
mission: "Understand the kanji system axiomatically — radicals, on/kun'yomi, the vault database — and learn the first 100 N5 kanji with vocabulary"
status: active
tags: [japanese, kanji, jlpt-n5, radicals, chapter]
type: chapter
chapter: "37.3"
prev: "[[37.2 - Katakana — Loanwords & Foreign Names]]"
next: "[[37.4 - Particles & Basic Sentence Structure]]"
---
...
This vault maintains a **first-class kanji database** in `37 - Japanese/_kanji/`. See [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/37 - Japanese/Subject_Plan#6. THE KANJI METHOD]] for full documentation.
...
### The Vault Method
The `_kanji/` database (see [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/37 - Japanese/Subject_Plan#6]]) is the native vault approach. Each kanji is a searchable note with cross-links. Best for integrating kanji with your other vault notes.
...
### Internal Links
- Previous: [[37.2 - Katakana — Loanwords & Foreign Names]]
- Next: [[37.4 - Particles & Basic Sentence Structure]]
- Kanji database: [[_kanji/README]]
