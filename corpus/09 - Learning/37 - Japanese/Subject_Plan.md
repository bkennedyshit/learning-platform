...
mission: "Build adult-learner Japanese proficiency from zero through JLPT N3, with kanji as a first-class searchable database in the vault"
status: planning
tags: [japanese, language-learning, curriculum, subject-plan, kanji, jlpt]
type: subject-plan
---
...
- Radical: [[人 (radical)]]
- Related kanji: [[大]] (big), [[入]] (enter; visually similar — careful)
- JLPT level: [[_index_n5]]
```
...
- **Wikilinks:** any chapter or vocab note can `[[人]]` and Obsidian resolves it.
...
- **Composable with vocabulary:** a vocabulary note can `[[人]]` to backlink to the kanji; kanji notes accumulate examples organically.
...
*Curriculum architect: Bill — adult-learner Japanese track with vault-native kanji subsystem. Cross-links: [[36 - Spanish/Subject_Plan|Track 17 Spanish]] for parallel-structure language tracks; the [[_kanji/README]] documents the kanji method in detail.*
