...
mission: "Build the assembly line: GitHub Actions, GitLab CI, CircleCI, monorepo strategies (Nx, Turborepo, Bazel), caching, matrix builds, supply-chain hardening (Sigstore, SLSA, SBOMs)."
status: skeleton
tags:
  - devops
  - ci-cd
  ...
  - supply-chain
chapter: "20.1"
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/20 - DevOps & SRE/LEARNING_PATH]]"
next: "[[20.2 - Infrastructure as Code]]"
...
| 9 | Observe | Read SLO + error-budget burn rate (see [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]) |
...
### Internal
- [[20.2 - Infrastructure as Code]] — what the pipeline deploys *to*
- [[20.3 - Containers & Orchestration]] — what the build artifact *is*
- [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]] — what gates promotion
- [[20.7 - Deployment Strategies]] — canary, blue-green, feature flags
- [[../18 - Cybersecurity/Subject_Plan]] — supply-chain attacks (SolarWinds, xz)
- [[../01- Python/1.8 - Git & Version Control]] — branching strategies
...
*Next: [[20.2 - Infrastructure as Code]] — Where the cluster, the network, and the database all become code.*
