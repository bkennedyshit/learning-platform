...
mission: "Visual roadmap and progression guide for the DevOps & SRE track"
status: active
tags: [devops, sre, learning-path, roadmap, progression, ci-cd, kubernetes, observability, slo, finops]
type: learning-path
...
*Next: [[20.1 - CI-CD Foundations]] — Where the assembly line begins.*

---

## Related Notes
- [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]] - Shared devops/slo focus
- [[20.3 - Containers & Orchestration]] - Shared kubernetes/devops focus
- [[20.4 - Observability - Logs, Metrics, Traces]] - Shared observability/devops focus
