...
mission: "Inject controlled failure to prove (or improve) resilience. LitmusChaos, Gremlin, Chaos Mesh, AWS Fault Injection Service. Hypothesis → blast radius → revert → analyze. Game days."
status: skeleton
tags: [devops, sre, chaos-engineering, resilience, fault-injection, litmus, gremlin, chaos-mesh, aws-fis, circuit-breakers, bulkheads, gameday]
chapter: "20.6"
prev: "[[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]"
next: "[[20.7 - Deployment Strategies]]"
...
This chapter is the **stress test**. With an SLO ([[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]) and observability ([[20.4 - Observability - Logs, Metrics, Traces]]) in place, you can now do the most counter-intuitively useful thing in production engineering: deliberately inject failure to verify that your system survives it.
...
5. Distinguish **chaos engineering** from **load testing** ([[20.7 - Deployment Strategies]] uses both for canary analysis).
...
| 2. Roles | IC, ops lead, scribe, observers (see [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]) |
...
### Internal
- [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]] — the SLI you read during the experiment
- [[20.4 - Observability - Logs, Metrics, Traces]] — the dashboards you watch
- [[20.7 - Deployment Strategies]] — canary analysis is mini-chaos on a single deploy
- [[../19 - System Design & Distributed Architecture/Subject_Plan]] — circuit breakers, bulkheads, etc.
...
*Next: [[20.7 - Deployment Strategies]] — Where you ship safely under the resilience you just verified.*
