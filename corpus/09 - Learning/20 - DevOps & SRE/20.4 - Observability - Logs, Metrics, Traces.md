...
mission: "OpenTelemetry (CNCF Graduated 2026, now THE vendor-neutral standard) + Prometheus + Grafana + Loki + Tempo + Sentry + Honeycomb. Includes 2026's GenAI observability semantic conventions for LLM and agent traces."
status: skeleton
tags: [devops, observability, opentelemetry, otel, prometheus, grafana, loki, tempo, jaeger, signoz, sentry, honeycomb, structured-logging, genai-observability, llm-observability]
chapter: "20.4"
prev: "[[20.3 - Containers & Orchestration]]"
next: "[[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]"
...
This chapter is the **nervous system** of the track. You can't run an SLO ([[20.5 - SLOs, SLAs, Error Budgets & Incident Response]]), you can't run a chaos experiment ([[20.6 - Chaos Engineering & Resilience]]), and you can't run a canary ([[20.7 - Deployment Strategies]]) without it. The 2026 reality: **OpenTelemetry graduated from CNCF in May 2026** and is now the de-facto vendor-neutral standard for traces, metrics, and logs — with new GenAI semantic conventions that make LLM and agent calls first-class spans.
...
Why this matters: a slow LLM endpoint, a retrieval that returned the wrong chunks, or a tool that loops are all now visible in the same trace UI as your HTTP handler. See [[../23 - AI & Machine Learning Systems/10.5 - Transformer Architectures & LLMs]] for the model side.
...
That recording rule becomes the SLI for an availability SLO in [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]].
...
### Internal
- [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]] — what you build *with* metrics
- [[20.6 - Chaos Engineering & Resilience]] — what you observe *during* a fault injection
- [[20.7 - Deployment Strategies]] — canary analysis reads from here
- [[20.8 - Cost & Capacity Engineering - FinOps]] — observability has its own cost curve
- [[../23 - AI & Machine Learning Systems/10.5 - Transformer Architectures & LLMs]] — the LLM side of GenAI observability
...
*Next: [[20.5 - SLOs, SLAs, Error Budgets & Incident Response]] — Where these signals become a contract.*
