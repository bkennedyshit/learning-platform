...
mission: "Translate architecture-CAD intuition into mechanical-engineering CAD: the Fusion 360 timeline, parametric features, assemblies + joints, and the integrated CAM/CAE/PCB workflow."
status: skeleton
tags: [3d-modelling, fusion-360, parametric-cad, cam, assemblies, joints, autodesk]
chapter: "27.4"
prev: "[[27.3 - Advanced Revit - Families, Adaptive Components & Dynamo]]"
next: "[[27.5 - Maya & 3ds Max - DCC, Animation & Arch-Viz Rendering]]"
...
### Internal
- [[27.1 - 3D Modelling Foundations & Coordinate Systems]] — B-rep representation
- [[27.7 - SolidWorks - Mechanical CAD, Assemblies & Simulation]] — the engineering-grade sibling
- [[27.8 - Pipelines, Interop & Productization - From Architecture to Business]] — STEP/IGES exchange
- [[22.4 - Actuators & Motor Control]] — designing mechanical parts for robots in Fusion
