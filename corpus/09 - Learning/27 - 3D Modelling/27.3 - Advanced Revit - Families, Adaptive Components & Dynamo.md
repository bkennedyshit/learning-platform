...
mission: "Move from competent Revit modeler to advanced BIM author: parametric families, adaptive components for non-orthogonal geometry, Dynamo visual programming with CPython 3 (Dynamo 3.5)."
status: skeleton
tags: [3d-modelling, revit, advanced, families, adaptive-components, dynamo, computational-design, parametric]
chapter: "27.3"
prev: "[[27.2 - Autodesk Revit Fundamentals]]"
next: "[[27.4 - Autodesk Fusion 360 - Parametric Modelling & CAM]]"
...
### Internal
- [[27.2 - Autodesk Revit Fundamentals]] — fundamentals you need first
- [[27.8 - Pipelines, Interop & Productization - From Architecture to Business]] — selling Dynamo packages and Revit add-ins
- [[08.2 - Core Language - Syntax, Types, Control Flow & Functions]] — Python skills for Dynamo CPython
- [[3 - C hash/Subject_Plan]] — C# foundations for the Revit API
