...
mission: "Master Blender 4.4 — modelling, sculpting, shading, Cycles/EEVEE rendering, and the Geometry Nodes procedural system that has made Blender the open-source DCC powerhouse of 2026."
status: skeleton
tags: [3d-modelling, blender, geometry-nodes, sculpting, cycles, eevee, open-source, procedural]
chapter: "27.6"
prev: "[[27.5 - Maya & 3ds Max - DCC, Animation & Arch-Viz Rendering]]"
next: "[[27.7 - SolidWorks - Mechanical CAD, Assemblies & Simulation]]"
...
### Internal
- [[27.5 - Maya & 3ds Max - DCC, Animation & Arch-Viz Rendering]] — paid DCC siblings
- [[27.8 - Pipelines, Interop & Productization - From Architecture to Business]] — selling Blender add-ons / asset packs
- [[08.6 - The Standard Library & Ecosystem Tour]] — Python skills you'll need for `bpy`
