...
mission: Understand how languages run without direct compilation to native code. Master stack-based VMs, CPython bytecode, JIT compilation tiers, garbage collection strategies, and WebAssembly.
status: active
tags:
  - compilers
  - virtual-machines
  ...
  - interpreter
chapter: "15.8"
prev: "[[15.7 - Optimization Passes]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/README]]"
...
Rust's approach: **no garbage collector at all**. The borrow checker (see [[15.4 - Type Systems & Type Checking|15.4]]) tracks ownership statically. When an owner goes out of scope, the compiler inserts a destructor call (the `Drop` trait).
...
### Internal
- [[15.5 - Intermediate Representations & IR Design]] — the IR that VMs and JITs use internally
- [[15.7 - Optimization Passes]] — JIT applies many of the same passes as AOT compilers
- [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] — Python's GIL and memory model
- [[../23 - AI & Machine Learning Systems/Subject_Plan]] — ML runtimes (XLA, TVM, TorchScript)
...
*Back to: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/README]] — Subject Hub | [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/Subject_Plan]] — Full curriculum | [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/LEARNING_PATH]] — Roadmap*
