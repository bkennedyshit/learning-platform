...
mission: "Design and traverse ASTs. Implement the visitor pattern, build symbol tables with nested scopes, and understand the semantic passes that turn a tree into a verified program."
status: active
tags: [compilers, ast, abstract-syntax-tree, semantic-analysis, visitor-pattern, symbol-table, scope, name-resolution, type-checking, python]
chapter: "15.3"
prev: "[[15.2 - Parsers & Grammars]]"
next: "[[15.4 - Type Systems & Type Checking]]"
...
- See [[15.4 - Type Systems & Type Checking|15.4]] for full detail
...
- See [[15.5 - Intermediate Representations & IR Design|15.5]] for more on MIR
...
**Step 5 — Annotated AST feeds IR generation** → see [[15.5 - Intermediate Representations & IR Design|15.5]]
...
### Internal
- [[15.2 - Parsers & Grammars]] — how the AST is built
- [[15.4 - Type Systems & Type Checking]] — next pass on the AST
- [[15.5 - Intermediate Representations & IR Design]] — what the AST is lowered to
- [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] — Python internals
...
*Next: [[15.4 - Type Systems & Type Checking]] — Adding the type layer to the AST.*
