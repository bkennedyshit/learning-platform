...
date: 2026-05-26
type: subject-readme
tags: [practice, refresher, drills, source-materials, study-aids, compilers, language-design, lexers, parsers, ast, llvm, jit, type-systems]
...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/comp__<chapter>-fig<n>.svg` and embedded inline via `![[comp__29.x-figN.svg]]`.
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/Subject_Plan]]
- Visual roadmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/LEARNING_PATH]]
- Python internals: [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
- C++ templates & codegen: [[../09 - C++/Subject_Plan]]
- Rust borrow checker: [[../11 - Rust/Subject_Plan]]
- TypeScript type system: [[../13 - TypeScript/Subject_Plan]]
- AI/ML code-analysis tooling: [[../23 - AI & Machine Learning Systems/Subject_Plan]]
- Game Dev scripting VMs: [[../26 - Game Dev/Subject_Plan]]
- System Design (IR design ≈ API design): [[../19 - System Design & Distributed Architecture/Subject_Plan]]
