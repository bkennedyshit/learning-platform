...
mission: "Understand how a compiler turns IR into runnable machine code. Master instruction selection, register allocation as graph colouring, calling conventions, and read real x86-64 assembly."
status: active
tags: [compilers, codegen, code-generation, instruction-selection, register-allocation, graph-colouring, calling-conventions, x86-64, assembly, llvm-backend]
chapter: "15.6"
prev: "[[15.5 - Intermediate Representations & IR Design]]"
next: "[[15.7 - Optimization Passes]]"
...
### Internal
- [[15.5 - Intermediate Representations & IR Design]] — the IR that this pass consumes
- [[15.7 - Optimization Passes]] — passes that run before or after instruction selection
- [[../09 - C++/Subject_Plan]] — understanding C++ compilation
...
*Next: [[15.7 - Optimization Passes]] — Teaching the compiler to make your code faster.*
