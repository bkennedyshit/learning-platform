...
mission: "Understand how type systems catch bugs at compile time. Master Hindley-Milner type inference, unification, subtyping, generics, and see how TypeScript, Rust, and Python all differ."
status: active
tags: [compilers, type-systems, type-checking, hindley-milner, unification, subtyping, generics, typescript, rust, python, static-typing]
chapter: "15.4"
prev: "[[15.3 - Abstract Syntax Trees & Semantic Analysis]]"
next: "[[15.5 - Intermediate Representations & IR Design]]"
...
### Internal
- [[15.3 - Abstract Syntax Trees & Semantic Analysis]] — the AST that the type checker walks
- [[15.5 - Intermediate Representations & IR Design]] — after type-checking, lowering to IR
- [[../13 - TypeScript/Subject_Plan]] — TypeScript structural type system in depth
- [[../11 - Rust/Subject_Plan]] — Rust borrow checker and lifetime system
...
*Next: [[15.5 - Intermediate Representations & IR Design]] — From verified AST to machine-neutral code.*
