...
mission: "Build the decoder ring for every language you know. Lexers → parsers → ASTs → type systems → IR → codegen → optimization → VMs. The track that turns 7 languages from tools into transparent machines — and directly powers your AI tooling and LLM code-analysis work."
status: active
tags: [compilers, language-design, lexers, parsers, ast, type-systems, ir, ssa, llvm, codegen, optimization, virtual-machines, jit, subject-plan, curriculum]
type: subject-plan
subject: "15 - Compilers & Language Design"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/LEARNING_PATH]]*
...
|---|---|---|
| Python fluency | [[../01- Python/Subject_Plan]] | All small compiler examples are in Python |
| Data structures | [[../01- Python/1.3 - Data Structures - Lists, Dicts, Sets, Tuples]] | Trees, stacks, hash maps are the building blocks of compilers |
| Recursion & functional patterns | Python / general | Recursive descent parsers *are* recursion |
| Basic graph theory | [[../07 - Math and Physics/Subject_Plan]] (discrete math) | CFG = directed graph; register allocation = graph colouring |
| Any compiled language (C++, Rust, C#) | [[../09 - C++/Subject_Plan]] / [[../11 - Rust/Subject_Plan]] | Concrete feel for what the compiler must produce |
...
> Pictures, videos, and reference materials live **outside the repo** (YouTube, official docs, open-source books). Chapter files and the [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/README]] hub link to them by URL. SVG diagrams we author live inside `../_svgs/` with the `comp__<ch>-fig<n>.svg` prefix.
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/15 - Compilers & Language Design/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[15.5 - Intermediate Representations & IR Design]] - Shared compilers/ssa focus
- [[15.8 - Virtual Machines, Bytecode & JIT]] - Shared virtual-machines/compilers focus
- [[15.1 - Lexers & Tokenization]] - Shared compilers/lexers focus
