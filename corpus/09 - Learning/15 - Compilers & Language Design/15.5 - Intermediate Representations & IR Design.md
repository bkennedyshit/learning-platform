...
mission: "Understand how compilers lower a verified AST into machine-neutral intermediate forms. Master three-address code, SSA form, control-flow graphs, phi nodes, and read real LLVM IR."
status: active
tags: [compilers, ir, intermediate-representation, ssa, three-address-code, cfg, phi-nodes, llvm-ir, mlir, dataflow]
chapter: "15.5"
prev: "[[15.4 - Type Systems & Type Checking]]"
next: "[[15.6 - Code Generation & Backends]]"
...
Liveness is used by the register allocator (see [[15.6 - Code Generation & Backends|15.6]]) and by dead-code elimination (see [[15.7 - Optimization Passes|15.7]]).
...
### Internal
- [[15.4 - Type Systems & Type Checking]] — the type-checked AST that IR is lowered from
- [[15.6 - Code Generation & Backends]] — what LLVM IR is lowered into
- [[15.7 - Optimization Passes]] — passes that run on the IR
...
*Next: [[15.6 - Code Generation & Backends]] — From IR to real machine instructions.*
