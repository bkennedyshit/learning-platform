...
mission: "Understand how compilers make code faster without changing its meaning. Master constant folding, dead code elimination, function inlining, LICM, and loop vectorisation."
status: active
tags: [compilers, optimization, constant-folding, dead-code-elimination, inlining, licm, loop-optimization, vectorization, llvm-passes, profile-guided-optimization]
chapter: "15.7"
prev: "[[15.6 - Code Generation & Backends]]"
next: "[[15.8 - Virtual Machines, Bytecode & JIT]]"
...
Optimizations operate on IR (the SSA/CFG form from [[15.5 - Intermediate Representations & IR Design|15.5]]) and are organized into **passes** — each pass walks the IR and makes a specific kind of transformation. LLVM's `-O2` pipeline runs **dozens** of passes in a specific order.
...
### Internal
- [[15.5 - Intermediate Representations & IR Design]] — the IR that these passes transform
- [[15.6 - Code Generation & Backends]] — after optimization, instruction selection runs
- [[15.8 - Virtual Machines, Bytecode & JIT]] — JIT applies similar passes at runtime
...
*Next: [[15.8 - Virtual Machines, Bytecode & JIT]] — The runtime story: how code executes without direct compilation.*
