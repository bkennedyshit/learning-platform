...
mission: "Master IMU sensor fusion algorithms for tracking human movement orientation and acceleration"
status: complete
tags: [biomechanics, sensor-fusion, IMU, accelerometer, gyroscope, Kalman-filter, quaternion, complementary-filter]
chapter: "34.5"
prev: "[[34.4 - Autonomic Nervous System Telemetry - HRV]]"
next: "[[34.6 - Human-Computer Interfaces - HCI Design]]"
type: chapter-note
---
...
- [[4.7 - Rigid Body Dynamics & Euler Angles]] — Euler angles and rotation matrices
- [[34.2 - Rotational Dynamics in Extreme Sports]] — The rotations we're measuring
- [[34.1 - Kinematics of Human Movement]] — Position/velocity from integrated IMU data
- [[34.7 - Building Bio-metric Software Applications]] — Deploying sensor fusion in apps
- [[1.6 - Vector Fields, Div & Curl]] — Vector calculus for angular velocity fields
