...
mission: Architect and implement complete bio-tracking applications from BLE sensor to cloud analytics
status: complete
tags:
  - biomechanics
  ...
  - data-pipeline
chapter: "34.7"
prev: "[[34.6 - Human-Computer Interfaces - HCI Design]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/34 - Biomechanics & HCI/Subject_Plan]]"
type: chapter-note
---
...
- [[34.4 - Autonomic Nervous System Telemetry - HRV]] — HRV algorithms implemented here
- [[34.5 - Sensor Fusion - Accelerometers & Gyroscopes]] — IMU data pipeline
- [[34.6 - Human-Computer Interfaces - HCI Design]] — UI/UX principles applied
- [[34.3 - Cardiovascular Bioenergetics & VO2 Max]] — VO2 estimation from HR data
- [[05 - Neuroscience & Computational Cognition]] — Neural basis of biofeedback
