...
mission: "Master HCI principles for designing bio-tracking interfaces that leverage human cognitive and motor capabilities"
status: complete
tags: [HCI, user-interface, Fitts-law, Nielsen-heuristics, bio-tracking, UX-design, accessibility]
chapter: "34.6"
prev: "[[34.5 - Sensor Fusion - Accelerometers & Gyroscopes]]"
next: "[[34.7 - Building Bio-metric Software Applications]]"
type: chapter-note
---
...
- [[34.7 - Building Bio-metric Software Applications]] — Implementing these HCI principles in code
- [[34.4 - Autonomic Nervous System Telemetry - HRV]] — The data being displayed
- [[06 - Behavioral Psychology & Reinforcement Learning]] — Cognitive models underlying HCI
- [[05 - Neuroscience & Computational Cognition]] — Neural basis of attention and memory
