...
tags:
  ...
  - server-components
chapter: 22.1
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/22 - App Architectures & Frameworks/Subject_Plan]]"
next: "[[22.2 - Angular - Class-based Architecture & RxJS]]"
---
...
- [[22.2 - Angular - Class-based Architecture & RxJS]] — Compare React's unidirectional flow with Angular's two-way binding and zone-based change detection.
- [[22.3 - Vite & Modern Build Tools]] — Understand the bundler that powers React development (Vite replaces Create React App).
- [[22.5 - Flutter & Dart - Widget Tree, Isolates & Custom Painters]] — Flutter's widget tree is conceptually similar to React's component tree, but with a three-layer architecture (Widget → Element → RenderObject).
- [[23.5 - Transformer Architectures & LLMs]] — AI-frontend integration: streaming LLM responses into React components via Server-Sent Events.
