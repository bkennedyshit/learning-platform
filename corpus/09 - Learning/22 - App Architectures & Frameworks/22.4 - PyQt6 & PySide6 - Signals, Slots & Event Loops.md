---
tags: [pyqt6, pyside6, qt, signals-slots, event-loop, qthread, qpainter, model-view]
chapter: 22.4
prev: "[[22.3 - Vite & Modern Build Tools]]"
next: "[[22.5 - Flutter & Dart - Widget Tree, Isolates & Custom Painters]]"
---
...
- [[22.1 - React & Next.js - Functional Components & Hooks]] — Compare Qt's signal/slot with React's event handlers and state updates.
- [[22.5 - Flutter & Dart - Widget Tree, Isolates & Custom Painters]] — Flutter's CustomPainter is conceptually similar to QPainter; compare the rendering models.
- [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] — Matrix math relevant to QPainter coordinate transforms (rotation, scaling, shearing).
- [[28.1 - 3D Math Fundamentals]] — 3D transforms in QOpenGLWidget for hardware-accelerated rendering.
