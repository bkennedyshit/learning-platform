...
tags:
  ...
  - skia
chapter: 22.5
prev: "[[22.4 - PyQt6 & PySide6 - Signals, Slots & Event Loops]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/22 - App Architectures & Frameworks/Subject_Plan]]"
---
...
- [[22.1 - React & Next.js - Functional Components & Hooks]] — Compare Flutter's widget rebuild with React's VDOM reconciliation. Both use tree diffing, but Flutter has three trees vs React's two.
- [[22.4 - PyQt6 & PySide6 - Signals, Slots & Event Loops]] — Compare CustomPainter with QPainter. Both provide immediate-mode 2D drawing APIs with similar primitives (paths, arcs, transforms).
- [[28.1 - 3D Math Fundamentals]] — Matrix transforms in CustomPainter: `canvas.transform()` accepts a Float64List representing a 4×4 matrix.
- [[23.5 - Transformer Architectures & LLMs]] — Running ML models in Flutter via `tflite_flutter` or Dart FFI to ONNX Runtime.
...
*← Previous: [[22.4 - PyQt6 & PySide6 - Signals, Slots & Event Loops]] | Back to [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/22 - App Architectures & Frameworks/Subject_Plan]]*
