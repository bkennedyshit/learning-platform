...
mission: "Master the real-time web: WebSocket upgrade handshake and frame protocol, SSE event format, and WebRTC's complete ICE/STUN/TURN/SDP pipeline for peer-to-peer audio, video, and data. Critical for multiplayer games, VR, and live collaboration tools."
status: active
tags: [networking, websocket, sse, webrtc, ice, stun, turn, sdp, real-time, p2p, dtls, srtp, datachannel]
chapter: "17.6"
prev: "[[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]]"
next: "[[17.7 - gRPC, Protocol Buffers & Service Mesh]]"
...
### Internal
- [[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]] — WebSocket runs over HTTP/1.1; SSE over HTTP/1.1 or HTTP/2
- [[17.4 - TLS, mTLS & PKI]] — TLS wraps WebSocket (WSS); DTLS wraps WebRTC
- [[17.3 - TCP & UDP Deep Dive]] — WebSocket is TCP; WebRTC DataChannel is UDP (SCTP/DTLS)
- [[../19 - System Design & Distributed Architecture/27.7 - Real-Time Systems]] — CRDTs, presence, netcode patterns
- [[../29 - VR/Subject_Plan]] — VR streaming architecture
- [[../26 - Game Dev/Subject_Plan]] — game netcode implementation
...
*Next: [[17.7 - gRPC, Protocol Buffers & Service Mesh]] — Efficient RPC for microservices.*
