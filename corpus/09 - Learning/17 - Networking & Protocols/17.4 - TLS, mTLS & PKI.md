...
mission: "Master TLS 1.3 from first principles: every handshake message, ECDHE key exchange, HKDF key schedule, certificate chain verification, 0-RTT resumption, and mTLS for zero-trust service mesh."
status: active
tags: [networking, tls, mtls, pki, certificates, x509, ecdhe, handshake, tls-1.3, ocsp, service-mesh, zero-trust]
chapter: "17.4"
prev: "[[17.3 - TCP & UDP Deep Dive]]"
next: "[[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]]"
...
### Internal
- [[17.3 - TCP & UDP Deep Dive]] — TLS runs over TCP (adds 1 RTT to TCP's 1 RTT)
- [[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]] — QUIC has TLS 1.3 built-in
- [[17.7 - gRPC, Protocol Buffers & Service Mesh]] — mTLS in Istio/Linkerd
- [[../18 - Cybersecurity/Subject_Plan]] — PKI security, certificate attacks, CT
...
*Next: [[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]] — The application protocols that run over TLS.*
