...
mission: "See the wire. TCP handshakes, TLS key exchange, HTTP/2 multiplexing, QUIC 0-RTT, WebRTC ICE, gRPC streaming, mTLS — every packet on every hop. Critical for multiplayer game netcode, VR streaming, distributed AI inference, and every SaaS product you ship."
status: active
tags: [networking, protocols, tcp, udp, tls, http, quic, websockets, webrtc, grpc, bgp, ddos, subject-plan, curriculum]
type: subject-plan
subject: "17 - Networking & Protocols"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/17 - Networking & Protocols/LEARNING_PATH]]*
...
This track fills the gap between [[../19 - System Design & Distributed Architecture/Subject_Plan|Track 27]] (architecture) and the raw physical reality of data moving through networks. Where Track 27 teaches you *what to build*, Track 17 teaches you *how the wire actually works beneath every abstraction you rely on*.
...
|---|---|---|
| Computer Networks Essentials | [[../01- Python/1.11 - Computer Networks Essentials]] | Existing foundation — this track deepens it dramatically |
| OS Essentials (sockets, syscalls) | [[../01- Python/1.10 - Operating Systems Essentials]] | TCP is implemented in the kernel; sockets are the userland abstraction |
| Concurrency & async I/O | [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] | Every server is async I/O on sockets; understanding the event loop matters |
| System Design fundamentals | [[../19 - System Design & Distributed Architecture/Subject_Plan]] | CAP, PACELC, latency numbers give meaning to the measurements in this track |
| Cybersecurity basics | [[../18 - Cybersecurity/Subject_Plan]] | TLS and PKI concepts overlap; network security prereqs |
| Distributed Systems | [[../01- Python/1.16 - Distributed Systems & Multi-GPU Training]] | RPC, pub/sub patterns contextualize gRPC and protobuf |
...
gRPC is the wire for internal microservices. protobuf is 10× smaller and faster than JSON for game state. Service mesh (Istio/Linkerd) is how you get mTLS, retries, and observability "for free" at the infrastructure level. The DDoS chapter rounds out your network security picture from [[../18 - Cybersecurity/Subject_Plan|Track 25]].
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/17 - Networking & Protocols/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[17.3 - TCP & UDP Deep Dive]] - Shared networking/udp focus
- [[08.11 - Computer Networks Essentials]] - Shared networking/http focus
- [[17.2 - IP, Routing & BGP]] - Shared networking/bgp focus
- [[17.4 - TLS, mTLS & PKI]] - Shared networking/tls focus
