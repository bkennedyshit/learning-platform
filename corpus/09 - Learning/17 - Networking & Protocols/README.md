...
date: 2026-05-28
type: subject-readme
tags: [networking, protocols, tcp, udp, tls, quic, http, websockets, webrtc, grpc, bgp, ddos, practice, refresher, source-materials]
...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/net__<chapter>-fig<n>.svg` and embedded inline via `![[net__31.x-figN.svg]]`.
...
- [[17.4 - TLS, mTLS & PKI]]
- [[17.5 - HTTP/1.1, HTTP/2 & HTTP/3 (QUIC)]]
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/17 - Networking & Protocols/Subject_Plan]]
- Visual roadmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/17 - Networking & Protocols/LEARNING_PATH]]
- OS & sockets prerequisite: [[../01- Python/1.10 - Operating Systems Essentials]]
- Networking intro (Python track): [[../01- Python/1.11 - Computer Networks Essentials]]
- Concurrency & async I/O: [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
- Distributed systems: [[../01- Python/1.16 - Distributed Systems & Multi-GPU Training]]
- System Design (architecture layer above): [[../19 - System Design & Distributed Architecture/Subject_Plan]]
- Cybersecurity (network attack surface): [[../18 - Cybersecurity/Subject_Plan]]
- DevOps & SRE (mesh, k8s networking): [[../20 - DevOps & SRE/Subject_Plan]]
- Cloud Platforms (VPC, transit gateways): [[../21 - Cloud Platforms/Subject_Plan]]
- VR (WebRTC, QUIC streaming): [[../29 - VR/Subject_Plan]]
- Game Dev (netcode): [[../26 - Game Dev/Subject_Plan]]
