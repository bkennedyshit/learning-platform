...
mission: "Understand the HTTP protocol family deeply: HTTP/1.1 keep-alive and its limitations, HTTP/2 binary framing and stream multiplexing with HPACK, and HTTP/3 QUIC's 0-RTT connection, connection migration, and elimination of TCP head-of-line blocking."
status: active
tags: [networking, http, http2, http3, quic, multiplexing, hpack, qpack, server-push, connection-migration, 0-rtt]
chapter: "31.5"
prev: "[[17.4 - TLS, mTLS & PKI]]"
next: "[[17.6 - WebSockets, SSE & WebRTC]]"
subject: "31 - Networking & Protocols"
type: chapter
---

*Back to [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/10 - C#/Subject_Plan]] | Part of [[00 - 09 - Learning Index]]*
...
**As with TLS 1.3 0-RTT**, this is only safe for idempotent operations (see [[17.4 - TLS, mTLS & PKI]]).
...
### Internal
- [[17.4 - TLS, mTLS & PKI]] — TLS 1.3 is integral to QUIC; 0-RTT discussed in depth there
- [[17.3 - TCP & UDP Deep Dive]] — TCP congestion control and HOL blocking that HTTP/2 and HTTP/3 address
- [[17.6 - WebSockets, SSE & WebRTC]] — WebSocket and WebRTC are separate from HTTP; when to use each
- [[17.7 - gRPC, Protocol Buffers & Service Mesh]] — gRPC runs over HTTP/2 (and increasingly HTTP/3)
- [[../27 - System Design & Distributed Architecture/27.2 - Caching, CDNs & Edge]] — CDNs serve HTTP/3
...
*Next: [[17.6 - WebSockets, SSE & WebRTC]] — Real-time bidirectional and peer-to-peer communication.*
