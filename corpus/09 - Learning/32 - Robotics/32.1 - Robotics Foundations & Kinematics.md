...
mission: Build the universal vocabulary — frames, transforms, screws, twists, DH parameters — that the rest of robotics is written in.
status: skeleton
tags:
  - robotics
  - kinematics
  ...
  - foundations
chapter: "32.1"
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/32 - Robotics/LEARNING_PATH]]"
next: "[[32.2 - Forward & Inverse Kinematics]]"
subject: 32 - Robotics
type: chapter
---
...
### Internal
- [[2.4 - Linear Maps & Matrix Algebra]]
