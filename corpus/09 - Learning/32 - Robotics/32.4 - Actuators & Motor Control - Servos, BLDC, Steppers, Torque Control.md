...
mission: "Pick and drive the right actuator — hobby servo / BLDC + FOC / stepper / direct-drive torque motor — and close position, velocity, and torque loops with PID, LQR, and modern impedance / admittance control."
status: skeleton
tags: [robotics, actuators, motor-control, foc, bldc, stepper, servo, torque-control, impedance, pid, lqr]
chapter: "32.4"
prev: "[[32.3 - Sensors & Perception - IMU, LiDAR, Cameras, Encoders]]"
next: "[[32.5 - ROS 2 & Middleware - Nodes, Topics, Services, Actions, DDS]]"
subject: "32 - Robotics"
type: chapter
---
...
### Internal
- [[32.2 - Forward & Inverse Kinematics]] — joints' job description
- [[32.7 - Manipulation & Grasping - MoveIt, GraspNet, Whole-body Control]]
- [[../30 - Electronics/21.7 - Power Electronics & Motor Drivers - PWM, H-Bridges, BLDC, Regulators]]
- [[../07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan]]
