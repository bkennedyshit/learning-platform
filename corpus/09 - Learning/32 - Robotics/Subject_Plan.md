...
mission: "From electronics + sensors → kinematics → control → ROS 2 → SLAM → manipulation → humanoids/drones. A modern robotics curriculum aligned with the 2026 humanoid-robotics inflection point (Boston Dynamics Atlas, Figure 03, Tesla Optimus Gen 3, Unitree G1)."
status: active
tags: [robotics, kinematics, ros2, slam, navigation, manipulation, humanoids, drones, control-systems, subject-plan, curriculum]
type: subject-plan
subject: "32 - Robotics"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/32 - Robotics/LEARNING_PATH]]*
...
This curriculum is built on the **prerequisites you already have**: electronics ([[../30 - Electronics/Subject_Plan|Track 21]]), Python ([[Bill's Vault/05-Knowledge_Foundation/09 - Learning/08 - Python/Subject_Plan|Track 01]]), 3D math ([[../28 - VR & 3D Engineering/Subject_Plan|Track 09]]), control theory + dynamics ([[../07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan|Math/Phys 11]], [[../07 - Math and Physics/04 - Classical Mechanics & Dynamical Systems/Subject_Plan|Math/Phys 04]]).
...
|---|---|---|
| Electronics & buses | [[../30 - Electronics/Subject_Plan]] | A robot is still a microcontroller talking to motors and sensors |
| Linear algebra | [[2 - Linear Algebra & Matrix Theory/Subject_Plan]] | Every transform is a matrix; Jacobians, SVD for IK |
| Calculus / ODEs | [[1 - Mathematical Foundations & Calculus/Subject_Plan]], [[3 - Ordinary & Partial Differential Equations/Subject_Plan]] | Equations of motion, control loops |
| Classical mechanics | [[../07 - Math and Physics/04 - Classical Mechanics & Dynamical Systems/Subject_Plan]] | Lagrangian + Newton-Euler dynamics |
| Control theory | [[../07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan]] | PID, LQR, MPC |
| 3D math + quaternions | [[28.1 - 3D Math Fundamentals]], [[28.2 - Quaternions & Rotations]] | SE(3), orientation |
| Python | [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/08 - Python/Subject_Plan]] | ROS 2 rclpy, perception scripting |
| C++ | [[../09 - C++/Subject_Plan]] | ROS 2 rclcpp, real-time nodes |
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/32 - Robotics/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[32.6 - SLAM & Autonomous Navigation - ORB-SLAM3, Cartographer, Nav2]] - Shared navigation/robotics focus
- [[32.8 - Humanoids, Drones & The Future of Robotics]] - Shared humanoids/robotics focus
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/32 - Robotics/LEARNING_PATH]] - Shared manipulation/humanoids focus
- [[32.1 - Robotics Foundations & Kinematics]] - Shared kinematics/robotics focus
- [[32.2 - Forward & Inverse Kinematics]] - Shared kinematics/robotics focus
