...
mission: "Hand-curated progression through the Python curriculum with timing, prerequisites, and parallel work recommendations"
status: stable
tags: [python, learning-path, curriculum, hand-curated]
type: learning-path
---
...
|-------|---------|-----------|
| 1 | [[08.1 - Setup, Tooling & Project Structure]] | Foundation — can't build without tools |
| 2 | [[08.2 - Core Language - Syntax, Types, Control Flow & Functions]] | The language itself — everything else builds on this |
| 3 | [[08.3 - OOP, Data Models & Pythonic Idioms]] | Python's object model is unique; understanding `__dunder__` methods unlocks the language |
| 4 | [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] | Early exposure — you'll need async for any modern Python work |
| 5 | [[08.5 - Testing, Debugging & Logging]] | Before you write more code, learn to verify it |
| 6 | [[08.6 - The Standard Library & Ecosystem Tour]] | Know what's already built before you pip install |
...
| Order | Chapter | Rationale |
|-------|---------|-----------|
| 7 | [[08.7 - Shell, Terminal & Cross-Platform CLI]] | You need shell fluency for everything that follows |
| 8 | [[08.8 - Git & Version Control]] | Version control is non-negotiable for professional work |
| 9 | [[08.9 - Docker & Containers]] | Reproducible environments — critical for ML pipelines |
| 10 | [[08.10 - Operating Systems Essentials]] | Understand what's under your Python process |
| 11 | [[08.11 - Computer Networks Essentials]] | HTTP, TCP, DNS — the substrate of distributed systems |
| 12 | [[08.12 - Computer Architecture - Performance Intuition]] | Cache lines, branch prediction, SIMD — why some Python is 100x slower |
...
| Order | Chapter | Rationale |
|-------|---------|-----------|
| 13 | [[08.13 - Algorithms & Data Structures in Python]] | The interview gate AND the foundation for ML optimization |
| 14 | [[08.14 - Concurrency Models & Patterns]] | Deep dive — actor models, CSP, lock-free structures for production systems |
...
| Order | Chapter | Rationale |
|-------|---------|-----------|
| 15 | [[08.15 - GPU Computing & CUDA Foundations]] | The hardware that trains LLMs — understand it at the kernel level |
| 16 | [[08.16 - Distributed Systems & Multi-GPU Training]] | Scale from 1 GPU to a cluster — FSDP, ZeRO, NCCL |
...
| Phase 4 (GPU/Distributed) | AI/ML Track: [[23.5 - Transformer Architectures & LLMs]] | Apply GPU knowledge to actual model training |
...
## Related Notes
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/08 - Python/Subject_Plan]] - Shared curriculum/python focus
