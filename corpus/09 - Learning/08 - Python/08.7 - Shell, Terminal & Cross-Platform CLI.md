...
mission: "Master shell fundamentals, subprocess management, and cross-platform CLI development for Python automation"
status: active
tags: [python, shell, terminal, CLI, subprocess, bash, powershell, cross-platform]
type: chapter
chapter: 08.7
prev: "[[08.6 - The Standard Library & Ecosystem Tour]]"
next: "[[08.8 - Git & Version Control]]"
---
...
- Next: [[08.8 - Git & Version Control]]
- OS internals: [[08.10 - Operating Systems Essentials]]
...
if [[ -f $file ]]; then   # Works in [[ ]] (bash-specific, no splitting)
