...
mission: "Master fundamental algorithms and data structures with Python implementations — the interview gate and the ML optimization foundation"
status: active
tags: [python, algorithms, data-structures, complexity, sorting, graphs, dynamic-programming]
type: chapter
chapter: 08.13
prev: "[[08.12 - Computer Architecture - Performance Intuition]]"
next: "[[08.14 - Concurrency Models & Patterns]]"
---
...
- Previous: [[08.12 - Computer Architecture - Performance Intuition]]
- Next: [[08.14 - Concurrency Models & Patterns]]
- Existing: [[Common Algorithms for Coding Tests]]
- Math: [[08.1 - Real Numbers, Sequences & Limits]] (Big-O uses limits)
- ML connection: [[23.5 - Transformer Architectures & LLMs]] (attention is O(n²))
