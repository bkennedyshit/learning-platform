...
mission: "Build a professional testing discipline with pytest, property-based testing, structured logging, and systematic debugging techniques"
status: active
tags: [python, testing, pytest, debugging, logging, hypothesis, TDD]
type: chapter
chapter: 08.5
prev: "[[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]"
next: "[[08.6 - The Standard Library & Ecosystem Tour]]"
---
...
- Previous: [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
- Next: [[08.6 - The Standard Library & Ecosystem Tour]]
- Existing reference: [[Python Error Handling]], [[Debugging Strategies for Coding Tests]]
