...
mission: Master modern JavaScript (ES6+) syntax, array methods, async patterns, and DOM manipulation for technical interviews
status: reference
tags: [javascript, es6, coding-tests, web-development, async, dom]
type: learning-note
---
...
Object.entries(obj)        // [["name", "Billy"], ["age", 33]]
...
- [[Python Lists & Tuples]] - Similar array operations
- [[Common Algorithms for Coding Tests]] - Language-agnostic patterns
- [[TypeScript Essentials for Coding Tests]] - JavaScript with types
- [[Working with APIs in Python]] - Similar async patterns
- [[VS Code Shortcuts & Productivity]] - JavaScript debugging
