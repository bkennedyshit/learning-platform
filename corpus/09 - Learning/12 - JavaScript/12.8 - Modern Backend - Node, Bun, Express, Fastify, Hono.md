...
mission: Build production-grade server-side JavaScript applications with modern runtimes and frameworks
status: active
tags:
  - javascript
  - nodejs
...
type: chapter
chapter: 12.8
prev: "[[12.7 - Modern Frontend Frameworks Overview]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/12 - JavaScript/Subject_Plan]]"
---
...
- **Previous:** [[12.7 - Modern Frontend Frameworks Overview]] — The frontend that consumes these APIs.
- **Async patterns:** [[12.3 - Async - Promises, Async_Await, Event Loop]] — All server code is async.
- **Modules:** [[12.5 - Modules & Build Systems]] — Server-side ESM vs CJS considerations.
- **TypeScript:** [[13 - TypeScript]] — Hono and Fastify have excellent TS support; type your APIs.
- **React full-stack:** [[22.1 - React & Next.js - Functional Components & Hooks]] — Next.js API routes and Server Actions.
