...
mission: "Compare React, Vue, Svelte, and Solid — understand their reactivity models, tradeoffs, and when to choose each"
status: active
tags: [javascript, react, vue, svelte, solid, frameworks, signals, virtual-dom, reactivity, comparison]
type: chapter
chapter: 12.7
prev: "[[12.6 - DOM & Browser APIs]]"
next: "[[12.8 - Modern Backend - Node, Bun, Express, Fastify, Hono]]"
---
...
- **Deep React dive:** [[22.1 - React & Next.js - Functional Components & Hooks]] — Full chapter on React internals, hooks, and Next.js.
- **Previous:** [[12.6 - DOM & Browser APIs]] — Frameworks abstract over these raw APIs.
- **Next:** [[12.8 - Modern Backend - Node, Bun, Express, Fastify, Hono]] — The server side of full-stack JS.
- **TypeScript:** [[13 - TypeScript]] — All modern frameworks have first-class TS support.
- **Build tools:** [[12.5 - Modules & Build Systems]] — Vite powers Svelte, Vue, Solid, and React dev servers.
