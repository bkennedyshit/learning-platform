...
mission: "Apply SOLID principles and Gang of Four patterns in Unity game architecture using interfaces, composition, and events"
status: active
tags: [csharp, oop, design-patterns, solid, interfaces, composition, unity, game-architecture]
type: chapter
chapter: 10.3
track: 3
prev: "[[10.2 - Core Language - Types, Generics & LINQ]]"
next: "[[10.4 - Async, Await, Tasks & Threading]]"
---
...
- **Next**: [[10.4 - Async, Await, Tasks & Threading]] — Async patterns
- **Previous**: [[10.2 - Core Language - Types, Generics & LINQ]]
- **Python OOP**: [[08.3 - OOP, Data Models & Pythonic Idioms]] — Protocol vs Interface
- **Unity Specifics**: [[10.6 - Unity Specifics - MonoBehaviour, Coroutines, ScriptableObjects, ECS]] — MonoBehaviour lifecycle
- **Production DI**: [[10.8 - Production Patterns - DI, Save Systems, Addressables]] — Dependency injection
