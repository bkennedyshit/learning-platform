...
mission: Architect shipping-quality Unity games with dependency injection, robust save/load, asset management, and automated testing
status: active
tags:
  - csharp
  - unity
...
chapter: 10.8
track: 3
prev: "[[10.7 - Networking & Multiplayer - Mirror, Photon & Unity Netcode]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/10 - C#/Subject_Plan]]"
---
...
- **Previous**: [[10.7 - Networking & Multiplayer - Mirror, Photon & Unity Netcode]]
- **Track Start**: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/10 - C#/Subject_Plan]]
- **Design Patterns**: [[10.3 - OOP & Design Patterns]] — Observer, Factory used here
- **Async Loading**: [[10.4 - Async, Await, Tasks & Threading]] — UniTask for Addressables
- **Memory**: [[10.5 - Memory Management & Performance]] — Asset memory management
- **Unity Lifecycle**: [[10.6 - Unity Specifics - MonoBehaviour, Coroutines, ScriptableObjects, ECS]]
