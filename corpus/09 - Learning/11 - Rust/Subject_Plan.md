...
mission: "Master Rust's ownership model, type system, and zero-cost abstractions for systems programming, game dev, and LLM infrastructure"
status: active
tags: [rust, systems-programming, ownership, concurrency, game-dev, wasm, subject-plan]
type: subject-plan
track: 14
---
...
|---|---------|-------------|--------|
| 11.1 | [[11.1 - Setup, Cargo & Project Structure]] | Toolchain, editions, workspace layout | 🟡 |
| 11.2 | [[11.2 - Ownership, Borrowing & Lifetimes]] | The revolutionary memory model | 🟡 |
| 11.3 | [[11.3 - Type System - Enums, Traits & Generics]] | Algebraic types + zero-cost polymorphism | 🟡 |
| 11.4 | [[11.4 - Error Handling - Result, Option, ? Operator]] | Errors as values, not exceptions | 🟡 |
| 11.5 | [[11.5 - Concurrency - Threads, Send__Sync, async__await & Tokio]] | Fearless concurrency | 🟡 |
| 11.6 | [[11.6 - Memory - Box, Rc, Arc, RefCell, Mutex]] | Smart pointers & interior mutability | 🟡 |
| 11.7 | [[11.7 - Idiomatic Rust - Patterns, Anti-patterns & Performance]] | Writing Rust that compiles *and* reads well | 🟡 |
| 11.8 | [[11.8 - Production Rust - WebAssembly, FFI, Embedded & Game Dev (Bevy)]] | Ship it: WASM, FFI, embedded, Bevy | 🟡 |
...
- **Prerequisites**: [[08.1 - Setup, Tooling & Project Structure]] (Python comfort), [[C++ Pointers & Memory Management]] (memory context)
- **Concurrency contrast**: [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
- **Game Dev target**: [[26 - Game Dev]]
- **AI/ML target**: [[23 - AI & Machine Learning Systems]]
- **Architecture context**: [[08.12 - Computer Architecture - Performance Intuition]]
...
## Related Notes
- [[11.5 - Concurrency - Threads, Send_Sync, async_await & Tokio]] - Shared concurrency/rust focus
