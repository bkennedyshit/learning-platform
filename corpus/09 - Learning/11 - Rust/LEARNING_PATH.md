...
mission: "Hand-curated progression from zero Rust to production-grade systems programming"
status: active
tags: [rust, learning-path, curriculum, progression]
type: learning-path
track: 14
---
...
|-------------|----------------|-----|
| Python comfort (functions, classes, iterators) | [[08.1 - Setup, Tooling & Project Structure]] through [[08.3 - OOP, Data Models & Pythonic Idioms]] | Rust's iterators and trait system map to Python's protocols |
| Skim C++ memory model | [[C++ Pointers & Memory Management]] | Stack vs heap, pointers, RAII — Rust formalizes what C++ leaves implicit |
| Basic terminal/CLI fluency | [[08.7 - Shell, Terminal & Cross-Platform CLI]] | Cargo is CLI-first |
...
| Track | Synergy |
|-------|---------|
| [[26 - Game Dev]] | Bevy game dev (Chapter 11.8) |
| [[09 - C++]] | Memory model context (prerequisite) |
| [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] | Python GIL contrast (Chapter 11.5) |
| [[23 - AI & Machine Learning Systems]] | LLM inference engines in Rust |
| [[08.12 - Computer Architecture - Performance Intuition]] | Cache-friendly data layout (Chapter 11.6) |

---

## Related Notes
- [[11.1 - Setup, Cargo & Project Structure]] - Same Rust folder
- [[11.2 - Ownership, Borrowing & Lifetimes]] - Same Rust folder
- [[11.3 - Type System - Enums, Traits & Generics]] - Same Rust folder
- [[11.4 - Error Handling - Result, Option & the Question-Mark Operator]] - Same Rust folder
- [[11.5 - Concurrency - Threads, Send_Sync, async_await & Tokio]] - Same Rust folder
