...
mission: "Master Rust's revolutionary memory model — the compile-time guarantee that eliminates use-after-free, double-free, and data races"
status: active
tags: [rust, ownership, borrowing, lifetimes, move-semantics, borrow-checker, memory-safety]
type: chapter
chapter: 11.2
track: 14
prev: "[[11.1 - Setup, Cargo & Project Structure]]"
next: "[[11.3 - Type System - Enums, Traits & Generics]]"
---
...
- **Next**: [[11.3 - Type System - Enums, Traits & Generics]] — Build on ownership with algebraic types
- **Memory deep-dive**: [[11.6 - Memory - Box, Rc, Arc, RefCell, Mutex]] — When single ownership isn't enough
- **Concurrency payoff**: [[11.5 - Concurrency - Threads, Send__Sync, async__await & Tokio]] — Ownership enables fearless concurrency
- **C++ comparison**: [[C++ Pointers & Memory Management]] — What Rust formalizes
