...
mission: "Master FDM, SLA, and SLS processes, understand slicer decisions, and build a reliable workflow from CAD to printed functional parts — including post-processing and failure diagnosis."
status: skeleton
tags: [3d-printing, additive-manufacturing, fdm, sla, sls, dmls, prusaslicer, slicing, post-processing, maybe-tier]
chapter: "33.5"
prev: "[[33.4 - CNC Machining & G-Code]]"
next: "[[33.6 - Tolerancing, Fits & Assemblies]]"
...
### Internal
- [[33.6 - Tolerancing, Fits & Assemblies]] — tolerance compensation for 3D printed parts
- [[33.3 - Manufacturing Processes & DFM]] — when to choose 3D printing vs other processes
- [[33.8 - Mechatronics & CAD-to-Fabrication Pipeline]] — integrating printed parts into assemblies
...
*Prev: [[33.4 - CNC Machining & G-Code]] | Next: [[33.6 - Tolerancing, Fits & Assemblies]]*
