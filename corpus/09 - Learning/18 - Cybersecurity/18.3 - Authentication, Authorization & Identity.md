...
mission: "Master the modern identity stack: OAuth 2.1, OIDC, JWT vs sessions, mTLS, SSO, passkeys / WebAuthn, and the managed providers (Clerk, Auth0, Supabase Auth, WorkOS) that absorb 80% of the work."
status: skeleton
tags: [cybersecurity, identity, authentication, authorization, oauth-2-1, oidc, jwt, mtls, webauthn, passkeys, fido, sso, clerk, auth0, supabase-auth, workos]
chapter: "18.3"
prev: "[[18.2 - OWASP Top 10 2025 Deep Dive]]"
next: "[[18.4 - Cryptography for Developers]]"
...
**JWT pitfalls** (almost all of these are A07 in [[18.2 - OWASP Top 10 2025 Deep Dive]]):
- Accepting `"alg": "none"`.
...
In zero-trust architectures (see [[18.6 - Network Security]]), *every* service-to-service call presents a client certificate. The mesh (Istio, Linkerd) issues short-lived workload identities (SPIFFE/SPIRE), rotates them automatically, and refuses unauthenticated traffic by default.
...
- Bind tool calls to a tenant context — see [[18.8 - AI Security & Adversarial ML]].
- Log every tool call with a tamper-evident audit trail (A09 in [[18.2 - OWASP Top 10 2025 Deep Dive]]).
...
### Internal
- [[18.2 - OWASP Top 10 2025 Deep Dive]] — A07 deep links here
- [[18.4 - Cryptography for Developers]] — JWT signing + the primitives behind WebAuthn
- [[18.6 - Network Security]] — mTLS in service mesh
- [[18.7 - Cloud & Container Security]] — workload identity (SPIFFE/SPIRE)
- [[18.8 - AI Security & Adversarial ML]] — agent identity model
...
*Next: [[18.4 - Cryptography for Developers]] — the primitives that make all of the above possible.*
