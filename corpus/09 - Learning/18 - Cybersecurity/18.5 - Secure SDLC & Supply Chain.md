...
mission: "Wire SAST + DAST + SCA + SBOM + signed builds into a CI pipeline so that A03 (Software Supply Chain Failures) and A06 (Vulnerable Components) become continuously-defended categories instead of audit theater."
status: skeleton
tags: [cybersecurity, secure-sdlc, supply-chain, sast, dast, sca, sbom, sigstore, slsa, cosign, semgrep, codeql, snyk, trivy, dependabot, cyclonedx, spdx]
chapter: "18.5"
prev: "[[18.4 - Cryptography for Developers]]"
next: "[[18.6 - Network Security]]"
...
Both are A03 patterns — see [[18.2 - OWASP Top 10 2025 Deep Dive]].
...
This single pipeline closes A03, A06, A08 from [[18.2 - OWASP Top 10 2025 Deep Dive]] simultaneously.
...
### Internal
- [[18.2 - OWASP Top 10 2025 Deep Dive]] — A03, A06, A08
- [[18.4 - Cryptography for Developers]] — the signatures behind Cosign
- [[18.7 - Cloud & Container Security]] — admission control and runtime
- [[../20 - DevOps & SRE/Subject_Plan]] — CI/CD pipelines (sibling track)
...
*Next: [[18.6 - Network Security]] — TLS 1.3, CSP, zero trust, and the network-layer half of supply chain.*
