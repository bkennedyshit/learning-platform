...
mission: "TLS 1.3, HSTS, CSP, CORS, rate limiting, WAF, zero-trust (BeyondCorp), service-mesh mTLS, DDoS mitigation — the network-layer controls that make the rest of the stack defensible."
status: skeleton
tags: [cybersecurity, network-security, tls-1-3, hsts, csp, cors, rate-limiting, waf, zero-trust, beyondcorp, service-mesh, mtls, ddos]
chapter: "18.6"
prev: "[[18.5 - Secure SDLC & Supply Chain]]"
next: "[[18.7 - Cloud & Container Security]]"
...
- Key exchange: X25519 (now hybrid X25519+Kyber where supported — see [[18.4 - Cryptography for Developers]]).
...
For LLM-backed endpoints add a **cost limit** in addition to a rate limit (tokens-per-minute per tenant) — see [[18.8 - AI Security & Adversarial ML]].
...
This composes with **NetworkPolicies** at L3/L4 (see [[18.7 - Cloud & Container Security]]) — defense in depth, not OR.
...
### Internal
- [[18.4 - Cryptography for Developers]] — TLS primitives + PQC migration
- [[18.7 - Cloud & Container Security]] — NetworkPolicies and runtime
- [[../01- Python/1.11 - Computer Networks Essentials]] — TCP/IP foundations
- [[../20 - DevOps & SRE/Subject_Plan]] — sibling track on operations
- [[../19 - System Design & Distributed Architecture/Subject_Plan]] — sibling track on architecture
...
*Next: [[18.7 - Cloud & Container Security]] — controls inside the cluster.*
