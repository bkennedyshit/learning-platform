...
mission: "Lock down the runtime: IAM least-privilege, secrets management (Vault, Doppler, cloud KMS), Kubernetes RBAC + Pod Security Standards + NetworkPolicies, container image scanning, and runtime behavioral defense (Falco)."
status: skeleton
tags: [cybersecurity, cloud-security, container-security, iam, kms, vault, doppler, kubernetes, rbac, pod-security-standards, networkpolicy, falco, kyverno, opa]
chapter: "18.7"
prev: "[[18.6 - Network Security]]"
next: "[[18.8 - AI Security & Adversarial ML]]"
...
NetworkPolicies pair with **service-mesh mTLS** (see [[18.6 - Network Security]]) — L3/L4 reachability + L7 identity. Use both.

---

## 🩻 6. Image Scanning — Build + Admission

Build-time: Trivy / Grype on every image. Admission-time: only allow images signed by your CI workflow (Cosign + Kyverno policy from [[18.5 - Secure SDLC & Supply Chain]]).
...
### Internal
- [[18.5 - Secure SDLC & Supply Chain]] — admission controllers + signed images
- [[18.6 - Network Security]] — service-mesh mTLS layer above NetworkPolicies
- [[18.4 - Cryptography for Developers]] — KMS-backed envelope encryption
- [[../01- Python/1.9 - Docker & Containers]] — container basics
- [[../01- Python/1.10 - Operating Systems Essentials]] — namespaces, capabilities
- [[../20 - DevOps & SRE/Subject_Plan]] — sibling track
- [[../21 - Cloud Platforms/Subject_Plan]] — sibling track
...
*Next: [[18.8 - AI Security & Adversarial ML]] — the new attack surface that ties this whole track back to BUILDING_AT_SCALE §5.*
