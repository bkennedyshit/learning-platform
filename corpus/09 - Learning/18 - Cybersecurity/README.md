...
date: 2026-05-26
type: subject-readme
tags: [practice, refresher, drills, source-materials, study-aids, cybersecurity, security, owasp, threat-modeling, cryptography, secure-sdlc, ai-security]
title: "README — 18 - Cybersecurity"
mission: "Be the developer who can build secure code in 2026 — when nearly half of AI-generated code contains OWASP vulnerabilities and 81% of enterprises don't know where their AI code lives."
status: active
...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/cyber__<chapter>-fig<n>.svg` and embedded inline via `![[cyber__25.x-figN.svg]]`.
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/18 - Cybersecurity/Subject_Plan]]
- Visual roadmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/18 - Cybersecurity/LEARNING_PATH]]
- Foundational meta-playbook: [[../BUILDING_AT_SCALE]]
- Python prerequisite: [[../01- Python/Subject_Plan]]
- Docker & containers: [[../01- Python/1.9 - Docker & Containers]]
- OS essentials: [[../01- Python/1.10 - Operating Systems Essentials]]
- Networks essentials: [[../01- Python/1.11 - Computer Networks Essentials]]
- Distributed systems: [[../01- Python/1.16 - Distributed Systems & Multi-GPU Training]]
- SQL: [[../14 - SQL/Subject_Plan]]
- AI/ML systems: [[../23 - AI & Machine Learning Systems/Subject_Plan]]
- Transformers / LLMs: [[../23 - AI & Machine Learning Systems/10.5 - Transformer Architectures & LLMs]]
- DevOps & SRE (sibling): [[../20 - DevOps & SRE/Subject_Plan]]
- System Design (sibling): [[../19 - System Design & Distributed Architecture/Subject_Plan]]
- Cloud Platforms (sibling): [[../21 - Cloud Platforms/Subject_Plan]]
