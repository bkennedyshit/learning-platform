...
mission: Install the defender's mental model. STRIDE per element, DREAD scoring, attack trees, Mozilla RRA, abuse cases — applied to your own systems before any attacker gets there first.
status: skeleton
tags:
  - cybersecurity
  - threat-modeling
  ...
  - security-design
chapter: "18.1"
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/18 - Cybersecurity/LEARNING_PATH]]"
next: "[[18.2 - OWASP Top 10 2025 Deep Dive]]"
...
### Internal
- [[18.2 - OWASP Top 10 2025 Deep Dive]] — controls catalogue mapped from threats
- [[18.8 - AI Security & Adversarial ML]] — threat modeling for LLM systems
- [[../01- Python/1.10 - Operating Systems Essentials]] — privilege boundaries are trust boundaries
- [[../01- Python/1.11 - Computer Networks Essentials]] — network trust boundaries
- [[BUILDING_AT_SCALE]] §5 — why this matters at scale
...
*Next: [[18.2 - OWASP Top 10 2025 Deep Dive]] — the controls catalogue that maps directly back to threats.*
