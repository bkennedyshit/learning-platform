...
mission: "Pick the right primitive on the first try. AES-GCM / ChaCha20-Poly1305 for encryption, Ed25519 / ECDSA for signatures, Argon2id for passwords, libsodium / age / cosign for the libraries — and a working understanding of the post-quantum migration to Kyber + Dilithium."
status: skeleton
tags: [cybersecurity, cryptography, aes-gcm, chacha20-poly1305, ed25519, ecdsa, rsa, argon2id, libsodium, age, cosign, post-quantum, kyber, dilithium, sphincs, falcon]
chapter: "18.4"
prev: "[[18.3 - Authentication, Authorization & Identity]]"
next: "[[18.5 - Secure SDLC & Supply Chain]]"
...
For artifact signing the analogous tool is **Cosign** — see [[18.5 - Secure SDLC & Supply Chain]].
...
### Internal
- [[18.2 - OWASP Top 10 2025 Deep Dive]] — A02 Cryptographic Failures
- [[18.3 - Authentication, Authorization & Identity]] — JWT signing, WebAuthn primitives
- [[18.5 - Secure SDLC & Supply Chain]] — Cosign + Sigstore
- [[18.6 - Network Security]] — TLS 1.3 + hybrid PQC handshakes
...
*Next: [[18.5 - Secure SDLC & Supply Chain]] — where these primitives live in your build pipeline.*
