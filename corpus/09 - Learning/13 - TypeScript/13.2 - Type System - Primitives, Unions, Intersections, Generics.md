...
mission: "Master TypeScript's structural type system from primitives through generics and type narrowing"
status: active
tags: [typescript, type-system, generics, unions, intersections, narrowing, utility-types]
type: chapter
chapter: 13.2
prev: "[[13.1 - Setup, Compilation & Project Structure]]"
next: "[[13.3 - Advanced Types - Conditional, Mapped, Template Literal Types]]"
---
...
### Internal Links
- **Previous:** [[13.1 - Setup, Compilation & Project Structure]]
- **Next:** [[13.3 - Advanced Types - Conditional, Mapped, Template Literal Types]]
- **Python OOP comparison:** [[08.3 - OOP, Data Models & Pythonic Idioms]] — structural typing ≈ Python protocols
- **React with TS:** [[13.7 - Frontend with TypeScript - React, Vue, Svelte, SolidJS]]
