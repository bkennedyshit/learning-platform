...
mission: "Master ESM/CJS module systems, modern bundlers, and monorepo tooling for TypeScript projects"
status: active
tags: [typescript, modules, esm, cjs, bundlers, vite, esbuild, monorepo, turborepo]
type: chapter
chapter: 13.6
prev: "[[13.5 - Async, Promises & Async Generators]]"
next: "[[13.7 - Frontend with TypeScript - React, Vue, Svelte, SolidJS]]"
---
...
### Internal Links
- **Previous:** [[13.5 - Async, Promises & Async Generators]]
- **Next:** [[13.7 - Frontend with TypeScript - React, Vue, Svelte, SolidJS]]
- **Project setup:** [[13.1 - Setup, Compilation & Project Structure]]
- **Backend builds:** [[13.8 - Backend with TypeScript - Node, Bun, Deno, Express, Fastify, Hono]]
