...
mission: Configure TypeScript projects with strict mode, understand the compilation pipeline, and architect monorepo structures
status: active
tags:
  - typescript
  - setup
...
type: chapter
chapter: 13.1
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/13 - TypeScript/Subject_Plan]]"
next: "[[13.2 - Type System - Primitives, Unions, Intersections, Generics]]"
---
...
### Internal Links
- **Next chapter:** [[13.2 - Type System - Primitives, Unions, Intersections, Generics]]
- **Modules deep-dive:** [[13.6 - Modules & Build Systems]]
- **Python comparison:** [[08.3 - OOP, Data Models & Pythonic Idioms]] — structural typing parallels
