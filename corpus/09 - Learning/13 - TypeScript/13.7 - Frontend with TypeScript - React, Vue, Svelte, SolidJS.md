...
mission: "Master typed frontend development across major frameworks with React Server Components, Vue 3 Composition API, Svelte 5 runes, and SolidJS signals"
status: active
tags: [typescript, react, vue, svelte, solidjs, frontend, hooks, rsc, signals, runes]
type: chapter
chapter: 13.7
prev: "[[13.6 - Modules & Build Systems]]"
next: "[[13.8 - Backend with TypeScript - Node, Bun, Deno, Express, Fastify, Hono]]"
---
...
### Internal Links
- **Previous:** [[13.6 - Modules & Build Systems]]
- **Next:** [[13.8 - Backend with TypeScript - Node, Bun, Deno, Express, Fastify, Hono]]
- **React deep-dive:** [[22.1 - React & Next.js - Functional Components & Hooks]]
- **Angular (heavy TS):** [[22.2 - Angular - Class-based Architecture & RxJS]]
