...
mission: "Master both object-oriented and functional programming paradigms in TypeScript, including discriminated unions, Effect.ts, and composition patterns"
status: active
tags: [typescript, oop, functional-programming, classes, composition, effect-ts, discriminated-unions, patterns]
type: chapter
chapter: 13.4
prev: "[[13.3 - Advanced Types - Conditional, Mapped, Template Literal Types]]"
next: "[[13.5 - Async, Promises & Async Generators]]"
---
...
### Internal Links
- **Previous:** [[13.3 - Advanced Types - Conditional, Mapped, Template Literal Types]]
- **Next:** [[13.5 - Async, Promises & Async Generators]]
- **Python OOP:** [[08.3 - OOP, Data Models & Pythonic Idioms]] — direct comparison
- **React patterns:** [[13.7 - Frontend with TypeScript - React, Vue, Svelte, SolidJS]]
