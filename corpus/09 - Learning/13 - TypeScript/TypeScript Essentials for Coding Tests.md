...
mission: Master TypeScript type system, interfaces, generics, and type-safe patterns for technical interviews
status: reference
tags: [typescript, type-system, coding-tests, interfaces, generics, type-safety]
type: learning-note
---
...
- [[JavaScript Essentials for Coding Tests]] - JavaScript fundamentals
- [[Python Variables & Data Types]] - Similar type concepts
- [[Common Algorithms for Coding Tests]] - Language-agnostic patterns
- [[VS Code Shortcuts & Productivity]] - TypeScript debugging
