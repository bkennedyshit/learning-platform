---
date: 2026-05-26
title: "Business & Entrepreneurship — Subject Plan"
mission: "Turn the builder into the founder. Idea validation → business models → pricing → GTM → fundraising → sales → legal → scaling. The track that turns your AI tools, games, and content brand from side projects into companies."
status: active
tags: [business, entrepreneurship, founder, startups, business-models, pricing, gtm, fundraising, sales, legal, scaling, subject-plan, curriculum]
type: subject-plan
subject: "39 - Business & Entrepreneurship"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/39 - Business & Entrepreneurship/LEARNING_PATH]]*
...
```mermaid
mindmap
  root((39 - Business & Entrepreneurship))
    Discovery
      39.1 Founder Mindset & Idea Validation
    Revenue Architecture
      39.2 Business Models
      39.3 Pricing Strategy
    Growth Engine
      39.4 Go-To-Market & Distribution
      39.5 Fundraising & Equity
    Execution
      39.6 Sales & Negotiation
      39.7 Legal Basics
      39.8 Scaling & Teams
```
...
|---|---|---|
| SaaS architecture patterns | [[../19 - System Design & Distributed Architecture/Subject_Plan\|Track 27]] | You need to know what you're pricing and selling |
| Your business context | [[../../02 - Business_Platform/\|02 - Business_Platform]] | Your real products — AI tools, game dev, BMX brand — are the case studies |
...
> Pictures, videos, and reference materials live **outside the repo** (YouTube, official docs, open-source resources). Each chapter and the [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/39 - Business & Entrepreneurship/README]] hub link to them by URL. SVG diagrams that we author live inside `_svgs/` with the `biz__<ch>-fig<n>.svg` prefix.
...
```mermaid
graph LR
    BIZ["33 — Business & Entrepreneurship"]
    BIZ --> SAAS["Your SaaS Products<br/>(AI tools, developer tools)"]
    BIZ --> GAME["Game Dev Business<br/>(26 - Game Dev)"]
    BIZ --> BMX["BMX Content Brand<br/>(media + sponsorship)"]
    BIZ --> PLATFORM["02 - Business_Platform<br/>(your live ops)"]
    BIZ --> SD["27 - System Design<br/>(what you're selling)"]
    BIZ --> DEVOPS["20 - DevOps & SRE<br/>(reliability = trust = revenue)"]
    PLATFORM --> SCALE["Scaling to Real Revenue"]
    SAAS --> SCALE
    GAME --> SCALE
    BMX --> SCALE
```
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/39 - Business & Entrepreneurship/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[39.2 - Business Models & Revenue Architecture]] - Shared entrepreneurship/business-models focus
