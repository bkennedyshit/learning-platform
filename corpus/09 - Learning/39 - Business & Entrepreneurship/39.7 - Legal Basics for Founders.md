...
mission: "Don't let a legal landmine undo years of work. Entity structure, IP assignment, contractor vs employee, vesting schedules, founder agreements, and what to do before you raise."
status: active
tags: [legal, founders, delaware-c-corp, llc, ip-assignment, vesting, contractor, employee, founder-agreements, intellectual-property, entrepreneurship]
chapter: "39.7"
prev: "[[39.6 - Sales, Negotiation & Closing]]"
next: "[[39.8 - Scaling Operations & Building Teams]]"
...
### Internal
- [[39.5 - Fundraising, Investors & Equity]] — fundraising triggers most of the legal events in this chapter
- [[39.8 - Scaling Operations & Building Teams]] — first hire = first employee classification decision
...
*Next: [[39.8 - Scaling Operations & Building Teams]] — You've built the foundation. Now build the machine.*
