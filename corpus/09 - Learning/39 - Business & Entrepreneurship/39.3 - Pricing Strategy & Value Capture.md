...
mission: "Stop charging what feels safe. Learn value-based pricing, the freemium math, willingness-to-pay research, SaaS tier design, and anchoring. Most developers undercharge by 5–10×."
status: active
tags: [pricing, value-based-pricing, freemium, willingness-to-pay, van-westendorp, saas-pricing, price-anchoring, tier-design, pricing-psychology, entrepreneurship]
chapter: "39.3"
prev: "[[39.2 - Business Models & Revenue Architecture]]"
next: "[[39.4 - Go-To-Market Strategy & Distribution]]"
...
### Internal
- [[39.2 - Business Models & Revenue Architecture]] — the model shapes what can be priced
- [[39.4 - Go-To-Market Strategy & Distribution]] — the channels through which price is communicated
- [[39.6 - Sales, Negotiation & Closing]] — in sales calls, price negotiation is a different skill than pricing itself
- [[39.8 - Scaling Operations & Building Teams]] — MRR/ARPU/churn metrics that reflect pricing effectiveness
...
*Next: [[39.4 - Go-To-Market Strategy & Distribution]] — Pricing only matters if people can find you. Build the engine that brings them to you.*
