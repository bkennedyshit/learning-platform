...
mission: "Build the digital foundation: Boolean algebra → combinational gates → sequential logic (latches, flip-flops, registers) → finite state machines → enough to read RTL and understand a CPU."
status: skeleton
tags: [electronics, digital-logic, boolean-algebra, gates, flip-flops, fsm, sequential-logic, combinational-logic, fpga]
chapter: "30.4"
prev: "[[30.3 - Semiconductors - Diodes, BJTs, MOSFETs, Op-Amps]]"
next: "[[30.5 - Microcontrollers & Embedded Systems - Arduino, ESP32, RP2040, STM32]]"
...
### Internal
- [[30.3 - Semiconductors - Diodes, BJTs, MOSFETs, Op-Amps]] — CMOS implements gates
- [[30.5 - Microcontrollers & Embedded Systems - Arduino, ESP32, RP2040, STM32]] — what runs sequential logic at scale
- [[30.6 - Motherboards & Computer Architecture - CPU, RAM, Chipset, PCIe, UEFI]] — the CPU is a giant FSM
