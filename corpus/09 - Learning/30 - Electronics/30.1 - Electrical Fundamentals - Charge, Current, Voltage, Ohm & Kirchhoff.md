...
mission: Establish the four atoms of circuit analysis — charge, current, voltage, resistance — and the two laws (Ohm + Kirchhoff) that the entire field is built on.
status: skeleton
tags:
  - electronics
  - fundamentals
  ...
  - circuit-analysis
chapter: "30.1"
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/30 - Electronics/LEARNING_PATH]]"
next: "[[30.2 - Passive Components - Resistors, Capacitors, Inductors, Transformers]]"
...
### Internal
- [[30.2 - Passive Components - Resistors, Capacitors, Inductors, Transformers]] — what circuits *do* over time
- [[../07 - Math and Physics/07 - Electrodynamics & Classical Field Theory/Subject_Plan]] — the Maxwell-equation foundations
