...
mission: "From electrons → components → semiconductors → digital logic → microcontrollers → motherboards → power electronics → the bridge to robotics. A first-principles electronics curriculum built to feed directly into 32 - Robotics."
status: active
tags: [electronics, electrical-engineering, semiconductors, microcontrollers, motherboards, embedded-systems, pcb, robotics-prerequisite, subject-plan, curriculum]
type: subject-plan
subject: "30 - Electronics"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/30 - Electronics/LEARNING_PATH]]*
...
2. **The on-ramp to [[../32 - Robotics/Subject_Plan|32 - Robotics]].** A robot is electronics + actuators + sensors + control loops. You cannot debug a misbehaving robot if you can't reason about a wire, a battery, or a motor driver. This track gives you exactly that ability.
...
|---|---|---|
| Calculus (derivatives, integrals) | [[1 - Mathematical Foundations & Calculus/Subject_Plan]] | $i = C\frac{dv}{dt}$, $v = L\frac{di}{dt}$, integrals everywhere |
| Linear algebra | [[2 - Linear Algebra & Matrix Theory/Subject_Plan]] | Mesh + nodal analysis, state-space systems |
| ODEs | [[3 - Ordinary & Partial Differential Equations/Subject_Plan]] | RC, RL, RLC transient response |
| Electrodynamics | [[../07 - Math and Physics/07 - Electrodynamics & Classical Field Theory/Subject_Plan]] | Maxwell underneath all of this |
| Python basics | [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/08 - Python/Subject_Plan]] | MicroPython on RP2040/ESP32, host-side tooling |

---

## 🆓 Premium-Free Resource Catalog

> Pictures, videos, and reference materials live **outside the repo** — see [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/30 - Electronics/README]] for the canonical link list. SVG diagrams that we author live inside `../_svgs/` with the `elec__<ch>-fig<n>.svg` prefix.
...
PWM, H-bridges, motor drivers, regulators, then the bus protocols (I²C/SPI/UART/CAN) that connect everything. **Drive a small DC motor and read an I²C sensor.** This puts you on the doorstep of [[../32 - Robotics/Subject_Plan|32 - Robotics]].
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/30 - Electronics/LEARNING_PATH]] — Visual progression map*

---

## Related Notes
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/30 - Electronics/LEARNING_PATH]] - Shared microcontrollers/semiconductors focus
- [[30.3 - Semiconductors - Diodes, BJTs, MOSFETs, Op-Amps]] - Shared semiconductors/electronics focus
- [[30.5 - Microcontrollers & Embedded Systems - Arduino, ESP32, RP2040, STM32]] - Shared microcontrollers/electronics focus
- [[30.6 - Motherboards & Computer Architecture - CPU, RAM, Chipset, PCIe, UEFI]] - Shared motherboards/electronics focus
- [[30.1 - Electrical Fundamentals - Charge, Current, Voltage, Ohm & Kirchhoff]] - Same Electronics folder
