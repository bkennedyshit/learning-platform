...
mission: "From silicon physics to working circuits — diodes, bipolar and field-effect transistors as switches and amplifiers, and the operational amplifier as a near-ideal building block."
status: skeleton
tags: [electronics, semiconductors, diodes, bjt, mosfet, op-amp, amplifier, switch, analog]
chapter: "30.3"
prev: "[[30.2 - Passive Components - Resistors, Capacitors, Inductors, Transformers]]"
next: "[[30.4 - Digital Logic & Boolean Algebra - Gates, Flip-Flops, FSMs]]"
...
- [[30.4 - Digital Logic & Boolean Algebra - Gates, Flip-Flops, FSMs]] — gates are MOSFET pairs
- [[30.7 - Power Electronics & Motor Drivers - PWM, H-Bridges, BLDC, Regulators]] — power MOSFETs in action
