...
mission: "Wire it all together — the four bus protocols that connect every chip to every other chip, plus the sensors and actuators that turn an MCU into a robot. The bridge to 32 - Robotics."
status: skeleton
tags: [electronics, i2c, spi, uart, can, sensors, actuators, communication-protocols, robotics-bridge, capstone]
chapter: "30.8"
prev: "[[30.7 - Power Electronics & Motor Drivers - PWM, H-Bridges, BLDC, Regulators]]"
next: "[[../32 - Robotics/Subject_Plan]]"
...
This is the **capstone** of Track 30 and the **bridge** to [[../32 - Robotics/Subject_Plan|Track 32 - Robotics]]. Everything you've learned — passive components, transistors, digital logic, microcontrollers, motherboards, motor drivers — comes together when you connect a sensor to an MCU, decide on a protocol, and close the control loop.
...
4. **Hand-off** — feeds [[../32 - Robotics/Subject_Plan|32 - Robotics]] (Nav2, SLAM).
...
- [[../32 - Robotics/Subject_Plan|32 - Robotics]] — the next track picks up here
- [[22.5 - ROS 2 & Middleware]] — what runs on the Pi side
- [[22.3 - Sensors & Perception]] — sensor processing in depth
...
*Track 30 capstone complete. Continue to [[../32 - Robotics/Subject_Plan|32 - Robotics]] — where electronics + control + perception become a robot.*
