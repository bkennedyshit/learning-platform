...
mission: "Move from signal-level circuits to power: PWM, H-bridges for DC motors, BLDC + ESC for drones / robotics, linear vs switching regulators, batteries, and the protection circuits that keep things from melting."
status: skeleton
tags: [electronics, power-electronics, pwm, h-bridge, bldc, motor-driver, regulator, smps, batteries]
chapter: "30.7"
prev: "[[30.6 - Motherboards & Computer Architecture - CPU, RAM, Chipset, PCIe, UEFI]]"
next: "[[30.8 - From Electronics to Robotics - I2C, SPI, UART, CAN, Sensors & Actuators]]"
...
### Internal
- [[30.3 - Semiconductors - Diodes, BJTs, MOSFETs, Op-Amps]] — power MOSFETs in detail
- [[30.5 - Microcontrollers & Embedded Systems - Arduino, ESP32, RP2040, STM32]] — generating PWM
- [[30.8 - From Electronics to Robotics - I2C, SPI, UART, CAN, Sensors & Actuators]] — closing the control loop
- [[22.4 - Actuators & Motor Control]] — robotics-side torque/velocity control
