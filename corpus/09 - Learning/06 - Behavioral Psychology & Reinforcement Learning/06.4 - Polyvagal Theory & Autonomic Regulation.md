...
chapter: 06.4
prev: "[[06.3 - Q-Learning & The Bellman Equation]]"
next: "[[06.5 - Trauma Adaptations - C-PTSD as Reinforcement Learning]]"
tags: [polyvagal-theory, autonomic-nervous-system, vagus-nerve, HRV, ventral-vagal, dorsal-vagal, sympathetic, porges, neuroception]
status: complete
type: chapter-note
---
...
where $Q = P^T - I$ is the **rate matrix** (generator matrix). This connects to [[3.4 - Systems of Linear ODEs & State Space]].
...
### Internal Links
- [[06.5 - Trauma Adaptations - C-PTSD as Reinforcement Learning]] — When the polyvagal system gets stuck
- [[06.2 - Dopamine & Reward Prediction Error]] — How autonomic state modulates dopamine signaling
- [[06.6 - RLHF - Reinforcement Learning from Human Feedback]] — Co-regulation as biological RLHF
- [[34.4 - Autonomic Nervous System Telemetry - HRV]] — Measurement and biofeedback
- [[05.6 - Neuromodulators - Dopamine, Serotonin, Acetylcholine]] — Neurochemistry of state transitions
- [[3.4 - Systems of Linear ODEs & State Space]] — Mathematical framework for state dynamics
...
### Practice
- [[12.4_polyvagal_states.py]] — State-machine simulator for autonomic transitions with HRV signatures
