...
title: "README — 06 - Behavioral Psychology & Reinforcement Learning"
---

# 06 - Behavioral Psychology & Reinforcement Learning — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/06 - Behavioral Psychology & Reinforcement Learning"
...
|---|---|---|
| 12.1_conditioning.py | [[06.1 - Classical & Operant Conditioning]] | `python "_practice/scripts/12.1_conditioning.py" --count 8 --seed 42` |
| 12.2_rpe_simulator.py | [[06.2 - Dopamine & Reward Prediction Error]] | `python "_practice/scripts/12.2_rpe_simulator.py" --count 8 --seed 42` |
| 12.3_bellman_qlearning.py | [[06.3 - Q-Learning & The Bellman Equation]] | `python "_practice/scripts/12.3_bellman_qlearning.py" --count 8 --seed 42` |
| 12.4_polyvagal_states.py | [[06.4 - Polyvagal Theory & Autonomic Regulation]] | `python "_practice/scripts/12.4_polyvagal_states.py" --count 8 --seed 42` |
| 12.5_trauma_policy.py | [[06.5 - Trauma Adaptations - C-PTSD as Reinforcement Learning]] | `python "_practice/scripts/12.5_trauma_policy.py" --count 8 --seed 42` |
| 12.6_rlhf_skeleton.py | [[06.6 - RLHF - Reinforcement Learning from Human Feedback]] | `python "_practice/scripts/12.6_rlhf_skeleton.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/06 - Behavioral Psychology & Reinforcement Learning/Subject_Plan]]
