...
chapter: 06.1
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/06 - Behavioral Psychology & Reinforcement Learning/Subject_Plan]]"
next: "[[06.2 - Dopamine & Reward Prediction Error]]"
tags:
...
### Internal Links
- [[06.2 - Dopamine & Reward Prediction Error]] — The neural implementation of the prediction error $\delta$
- [[06.3 - Q-Learning & The Bellman Equation]] — Extending Rescorla-Wagner to multi-step, multi-state environments
- [[06.5 - Trauma Adaptations - C-PTSD as Reinforcement Learning]] — Avoidant attachment as local-minimum lock-in
- [[23.7 - Reinforcement Learning & RLHF]] — Full AI/ML treatment of RL algorithms
- [[05.6 - Neuromodulators - Dopamine, Serotonin, Acetylcholine]] — Biological substrate of learning signals
- [[3.4 - Systems of Linear ODEs & State Space]] — State-space formulation underlying MDP dynamics
...
### Practice
- [[12.1_conditioning.py]] — Rescorla-Wagner derivation drills and operant conditioning problems
