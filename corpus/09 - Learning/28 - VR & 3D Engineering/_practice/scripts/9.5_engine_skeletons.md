---
tags: [review/3d, unity, unreal, engine-patterns, reference]
---

# 9.5 — Engine Skeletons: Unity C# & Unreal C++ Templates

*Reference companion to [[28.5 - Game Engine Architectures - Unity & Unreal]]*
...
## Related Notes
- [[9.4_shader_examples]] - Shared review/3d/reference focus
- [[9.7_xr_interaction]] - Shared review/3d/reference focus
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/10 - C#/Subject_Plan]] - Shared unreal/unity focus
