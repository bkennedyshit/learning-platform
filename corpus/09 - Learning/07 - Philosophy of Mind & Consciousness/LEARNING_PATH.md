---
date: 2026-05-26
title: "Philosophy of Mind & Consciousness — Learning Path"
mission: "Visual roadmap and progression guide for the Philosophy of Mind & Consciousness track."
status: skeleton
tags: [philosophy-of-mind, learning-path, roadmap, progression, consciousness, ai-sentience, maybe-tier]
type: learning-path
...
graph TD
    %% Prerequisites
    NEURO["✅ Neuroscience<br/>Track 11"]
    AIML["✅ AI/ML Systems<br/>Track 10"]
    PSYCH["✅ Behavioral Psych<br/>Track 12"]

    %% Chapters
    C1["07.1 The Hard Problem<br/>of Consciousness"]
    C2["07.2 Functionalism,<br/>Physicalism & Dualism"]
    C3["07.3 Computational<br/>Theories of Mind"]
    C4["07.4 Perception, Qualia<br/>& Phenomenology"]
    C5["07.5 Free Will, Agency<br/>& Causation"]
    C6["07.6 Personal Identity<br/>& Continuity"]
    C7["07.7 AI Consciousness<br/>& Machine Sentience"]
    C8["07.8 Altered States, Dreams<br/>& Non-Ordinary Consciousness"]
    ...
    %% Downstream
    C7 --> ALIGN["AI Alignment Work"]
    C7 --> ETHICS["AI Ethics Framework"]
    C6 --> UPLOAD["Mind Upload Questions"]

    %% Styles
    style NEURO fill:#2d5016,stroke:#4a8c2a
    style AIML fill:#2d5016,stroke:#4a8c2a
    style PSYCH fill:#2d5016,stroke:#4a8c2a

    style C1 fill:#1a1a4a,stroke:#5a5ab8
    style C2 fill:#3a1a3a,stroke:#b83db8
    ...
    style C7 fill:#1a1a4a,stroke:#5a5ab8
    style C8 fill:#1a3a1a,stroke:#3db83d

    style ALIGN fill:#2a2a2a,stroke:#666
    style ETHICS fill:#2a2a2a,stroke:#666
    style UPLOAD fill:#2a2a2a,stroke:#666
```
...
*Next: [[07.1 - The Hard Problem of Consciousness]] — Start at the question that changes everything.*

---

## Related Notes
- [[07.2 - Functionalism, Physicalism & Dualism]] - Same Philosophy of Mind & folder
- [[07.3 - Computational Theories of Mind]] - Same Philosophy of Mind & folder
- [[07.4 - Perception, Qualia & Phenomenology]] - Same Philosophy of Mind & folder
