...
mission: "REST, GraphQL Federation, gRPC + protobuf, OpenAPI 3.1, AsyncAPI, versioning, rate limiting, and the 2026 API gateway landscape (Kong, Tyk, Apigee, Zuplo). Pick the right protocol; treat the schema as a contract."
status: skeleton
tags: [system-design, api-design, rest, graphql, federation, grpc, protobuf, openapi, asyncapi, rate-limiting, api-gateway, kong, tyk, apigee, zuplo]
chapter: "19.5"
prev: "[[19.4 - Message Queues & Event-Driven Architecture]]"
next: "[[19.6 - Microservices & Service Mesh]]"
...
### Internal
- [[19.4 - Message Queues & Event-Driven Architecture]] — AsyncAPI is the contract layer for those topics
- [[19.6 - Microservices & Service Mesh]] — gRPC + mTLS via mesh
- [[19.2 - Caching, CDNs & Edge]] — `Cache-Control` is part of every REST API
- [[../18 - Cybersecurity/Subject_Plan]] — auth, mTLS, signed webhooks
- [[../20 - DevOps & SRE/Subject_Plan]] — rolling out a versioned API
...
*Next: [[19.6 - Microservices & Service Mesh]] — When (and only when) to decompose.*
