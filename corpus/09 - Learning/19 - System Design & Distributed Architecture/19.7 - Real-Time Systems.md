...
mission: "WebSockets, Server-Sent Events, WebRTC, WebTransport, presence, CRDTs (Yjs, Automerge), Operational Transform, conflict resolution, and multiplayer game patterns (rollback, snapshot interpolation). Where the request/response model dies."
status: skeleton
tags: [system-design, real-time, websockets, sse, webrtc, webtransport, presence, crdt, yjs, automerge, operational-transform, multiplayer, rollback-netcode, snapshot-interpolation]
chapter: "19.7"
prev: "[[19.6 - Microservices & Service Mesh]]"
next: "[[19.8 - Capacity Planning & Back-of-Envelope Math]]"
...
### Internal
- [[19.4 - Message Queues & Event-Driven Architecture]] — events vs streams vs CRDTs
- [[19.6 - Microservices & Service Mesh]] — when real-time systems should be one service
- [[19.8 - Capacity Planning & Back-of-Envelope Math]] — connection bandwidth math
- [[../29 - VR/24.7 - Networking, Avatars & Multi-User Spaces]] — same patterns at avatar scale
- [[../32 - Robotics/22.5 - ROS 2 & Middleware - Nodes, Topics, Services, Actions, DDS]] — DDS as real-time middleware
...
*Next: [[19.8 - Capacity Planning & Back-of-Envelope Math]] — The numbers that turn opinions into engineering.*
