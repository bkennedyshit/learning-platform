...
mission: "When to decompose (the failure-domain rule), why a modular monolith is usually the right answer first, Istio Ambient vs Linkerd vs Cilium in 2026, distributed tracing, and the discipline that keeps a service graph from becoming a distributed monolith."
status: skeleton
tags: [system-design, microservices, modular-monolith, service-mesh, istio, linkerd, cilium, ambient-mesh, observability, distributed-tracing, opentelemetry]
chapter: "19.6"
prev: "[[19.5 - API Design]]"
next: "[[19.7 - Real-Time Systems]]"
...
5. Avoid the **distributed transaction trap** — prefer Saga + idempotency ([[19.4 - Message Queues & Event-Driven Architecture|19.4]]).
...
|---|---|---|
| Atomic state change across services | **Saga** | [[19.4 - Message Queues & Event-Driven Architecture|19.4]] |
| DB write + event publish | **Outbox** | [[19.4 - Message Queues & Event-Driven Architecture|19.4]] |
| Same record written by two callers | **Idempotency keys** | [[19.5 - API Design|19.5]] |
| "Read what I just wrote" | Read from **leader** or **bounded staleness** replica | [[19.3 - Databases at Scale|19.3]] |
| Ordered events across partitions | Single partition key OR aggregate root | [[19.4 - Message Queues & Event-Driven Architecture|19.4]] |
...
### Internal
- [[19.4 - Message Queues & Event-Driven Architecture]] — async = decoupling
- [[19.5 - API Design]] — public API + gRPC for service ↔ service
- [[19.7 - Real-Time Systems]] — real-time services are usually one big service
- [[../18 - Cybersecurity/Subject_Plan]] — mTLS + AuthZ at the mesh
- [[../20 - DevOps & SRE/Subject_Plan]] — operating the mesh + SLOs
- [[BUILDING_AT_SCALE]] — failure-domain decisions live here
...
*Next: [[19.7 - Real-Time Systems]] — Where the request/response model breaks.*
