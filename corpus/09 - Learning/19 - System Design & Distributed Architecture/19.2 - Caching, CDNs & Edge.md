...
mission: "Master the cheapest 100× in computing — caching. Browser cache → HTTP cache headers → reverse proxy → CDN → edge compute → Redis/Memcached. Plus the four invalidation strategies and stampede protection."
status: skeleton
tags: [system-design, caching, cdn, redis, memcached, cloudflare, fastly, edge-compute, cache-invalidation, http-cache]
chapter: "19.2"
prev: "[[19.1 - System Design Fundamentals]]"
next: "[[19.3 - Databases at Scale]]"
...
### Internal
- [[19.1 - System Design Fundamentals]] — latency table = caching motivation
- [[19.3 - Databases at Scale]] — what to do when caching is no longer enough
- [[19.5 - API Design]] — `Cache-Control` and `ETag` are part of the API contract
- [[19.7 - Real-Time Systems]] — when caching is the wrong answer (live data)
- [[../01- Python/1.11 - Computer Networks Essentials]] — HTTP details
...
*Next: [[19.3 - Databases at Scale]] — When the database itself must scale.*
