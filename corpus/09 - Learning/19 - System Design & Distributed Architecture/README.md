...
date: 2026-05-26
type: subject-readme
tags: [practice, refresher, drills, source-materials, study-aids, system-design, distributed-systems, scalability, microservices, caching, message-queues]
...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/sysdes__<chapter>-fig<n>.svg` and embedded inline via `![[sysdes__27.x-figN.svg]]`.
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/19 - System Design & Distributed Architecture/Subject_Plan]]
- Visual roadmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/19 - System Design & Distributed Architecture/LEARNING_PATH]]
- Concurrency primitives: [[../01- Python/1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
...
- Distributed systems & multi-GPU: [[../01- Python/1.16 - Distributed Systems & Multi-GPU Training]]
- SQL track: [[../14 - SQL/Subject_Plan]]
- ROS 2 pub/sub (same patterns): [[../32 - Robotics/22.5 - ROS 2 & Middleware - Nodes, Topics, Services, Actions, DDS]]
- Real-time multi-user (CRDTs): [[../29 - VR/24.7 - Networking, Avatars & Multi-User Spaces]]
- Cybersecurity (secure-by-design): [[../18 - Cybersecurity/Subject_Plan]]
- DevOps & SRE (operate the design): [[../20 - DevOps & SRE/Subject_Plan]]
- Cloud platforms (provider impl): [[../21 - Cloud Platforms/Subject_Plan]]
- AI/ML systems (vector DBs, RAG): [[../23 - AI & Machine Learning Systems/Subject_Plan]]
