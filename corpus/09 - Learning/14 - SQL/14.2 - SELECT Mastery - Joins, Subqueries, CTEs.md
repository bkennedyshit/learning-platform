...
mission: "Master every JOIN type, subquery pattern, and CTE composition technique with execution-plan intuition"
status: active
tags: [sql, joins, subqueries, cte, inner-join, left-join, lateral, execution-plan]
type: chapter
chapter: 14.2
prev: "[[14.1 - Relational Theory & Set Logic]]"
next: "[[14.3 - Aggregations & Window Functions]]"
---
...
- **Previous:** [[14.1 - Relational Theory & Set Logic]] — the algebra behind joins
- **Next:** [[14.3 - Aggregations & Window Functions]] — analytics on joined data
- **Performance:** [[14.5 - Indexes & Query Performance]] — making joins fast
