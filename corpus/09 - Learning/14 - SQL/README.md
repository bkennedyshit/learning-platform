...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/14 - SQL"
...
|---|---|---|
| 7.1_relational_algebra.py | [[14.1 - Relational Theory & Set Logic]] | `python "_practice/scripts/7.1_relational_algebra.py" --count 8 --seed 42` |
| 7.2_joins.py | [[14.2 - SELECT Mastery - Joins, Subqueries, CTEs]] | `python "_practice/scripts/7.2_joins.py" --count 8 --seed 42` |
| 7.3_window_functions.py | [[14.3 - Aggregations & Window Functions]] | `python "_practice/scripts/7.3_window_functions.py" --count 8 --seed 42` |
| 7.5_query_plans.py | [[14.5 - Indexes & Query Performance]] | `python "_practice/scripts/7.5_query_plans.py" --count 8 --seed 42` |
| 7.6_transactions.py | [[14.6 - Transactions, ACID & Concurrency]] | `python "_practice/scripts/7.6_transactions.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/14 - SQL/Subject_Plan]]
