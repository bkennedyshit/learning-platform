...
mission: "Learn to mix: EQ for frequency balance, compression for dynamics control, stereo field placement, and the decision-making that turns a collection of tracks into a cohesive audio presentation."
status: skeleton
tags: [mixing, eq, compression, stereo, frequency-balance, dynamics, audio-engineering, maybe-tier]
chapter: "35.5"
prev: "[[35.4 - Sampling, Slicing & Resampling]]"
next: "[[35.6 - Mastering & Loudness]]"
...
### Internal
- [[35.6 - Mastering & Loudness]] — what comes after mixing
...
*Prev: [[35.4 - Sampling, Slicing & Resampling]] | Next: [[35.6 - Mastering & Loudness]]*
