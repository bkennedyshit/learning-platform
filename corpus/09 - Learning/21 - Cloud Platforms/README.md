...
date: 2026-05-26
type: subject-readme
tags: [practice, refresher, drills, source-materials, study-aids, cloud, aws, gcp, azure, cloudflare, fly-io, hetzner, finops]
...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/cloud__<chapter>-fig<n>.svg` and embedded inline via `![[cloud__28.x-figN.svg]]`.
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/21 - Cloud Platforms/Subject_Plan]]
- Visual roadmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/21 - Cloud Platforms/LEARNING_PATH]]
- The meta-playbook this track expands: [[../BUILDING_AT_SCALE]] (especially §9)
- Containers foundation: [[../01- Python/1.9 - Docker & Containers]]
- Networks foundation: [[../01- Python/1.11 - Computer Networks Essentials]]
- Distributed-systems foundation: [[../01- Python/1.16 - Distributed Systems & Multi-GPU Training]]
- Sister track — security posture: [[../18 - Cybersecurity/Subject_Plan]]
- Sister track — operating layer: [[../20 - DevOps & SRE/Subject_Plan]]
- Sister track — architectural layer: [[../19 - System Design & Distributed Architecture/Subject_Plan]]
- AI / GPU cloud feeder: [[../23 - AI & Machine Learning Systems/Subject_Plan]]
