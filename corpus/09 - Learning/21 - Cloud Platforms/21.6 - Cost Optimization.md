...
mission: "Spot / preemptible instances, savings plans, reserved instances, committed-use discounts, autoscaling rules, scheduled scale-down, the FinOps maturity model, and cost dashboards (Vantage, Infracost, OpenCost)."
status: skeleton
tags: [cloud, finops, cost-optimization, spot, preemptible, savings-plans, reserved-instances, committed-use-discount, autoscaling, infracost, opencost, vantage, kubecost]
chapter: "21.6"
prev: "[[21.5 - Identity, IAM & Org Structure]]"
next: "[[21.7 - Multi-Cloud, Edge & Vendor Lock-In]]"
...
### Internal
- [[21.1 - The Cloud Provider Landscape 2026]] — TCO drivers
- [[21.2 - Compute Primitives]] — where right-sizing applies
- [[21.3 - Storage & Databases]] — egress + idle DB are big line items
- [[21.4 - Networking, DNS & CDN]] — egress avoidance is a cost lever
- [[21.7 - Multi-Cloud, Edge & Vendor Lock-In]] — discount lock-in is real lock-in
- [[21.8 - The Indie & Solo Cloud Stack]] — by-design cost discipline
- [[20 - DevOps & SRE/Subject_Plan]] — especially 26.8 cost-as-an-SRE concern
...
*Next: [[21.7 - Multi-Cloud, Edge & Vendor Lock-In]] — When portability is worth the complexity, and when it isn't.*
