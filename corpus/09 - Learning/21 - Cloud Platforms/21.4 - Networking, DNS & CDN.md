...
mission: "VPCs, subnets, NAT, peering, Transit Gateway, Cloudflare DNS / Route 53 / Cloud DNS, CDN strategies, anycast, BGP basics, DDoS protection, Cloudflare Tunnels and Tailscale — the network plumbing that connects every cloud workload."
status: skeleton
tags: [cloud, networking, vpc, subnet, nat, peering, transit-gateway, dns, cdn, anycast, bgp, ddos, cloudflare-tunnel, tailscale, zero-trust]
chapter: "21.4"
prev: "[[21.3 - Storage & Databases]]"
next: "[[21.5 - Identity, IAM & Org Structure]]"
...
This is the AWS canonical 3-tier pattern; GCP and Azure follow the same shape. Prerequisite reading: [[01- Python/1.11 - Computer Networks Essentials]].
...
**Architectural consequence:** if your read traffic is large and globally distributed, putting the **origin** in a non-egress-charging provider (R2 / Hetzner / B2) saves enough to fund the rest of the stack. This is the architectural seed under [[21.8 - The Indie & Solo Cloud Stack|Chapter 21.8]].
...
- [[21.2 - Compute Primitives]] — what these networks connect
- [[21.3 - Storage & Databases]] — egress is mostly a database/object-store problem
- [[21.6 - Cost Optimization]] — egress optimization tactics
- [[21.7 - Multi-Cloud, Edge & Vendor Lock-In]] — anycast and edge runtimes
- [[01- Python/1.11 - Computer Networks Essentials]] — TCP/IP foundation
- [[18 - Cybersecurity/Subject_Plan]] — perimeter, ZTNA, segmentation (especially 25.7)
...
*Next: [[21.5 - Identity, IAM & Org Structure]] — Who can do what, in which account, with which credentials.*
