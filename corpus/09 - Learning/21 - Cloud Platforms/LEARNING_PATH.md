...
mission: "Visual roadmap and progression guide for the Cloud Platforms track"
status: active
tags: [cloud, learning-path, roadmap, progression, aws, gcp, azure, cloudflare, finops]
type: learning-path
...
*Next: [[21.1 - The Cloud Provider Landscape 2026]] — Where the map gets drawn.*

---

## Related Notes
- [[21.6 - Cost Optimization]] - Shared finops/cloud focus
- [[21.8 - The Indie & Solo Cloud Stack]] - Shared cloudflare/cloud focus
- [[21.2 - Compute Primitives]] - Same Cloud Platforms folder
