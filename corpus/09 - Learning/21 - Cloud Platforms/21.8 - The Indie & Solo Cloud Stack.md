...
mission: "The BUILDING_AT_SCALE §9 playbook expanded into deployable recipes. Cloudflare Workers + D1 + R2 + Queues, OR Supabase + Fly.io, OR Railway / Render — under $200/month for the first 1,000 users, with concrete deploy steps."
status: skeleton
tags: [cloud, indie, solo, saas, cloudflare, workers, d1, r2, queues, supabase, fly-io, railway, render, neon, clerk, stripe, resend, sentry, posthog, capstone, playbook]
chapter: "21.8"
prev: "[[21.7 - Multi-Cloud, Edge & Vendor Lock-In]]"
next: "[[../00 - 09 - Learning Index|00 - 09 - Learning Index]]"
...
It directly expands [[BUILDING_AT_SCALE]] §9 (paraphrased throughout). Read in conversational tone — this is the "now go ship" chapter.
...
**Stack C (Railway / Render):** the breakpoints are usually price (the convenience tax becomes real around $300–500/mo) — at which point you containerize and move to Fly or directly onto a hyperscaler with a Compute Savings Plan ([[21.6 - Cost Optimization|Chapter 21.6]]).
...
### Internal
- [[BUILDING_AT_SCALE]] — the meta-doc this chapter expands (especially §9)
- [[21.1 - The Cloud Provider Landscape 2026]] — vendor map
- [[21.2 - Compute Primitives]] — Workers / Fly / Railway as compute shapes
- [[21.3 - Storage & Databases]] — Supabase / Neon / D1 / R2 in depth
- [[21.4 - Networking, DNS & CDN]] — Cloudflare network as the backbone
- [[21.5 - Identity, IAM & Org Structure]] — Clerk / Supabase Auth as identity
- [[21.6 - Cost Optimization]] — when to finally graduate from indie tier
- [[21.7 - Multi-Cloud, Edge & Vendor Lock-In]] — exit doors built into each stack
- [[20 - DevOps & SRE/Subject_Plan]] — operating layer (CI/CD, IaC, observability)
- [[01- Python/1.9 - Docker & Containers]] — for Stack B / C
- [[01- Python/1.16 - Distributed Systems & Multi-GPU Training]] — when AI workloads grow
...
- The cross-links to [[18 - Cybersecurity/Subject_Plan|Track 25]] (security posture), [[20 - DevOps & SRE/Subject_Plan|Track 26]] (operating layer), [[19 - System Design & Distributed Architecture/Subject_Plan|Track 27]] (architectural layer), and [[BUILDING_AT_SCALE|BUILDING_AT_SCALE]] (the meta playbook).

The cloud is no longer a black box. It's a small set of decisions you now know how to make.

*Track 21 capstone complete. Continue at the [[../00 - 09 - Learning Index|Master Learning Index]].*
