...
mission: "When multi-cloud actually makes sense (rarely), edge computing in 2026 (Cloudflare Workers, Vercel Edge, Deno Deploy, Fastly Compute@Edge), portability via Kubernetes / container standards / OpenTelemetry, and concrete exit strategies."
status: skeleton
tags: [cloud, multi-cloud, edge, edge-computing, vendor-lock-in, portability, kubernetes, opentelemetry, wintercg, deno-deploy, cloudflare-workers, vercel-edge, fastly-compute, exit-strategy]
chapter: "21.7"
prev: "[[21.6 - Cost Optimization]]"
next: "[[21.8 - The Indie & Solo Cloud Stack]]"
...
- [[21.2 - Compute Primitives]] — edge runtimes as a compute shape
- [[21.6 - Cost Optimization]] — exit-cost modeling overlap
- [[21.8 - The Indie & Solo Cloud Stack]] — concrete edge-first recipes
- [[19 - System Design & Distributed Architecture/Subject_Plan]] — especially 27.2 edge architecture
- [[BUILDING_AT_SCALE]] — section on edge-first serverless
...
*Next: [[21.8 - The Indie & Solo Cloud Stack]] — The BUILDING_AT_SCALE §9 playbook, expanded into deployable recipes.*
