...
mission: "Master the B+ tree: anatomy, height invariant, O(log n) search proof, full worked insert with node splits propagating to root, delete with rotations and merges, PostgreSQL heap page layout, and why page size equals OS page size."
status: active
tags: [databases, b-tree, b-plus-tree, page-management, node-splits, merges, rotations, postgresql, heap-page, storage-engine, index]
chapter: "16.2"
prev: "[[16.1 - Storage Engine Fundamentals]]"
next: "[[16.3 - LSM-Trees & Write-Optimized Storage]]"
...
### Internal
- [[16.1 - Storage Engine Fundamentals]] — heap files and the buffer pool that backs these pages
- [[16.3 - LSM-Trees & Write-Optimized Storage]] — the alternative to update-in-place
- [[16.6 - Concurrency Control & MVCC]] — xmin, xmax, and HOT tuple visibility
- [[16.7 - Query Processing & Execution]] — when the planner chooses an index scan vs sequential scan
- [[../14 - SQL/Subject_Plan]] — the SQL indexes you create map to these B+ tree structures
...
*Next: [[16.3 - LSM-Trees & Write-Optimized Storage]] — Why Cassandra is faster to write than Postgres, and what that costs you.*
