...
mission: "Understand what ACID actually promises at each isolation level, how those promises are enforced mechanically, the full table of read anomalies vs isolation levels, and why Snapshot Isolation ≠ Serializable."
status: active
tags: [databases, transactions, acid, atomicity, consistency, isolation, durability, isolation-levels, snapshot-isolation, serializable, anomalies, dirty-read, phantom]
chapter: "16.4"
prev: "[[16.3 - LSM-Trees & Write-Optimized Storage]]"
next: "[[16.5 - Write-Ahead Logging & Recovery]]"
...
**Enforced by:**
- Locking (2-phase locking — see [[16.6 - Concurrency Control & MVCC|chapter 16.6]])
- Multiversion concurrency control (MVCC — see [[16.6 - Concurrency Control & MVCC|chapter 16.6]])
...
**Enforced by:**
- WAL flush to disk (`fsync`) before returning commit acknowledgement (see [[16.5 - Write-Ahead Logging & Recovery|chapter 16.5]])
...
### Internal
- [[16.5 - Write-Ahead Logging & Recovery]] — how Durability is implemented mechanically
- [[16.6 - Concurrency Control & MVCC]] — how Isolation is implemented (2PL and MVCC)
- [[../14 - SQL/Subject_Plan]] — SQL-level transaction syntax
...
*Next: [[16.5 - Write-Ahead Logging & Recovery]] — How a power cut doesn't lose your committed data.*
