...
mission: "Hands-on diffusion model experiments from inference to custom LoRA training"
status: complete
tags: [ai-experiments, diffusion, sdxl, controlnet, lora, image-generation, stable-diffusion]
type: experiment-chapter
chapter: 24.2
prev: "[[24.1 - Local AI Infrastructure - CUDA, PyTorch & Multi-GPU Setup]]"
next: "[[24.3 - LLM Fine-tuning - LoRA, QLoRA & Full Fine-tuning]]"
---
...
> For full diffusion theory (score matching, ELBO, noise schedules), see [[23.6 - Generative Models - GANs & Diffusion]].
...
- Diffusion theory & math: [[23.6 - Generative Models - GANs & Diffusion]]
- GPU memory management: [[24.1 - Local AI Infrastructure - CUDA, PyTorch & Multi-GPU Setup]]
- LoRA theory (shared with LLM fine-tuning): [[24.3 - LLM Fine-tuning - LoRA, QLoRA & Full Fine-tuning]]
- Multimodal bridges: [[24.7 - Multimodal Experiments - Vision-Language & Audio-Text Bridges]]
...
> **Cross-reference:** [[23.6 - Generative Models - GANs & Diffusion]] for full diffusion theory.
