...
mission: "Sequenced progression through hands-on AI experiments with time estimates and milestones"
status: active
tags: [ai-experiments, learning-path, progression, milestones]
type: learning-path
---
...
3. **Theory:** At minimum, skim [[23.5 - Transformer Architectures & LLMs]] and [[23.6 - Generative Models - GANs & Diffusion]]
...
|---|---|
| GPU/CUDA | [[08.15 - GPU Computing & CUDA Foundations]] |
| Multi-GPU | [[08.16 - Distributed Systems & Multi-GPU Training]] |
| Transformers | [[23.5 - Transformer Architectures & LLMs]] |
| Diffusion | [[23.6 - Generative Models - GANs & Diffusion]] |
| RLHF/DPO | [[23.7 - Reinforcement Learning & RLHF]] |
| CNNs/ViTs | [[23.3 - Computer Vision - CNNs & ViTs]] |
| Backprop | [[23.2 - Deep Neural Networks - Backprop & Architecture]] |

---

## Related Notes
- [[24.1 - Local AI Infrastructure - CUDA, PyTorch & Multi-GPU Setup]] - Same AI Experiments folder
- [[24.2 - Image Generation Experiments - SDXL, ControlNet & LoRA]] - Same AI Experiments folder
- [[24.3 - LLM Fine-tuning - LoRA, QLoRA & Full Fine-tuning]] - Same AI Experiments folder
- [[24.4 - RAG Pipelines - Embeddings, Vector DBs & Retrieval]] - Same AI Experiments folder
- [[24.5 - Agentic AI - ReAct, Tool Calling & Multi-Agent Orchestration]] - Same AI Experiments folder
