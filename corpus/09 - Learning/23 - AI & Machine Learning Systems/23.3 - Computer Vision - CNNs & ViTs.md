---
tags: [ai-ml, cnn, convolution, vision-transformer, vit, pooling, feature-maps, computer-vision]
chapter: 23.3
prev: "[[23.2 - Deep Neural Networks - Backprop & Architecture]]"
next: "[[23.4 - NLP & Recurrent Models - RNNs & LSTMs]]"
---
...
**Step 5.** Process through $L$ Transformer encoder layers (see [[23.5 - Transformer Architectures & LLMs]]).
...
- Convolution as linear operation: [[2.2 - Matrix Operations & Algebra]]
- Fourier transform for convolution theorem: [[1.5 - Integral Calculus & Techniques]]
- Backpropagation through conv layers: [[23.2 - Deep Neural Networks - Backprop & Architecture]]
- Self-attention in ViT: [[23.5 - Transformer Architectures & LLMs]]
- Optimization for training CNNs: [[23.1 - Statistical Learning & Optimization]]
