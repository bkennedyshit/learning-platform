...
title: "README — 23 - AI & Machine Learning Systems"
---

# 23 - AI & Machine Learning Systems — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/23 - AI & Machine Learning Systems"
...
- [[23.2 - Deep Neural Networks - Backprop & Architecture]]
- [[23.3 - Computer Vision - CNNs & ViTs]]
- [[23.4 - NLP & Recurrent Models - RNNs & LSTMs]]
- [[23.5 - Transformer Architectures & LLMs]]
...
|---|---|---|
| 10.1_optimization.py | [[23.1 - Statistical Learning & Optimization]] | `python "_practice/scripts/10.1_optimization.py" --count 8 --seed 42` |
| 10.2_backprop.py | [[23.2 - Deep Neural Networks - Backprop & Architecture]] | `python "_practice/scripts/10.2_backprop.py" --count 8 --seed 42` |
| 10.3_cnn_vit.py | [[23.3 - Computer Vision - CNNs & ViTs]] | `python "_practice/scripts/10.3_cnn_vit.py" --count 8 --seed 42` |
| 10.4_rnn_lstm.py | [[23.4 - NLP & Recurrent Models - RNNs & LSTMs]] | `python "_practice/scripts/10.4_rnn_lstm.py" --count 8 --seed 42` |
| 10.5_attention.py | [[23.5 - Transformer Architectures & LLMs]] | `python "_practice/scripts/10.5_attention.py" --count 8 --seed 42` |
| 10.6_diffusion.py | [[23.6 - Generative Models - GANs & Diffusion]] | `python "_practice/scripts/10.6_diffusion.py" --count 8 --seed 42` |
| 10.7_rl_q_learning.py | [[23.7 - Reinforcement Learning & RLHF]] | `python "_practice/scripts/10.7_rl_q_learning.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/23 - AI & Machine Learning Systems/Subject_Plan]]
