...
mission: "The math that connects your physics brain to audio AI. FFT, filters, sampling theory, MFCCs, spectrograms — the signal chain from microphone to Whisper to XTTS to holographic wavefront. Bridges Track 07 math, Track 21 electronics, Track 23 holographics, and the voice/audio experiments in Track 05."
status: active
tags: [dsp, signal-processing, fft, fourier-transform, sampling, nyquist, filters, fir, iir, mel-filterbank, mfcc, spectrogram, audio-ai, whisper, xtts, psychoacoustics, subject-plan, curriculum]
type: subject-plan
subject: "04 - Signal Processing & DSP"
---

*Back to [[00 - 09 - Learning Index]] | Part of [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/04 - Signal Processing & DSP/LEARNING_PATH]]*
...
**The math that connects your physics brain to audio AI.** FFT, filters, sampling theory, MFCCs, spectrograms — the signal chain from microphone to Whisper to XTTS to holographic wavefront. Bridges [[../07 - Math and Physics/Subject_Plan|Track 07 Math]], [[../30 - Electronics/Subject_Plan|Track 21 Electronics]], [[../31 - Holographics/Subject_Plan|Track 23 Holographics]], and the voice/audio experiments in [[../24 - AI Experiments/Subject_Plan|Track 05]].
...
|---|---|---|
| Complex numbers & Euler's formula | [[../07 - Math and Physics/Subject_Plan|Track 07 Math]] | e^{jωt} = cos(ωt) + j·sin(ωt) underpins the Fourier Transform |
| Calculus (integration, differentiation) | [[../07 - Math and Physics/Subject_Plan|Track 07 Math]] | Fourier integrals, filter derivations |
| Linear algebra (vectors, matrices) | [[../07 - Math and Physics/Subject_Plan|Track 07 Math]] | DFT matrix, mel filterbank as matrix multiply |
| Basic Python + NumPy | [[../01- Python/Subject_Plan|Track 01 Python]] | All examples use NumPy, SciPy, Librosa |
| Waves & oscillations (physics) | [[../07 - Math and Physics/Subject_Plan|Track 07 Math]] | Intuition for sinusoids and wave superposition |
| Electronic circuits (ADC/DAC) | [[../30 - Electronics/Subject_Plan|Track 21 Electronics]] | Physical implementation of sampling |
...
*Next: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/04 - Signal Processing & DSP/LEARNING_PATH]] — Visual progression map and weekly schedule*

---

## Related Notes
- [[04.4 - Digital Filters - FIR & IIR]] - Shared dsp/fir focus
- [[04.5 - Audio Signal Processing & Psychoacoustics]] - Shared psychoacoustics/whisper focus
- [[04.7 - Speech & Voice Processing (ASR-TTS Foundations)]] - Shared whisper/mfcc focus
- [[04.8 - Spectral Analysis & Applications in AI]] - Shared audio-ai/whisper focus
