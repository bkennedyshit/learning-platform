...
mission: "Visual roadmap and progression guide for the DSP track. 8 chapters, 8 weeks, from Nyquist to Whisper."
status: active
tags: [dsp, signal-processing, learning-path, roadmap, fourier, sampling, filters, audio-ai, whisper, xtts, mfcc]
type: learning-path
...
*Next: [[04.1 - Signals, Systems & Sampling Theory]] — Build the foundation.*

---

## Related Notes
- [[04.5 - Audio Signal Processing & Psychoacoustics]] - Shared whisper/mfcc focus
