...
mission: "Master the mathematical microscope that turns time-domain signals into their frequency-domain spectrum. Fourier Series for periodic signals, Fourier Transform for arbitrary signals, Parseval's theorem, and the worked spectrum of 440 Hz + 880 Hz."
status: active
tags: [dsp, fourier-series, fourier-transform, spectrum, frequency-domain, convolution-theorem, parseval, time-frequency, signal-analysis]
chapter: "04.2"
prev: "[[04.1 - Signals, Systems & Sampling Theory]]"
next: "[[04.3 - Discrete Fourier Transform & FFT]]"
...
Related chapters: [[04.1 - Signals, Systems & Sampling Theory|04.1]] (what signals are), [[04.3 - Discrete Fourier Transform & FFT|04.3]] (computing it efficiently), [[04.5 - Audio Signal Processing & Psychoacoustics|04.5]] (applying it to audio AI).
...
7. Explain the **Gibbs phenomenon** and why it matters for windowing (preview to [[04.3 - Discrete Fourier Transform & FFT|04.3]]).

---

## 🖼️ Visual Anchor

![[dsp-04__fig2.svg|720]]
...
- Rectangular windows on DFT cause high **spectral sidelobes** (see [[04.3 - Discrete Fourier Transform & FFT|04.3]])
...
The DFT (and its fast implementation, the FFT) is what runs on computers. It's covered in full depth in [[04.3 - Discrete Fourier Transform & FFT|04.3]]. The DTFT is the theoretical bridge between continuous-time and digital-domain analysis — it appears in Z-transform theory (filter design).
...
### Internal
- [[04.1 - Signals, Systems & Sampling Theory]] — the signal foundation this chapter analyses
- [[04.3 - Discrete Fourier Transform & FFT]] — computing the transform efficiently
- [[04.4 - Digital Filters - FIR & IIR]] — filter design in the frequency domain
- [[04.5 - Audio Signal Processing & Psychoacoustics]] — mel spectrograms use log|FT|²
- [[04.6 - Image Processing & 2D Transforms]] — 2D DFT for images
- [[04.8 - Spectral Analysis & Applications in AI]] — spectral features for deep learning
- [[../07 - Math and Physics/Subject_Plan|Track 07]] — complex analysis, Euler's formula, integration
- [[../31 - Holographics/Subject_Plan|Track 23]] — wavefront propagation uses Fourier optics
...
*Next: [[04.3 - Discrete Fourier Transform & FFT]] — The algorithm that makes frequency analysis fast enough to run in real-time.*
