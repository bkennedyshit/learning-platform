...
mission: "Extend Fourier analysis to two dimensions. The 2D DFT, image filtering via convolution, edge detection with Sobel/Laplacian kernels, and the connection to holographic wavefront propagation in Track 23."
status: active
tags: [dsp, image-processing, 2d-dft, convolution, edge-detection, sobel, laplacian, gaussian-blur, fourier-optics, angular-spectrum, numpy, scipy]
chapter: "04.6"
prev: "[[04.5 - Audio Signal Processing & Psychoacoustics]]"
next: "[[04.7 - Speech & Voice Processing (ASR-TTS Foundations)]]"
...
The Fourier machinery of [[04.2 - Fourier Series & Fourier Transform|04.2]] and [[04.3 - Discrete Fourier Transform & FFT|04.3]] extends directly to two dimensions. Images become tractable with exactly the same tools: 2D DFT, 2D convolution, 2D filtering. This chapter also connects to [[../31 - Holographics/Subject_Plan|Track 23]] — holographic wavefront propagation *is* 2D Fourier optics.
...
K_x = [[-1, 0, 1], [-2, 0, 2], [-1, 0, 1]] — weighted average of horizontal differences.
K_y = [[-1,-2,-1], [0, 0, 0], [1, 2, 1]] — transpose of K_x.
...
This is the bridge between [[04.6 - Image Processing & 2D Transforms|this chapter]] and [[../31 - Holographics/Subject_Plan|Track 23]].
...
### Internal
- [[04.2 - Fourier Series & Fourier Transform]] — 1D theory extended here to 2D
- [[04.3 - Discrete Fourier Transform & FFT]] — the algorithm behind `numpy.fft.fft2`
- [[04.4 - Digital Filters - FIR & IIR]] — 2D kernels are 2D FIR filters
- [[../31 - Holographics/Subject_Plan|Track 23]] — angular spectrum method, SLM wavefronts
- [[../28 - VR & 3D Engineering/Subject_Plan|Track 09]] — texture filtering (mipmaps = lowpass filtering)
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/04 - Signal Processing & DSP/Subject_Plan]] — resource catalog
...
*Next: [[04.7 - Speech & Voice Processing (ASR-TTS Foundations)]] — How audio signals become text (Whisper) and text becomes speech (XTTS).*
