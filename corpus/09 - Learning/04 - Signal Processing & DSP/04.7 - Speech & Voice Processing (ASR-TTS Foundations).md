...
mission: "The DSP layer under Whisper and XTTS. How speech is produced (source-filter model), how ASR converts audio to text (Whisper pipeline), how TTS converts text to speech (VITS/XTTS), pitch detection, formant analysis, and the signal chain from microphone to language model."
status: active
tags: [dsp, speech, voice, asr, tts, whisper, xtts, vits, pitch-detection, formants, source-filter, mfcc, log-mel, autocorrelation, yin, librosa, huggingface]
chapter: "04.7"
prev: "[[04.6 - Image Processing & 2D Transforms]]"
next: "[[04.8 - Spectral Analysis & Applications in AI]]"
...
Prerequisite: [[04.5 - Audio Signal Processing & Psychoacoustics|04.5]]. Connect to: [[../24 - AI Experiments/Subject_Plan|Track 05]] (AI experiments), [[04.8 - Spectral Analysis & Applications in AI|04.8]].
...
### Internal
- [[04.5 - Audio Signal Processing & Psychoacoustics]] — mel features this chapter consumes
- [[04.3 - Discrete Fourier Transform & FFT]] — STFT foundation
- [[04.8 - Spectral Analysis & Applications in AI]] — spectral features for AI
- [[../24 - AI Experiments/Subject_Plan|Track 05]] — Whisper & XTTS experiments
- [[../23 - AI & Machine Learning Systems/Subject_Plan|Track 10]] — Transformer architecture
...
*Next: [[04.8 - Spectral Analysis & Applications in AI]] — How spectral DSP connects to deep learning: wav2vec2, AudioLM, EnCodec, and real-time AI audio.*
