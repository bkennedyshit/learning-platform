...
mission: "Connect the math to the ear. Mel scale, MFCCs, log-mel spectrograms, psychoacoustic masking, loudness models — everything that explains why Whisper uses 80 mel bins at 16 kHz and why codecs sound as good as they do."
status: active
tags: [dsp, audio, psychoacoustics, mel-scale, mfcc, log-mel-spectrogram, critical-bands, bark, masking, loudness, librosa, whisper, audio-features]
chapter: "04.5"
prev: "[[04.4 - Digital Filters - FIR & IIR]]"
next: "[[04.6 - Image Processing & 2D Transforms]]"
...
Prerequisite: [[04.3 - Discrete Fourier Transform & FFT|04.3]] and [[04.4 - Digital Filters - FIR & IIR|04.4]]. Related: [[04.7 - Speech & Voice Processing (ASR-TTS Foundations)|04.7]], [[04.8 - Spectral Analysis & Applications in AI|04.8]].
...
- **"MFCC[0] is the pitch."** MFCC[0] approximates log-energy (related to loudness), not pitch. Pitch is encoded in the cepstrum at a different quefrency — see [[04.8 - Spectral Analysis & Applications in AI|04.8]].
...
### Internal
- [[04.3 - Discrete Fourier Transform & FFT]] — FFT behind every mel frame
- [[04.4 - Digital Filters - FIR & IIR]] — mel filterbank = bank of bandpass filters
- [[04.7 - Speech & Voice Processing (ASR-TTS Foundations)]] — Whisper & XTTS consume these features
- [[04.8 - Spectral Analysis & Applications in AI]] — broader spectral features for AI
- [[../24 - AI Experiments/Subject_Plan|Track 05]] — TTS/ASR experiments using these features
- [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/04 - Signal Processing & DSP/Subject_Plan]] — resource catalog including Librosa docs
...
*Next: [[04.6 - Image Processing & 2D Transforms]] — The same Fourier tools applied to images: 2D DFT, convolution, edge detection.*
