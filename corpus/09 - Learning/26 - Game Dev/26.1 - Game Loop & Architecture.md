...
mission: Master the core execution model of real-time interactive applications
status: active
tags:
  - game-dev
  - game-loop
...
chapter: 26.1
track: "04"
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/26 - Game Dev/Subject_Plan]]"
next: "[[26.2 - Gameplay Programming - Input, State, AI]]"
---
...
### Internal Links
- **Next:** [[26.2 - Gameplay Programming - Input, State, AI]]
- **Engine deep-dive:** [[28.5 - Game Engine Architectures - Unity & Unreal]] — Unity/Unreal lifecycle details
- **Performance math:** [[08.12 - Computer Architecture - Performance Intuition]] — cache lines, memory hierarchy
- **Data structures for ECS:** [[08.13 - Algorithms & Data Structures in Python]] — hash maps, spatial partitioning
...
For single-player games, the one-frame latency of interpolation (16.6ms at 60Hz) is imperceptible. For competitive multiplayer, extrapolation may be combined with server reconciliation (see [[26.6 - Multiplayer & Networking]]).
