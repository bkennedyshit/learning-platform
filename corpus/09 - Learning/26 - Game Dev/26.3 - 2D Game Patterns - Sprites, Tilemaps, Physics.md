...
mission: "Master 2D game systems from pixel-art rendering to tile-based world design"
status: active
tags: [game-dev, 2d, sprites, tilemaps, physics, collision, pixel-art, platformer]
type: chapter
chapter: 26.3
track: "04"
prev: "[[26.2 - Gameplay Programming - Input, State, AI]]"
next: "[[26.4 - 3D Game Patterns - Transforms, Animation, Physics]]"
---
...
### Internal Links
- **Previous:** [[26.2 - Gameplay Programming - Input, State, AI]]
- **Next:** [[26.4 - 3D Game Patterns - Transforms, Animation, Physics]]
- **Physics math:** [[26.4 - Classical Mechanics & Dynamical Systems]] (math track) — Newtonian mechanics
- **Spatial data structures:** [[08.13 - Algorithms & Data Structures in Python]] — hash maps, trees
