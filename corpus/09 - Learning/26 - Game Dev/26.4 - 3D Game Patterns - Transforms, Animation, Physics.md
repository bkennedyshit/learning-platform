...
mission: "Implement 3D game systems from transform hierarchies to skeletal animation and physics"
status: active
tags: [game-dev, 3d, transforms, animation, physics, raycasting, skeletal, quaternion]
type: chapter
chapter: 26.4
track: "04"
prev: "[[26.3 - 2D Game Patterns - Sprites, Tilemaps, Physics]]"
next: "[[26.5 - Save Systems & Serialization]]"
---
...
### Internal Links
- **Previous:** [[26.3 - 2D Game Patterns - Sprites, Tilemaps, Physics]]
- **Next:** [[26.5 - Save Systems & Serialization]]
- **Quaternion math:** [[28.2 - Quaternions & Rotations]] — full derivation and proofs
- **3D fundamentals:** [[28.1 - 3D Math Fundamentals]] — vectors, matrices, coordinate systems
- **Rigid body math:** [[26.7 - Rigid Body Dynamics & Euler Angles]] (math track)
