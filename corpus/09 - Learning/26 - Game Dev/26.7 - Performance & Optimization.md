...
mission: "Profile, identify bottlenecks, and optimize game performance across CPU and GPU"
status: active
tags: [game-dev, performance, optimization, profiling, memory, GPU, draw-calls, LOD]
type: chapter
chapter: 26.7
track: "04"
prev: "[[26.6 - Multiplayer & Networking]]"
next: "[[26.8 - Building, Packaging & Distribution]]"
---
...
### Internal Links
- **Previous:** [[26.6 - Multiplayer & Networking]]
- **Next:** [[26.8 - Building, Packaging & Distribution]]
- **Cache architecture:** [[08.12 - Computer Architecture - Performance Intuition]]
- **Data structures:** [[08.13 - Algorithms & Data Structures in Python]] — algorithmic complexity
- **ECS performance:** [[26.1 - Game Loop & Architecture]] — SoA layout, DOTS
- **Engine profiling:** [[28.5 - Game Engine Architectures - Unity & Unreal]] — profiler tools
