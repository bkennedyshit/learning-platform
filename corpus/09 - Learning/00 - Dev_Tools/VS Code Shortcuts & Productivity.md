...
mission: Essential VS Code shortcuts and features for faster coding in interviews and daily work
status: active-reference
tags: [vscode, shortcuts, productivity, dev-tools, coding-test]
type: code-reference
---
