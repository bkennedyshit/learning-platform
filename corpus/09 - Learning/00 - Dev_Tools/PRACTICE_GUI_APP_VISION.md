...
type: vision-doc
status: planning
tags: [vision, gui-app, vite, calculator-suite, learning-tools, packaged-product]
...
2. **The calculators are already built.** The Qt/C++ tools at `[[05-Knowledge_Foundation/00 - Learning_Tools]]` are powerful but live in isolation. Pairing each with the relevant practice generator unlocks them.
...
- Master practice howto: [[09 - Learning/HOW_TO_USE_PRACTICE]]
- Master Learning Index: [[09 - Learning/00 - 09 - Learning Index]]
- Existing calculator suite vision: [[CALCULATOR_SUITE_VISION]]
- Existing build instructions: [[BUILD_INSTRUCTIONS_TLDR]]
