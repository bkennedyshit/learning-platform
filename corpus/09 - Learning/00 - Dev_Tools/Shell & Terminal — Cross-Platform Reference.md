...
tags: [shell, terminal, bash, zsh, powershell, cmd, linux, macos, windows, command-line, dev-tools]
type: reference
...
- [[08.7 - Shell, Terminal & Cross-Platform CLI]] — Python integration: subprocess, argparse, click, building CLI tools
- [[08.8 - Git & Version Control]] — Git from the command line
- [[09 - Docker & Containers]] — Docker CLI commands
- [[Terminal Commands Essentials]] — original quick reference (bash-focused)
