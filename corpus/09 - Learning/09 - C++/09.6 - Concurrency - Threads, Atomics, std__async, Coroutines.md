...
mission: "Master C++ concurrency primitives from threads and mutexes through lock-free atomics and C++20 coroutines for game engines and high-performance systems"
status: active
tags: [cpp, concurrency, threads, atomics, async, coroutines, mutex, memory-model, lock-free]
type: chapter
chapter: 09.6
prev: "[[09.5 - Standard Template Library - Containers, Algorithms, Iterators, Ranges]]"
next: "[[09.7 - Performance - SIMD, Memory Layout & Cache Optimization]]"
---
...
See [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]] for the Python side.
...
### Internal Links
- **Previous:** [[09.5 - Standard Template Library - Containers, Algorithms, Iterators, Ranges]]
- **Next:** [[09.7 - Performance - SIMD, Memory Layout & Cache Optimization]]
- **Python concurrency comparison:** [[08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL]]
- **Cache lines & false sharing:** [[09.7 - Performance - SIMD, Memory Layout & Cache Optimization]]
- **Hardware context:** [[1.12 - Computer Architecture & How Code Becomes Execution]]
