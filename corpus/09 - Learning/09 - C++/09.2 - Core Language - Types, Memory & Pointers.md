...
mission: "Master C++'s type system, value categories, pointer/reference mechanics, and memory layout — the foundation everything else builds on"
status: active
tags: [cpp, types, memory, pointers, references, value-categories, lifetime, stack, heap]
type: chapter
chapter: 09.2
prev: "[[09.1 - Setup, Build Systems & Toolchain]]"
next: "[[09.3 - OOP - Classes, Inheritance, Polymorphism & Templates]]"
---
...
### Internal Links
- **Previous:** [[09.1 - Setup, Build Systems & Toolchain]]
- **Next:** [[09.3 - OOP - Classes, Inheritance, Polymorphism & Templates]]
- **Deep dive on pointers:** [[C++ Pointers & Memory Management]] (appendix cheatsheet)
- **How memory works at hardware level:** [[1.12 - Computer Architecture & How Code Becomes Execution]]
- **Python comparison:** [[08.2 - Core Language - Syntax, Types, Control Flow & Functions]]
