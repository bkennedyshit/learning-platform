...
mission: "Master hardware-aware C++ programming — cache-friendly data layouts, SIMD vectorization, and profiling-driven optimization for game engines and HPC"
status: active
tags: [cpp, performance, simd, cache, memory-layout, optimization, profiling, SoA, AoS, data-oriented]
type: chapter
chapter: 09.7
prev: "[[09.6 - Concurrency - Threads, Atomics, std__async, Coroutines]]"
next: "[[09.8 - Game Dev with C++ - Unreal Engine & Custom Engine Patterns]]"
---
...
### Internal Links
- **Previous:** [[09.6 - Concurrency - Threads, Atomics, std__async, Coroutines]]
- **Next:** [[09.8 - Game Dev with C++ - Unreal Engine & Custom Engine Patterns]]
- **CPU architecture:** [[1.12 - Computer Architecture & How Code Becomes Execution]]
- **Game engine data patterns:** [[09.8 - Game Dev with C++ - Unreal Engine & Custom Engine Patterns]]
- **False sharing (concurrency):** [[09.6 - Concurrency - Threads, Atomics, std__async, Coroutines]]
