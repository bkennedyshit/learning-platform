...
chapter: 05.6
prev: "[[05.5 - The Default Mode Network & Cortical Entropy]]"
next: "[[05.7 - Computational Cognition - Bio vs AI Neural Nets]]"
tags: [neuroscience, neuromodulators, dopamine, serotonin, acetylcholine, reward-prediction-error, TD-learning]
status: complete
type: chapter
---
...
1. 5-HT2A agonism on Layer V pyramidals → increased cortical entropy (see [[05.5 - The Default Mode Network & Cortical Entropy]])
2. Downstream BDNF/TrkB activation → structural plasticity (new dendritic spines)
3. Shift in NMDA receptor subunit composition (NR2A → NR2B) → lower BCM threshold (see [[05.3 - Synaptic Plasticity & Hebbian Learning]])
...
- [[05.3 - Synaptic Plasticity & Hebbian Learning]] — Three-factor learning and STDP modulation
- [[05.5 - The Default Mode Network & Cortical Entropy]] — 5-HT2A and entropy
- [[05.7 - Computational Cognition - Bio vs AI Neural Nets]] — RL algorithms
- [[06 - Behavioral Psychology & Reinforcement Learning]] — Full RL theory
- [[23 - AI & Machine Learning Systems]] — Policy gradients, actor-critic
