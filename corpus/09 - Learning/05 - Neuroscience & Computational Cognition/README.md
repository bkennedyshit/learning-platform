...
title: "README — 05 - Neuroscience & Computational Cognition"
---

# 05 - Neuroscience & Computational Cognition — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/05 - Neuroscience & Computational Cognition"
...
|---|---|---|
| 11.1_cortical_anatomy.py | [[05.1 - Neuroanatomy & The Cortex]] | `python "_practice/scripts/11.1_cortical_anatomy.py" --count 8 --seed 42` |
| 11.2_hodgkin_huxley.py | [[05.2 - Action Potentials & Ion Channels]] | `python "_practice/scripts/11.2_hodgkin_huxley.py" --count 8 --seed 42` |
| 11.3_stdp_simulator.py | [[05.3 - Synaptic Plasticity & Hebbian Learning]] | `python "_practice/scripts/11.3_stdp_simulator.py" --count 8 --seed 42` |
| 11.4_callosal_transfer.py | [[05.4 - Hemispheric Lateralization & The Corpus Callosum]] | `python "_practice/scripts/11.4_callosal_transfer.py" --count 8 --seed 42` |
| 11.5_dmn_entropy.py | [[05.5 - The Default Mode Network & Cortical Entropy]] | `python "_practice/scripts/11.5_dmn_entropy.py" --count 8 --seed 42` |
| 11.6_dopamine_rpe.py | [[05.6 - Neuromodulators - Dopamine, Serotonin, Acetylcholine]] | `python "_practice/scripts/11.6_dopamine_rpe.py" --count 8 --seed 42` |
| 11.7_bio_vs_ai_compare.py | [[05.7 - Computational Cognition - Bio vs AI Neural Nets]] | `python "_practice/scripts/11.7_bio_vs_ai_compare.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/05 - Neuroscience & Computational Cognition/Subject_Plan]]
