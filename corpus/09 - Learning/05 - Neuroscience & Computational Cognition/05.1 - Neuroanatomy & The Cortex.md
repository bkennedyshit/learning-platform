...
chapter: 05.1
prev: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/05 - Neuroscience & Computational Cognition/Subject_Plan]]"
next: "[[05.2 - Action Potentials & Ion Channels]]"
tags:
  - neuroscience
  - neuroanatomy
  - cortex
...
Key graph-theoretic measures (see [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] for spectral analysis):
...
Stability requires both eigenvalues of $\mathbf{J}$ to have negative real parts (see [[3.4 - Systems of Linear ODEs & State Space]]):
...
The eigenvalues of $\mathbf{W}_{\text{local}}$ determine the intrinsic oscillatory modes of the column (see [[2.6 - Eigenvalues Eigenvectors & Diagonalization]]).
...
- **Larger corpus callosum cross-sectional area** (particularly the isthmus and splenium) — enabling faster interhemispheric transfer (see [[05.4 - Hemispheric Lateralization & The Corpus Callosum]]).
...
- [[05.2 - Action Potentials & Ion Channels]] — How individual neurons in these layers generate signals
- [[05.3 - Synaptic Plasticity & Hebbian Learning]] — How cortical connections strengthen/weaken
- [[05.4 - Hemispheric Lateralization & The Corpus Callosum]] — Bilateral cortical organization
- [[05.5 - The Default Mode Network & Cortical Entropy]] — Large-scale cortical network dynamics
- [[05.7 - Computational Cognition - Bio vs AI Neural Nets]] — Full comparison of cortical vs artificial architectures
- [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] — Spectral analysis of connectivity matrices
- [[3.4 - Systems of Linear ODEs & State Space]] — Dynamical systems analysis of Wilson-Cowan model
- [[5.5 - Microstates & Ensembles]] — Statistical mechanics of neural populations
- [[23 - AI & Machine Learning Systems]] — Artificial network architectures
- [[06 - Behavioral Psychology & Reinforcement Learning]] — Behavioral outputs of cortical computation
- [[13 - Biomechanics & Human-Computer Interface]] — Motor cortex output pathways
