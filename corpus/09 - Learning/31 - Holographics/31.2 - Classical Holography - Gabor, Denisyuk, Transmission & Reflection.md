...
mission: "Walk through the physical-recording era — Gabor's in-line geometry, Leith-Upatnieks off-axis transmission, Denisyuk reflection, rainbow + embossed holograms — and the chemistry / materials that made them work."
status: skeleton
tags: [holographics, classical-holography, gabor, leith-upatnieks, denisyuk, transmission, reflection, rainbow, embossed]
chapter: "31.2"
prev: "[[31.1 - Optics Foundations - Interference, Diffraction, Coherence, Fourier Optics]]"
next: "[[31.3 - Computer-Generated Holography - Algorithms, FFT, Neural CGH]]"
...
- **"Hologram = Princess Leia."** That's volumetric / aerial display, not a hologram in the classical optical sense. (See [[31.6 - Holographic AR - HoloLens, Magic Leap, Waveguides & the Marketing-vs-Physics Gap|31.6]].)
