...
mission: "Capstone — every layer of the holographics stack from quantum-mechanical photon emission through display hardware to a sellable product, and where the 2026 frontier (metasurfaces, neural CGH, volumetric printing) is heading."
status: skeleton
tags: [holographics, systems-stack, photons, pixels, products, capstone, frontier, metasurface, neural-cgh, volumetric-printing]
chapter: "31.8"
prev: "[[31.7 - Holography in Architecture & Engineering Visualization]]"
next: "[[../29 - VR/Subject_Plan]]"
...
3. Pipeline: weekend implementation per [[31.7 - Holography in Architecture & Engineering Visualization|31.7]].
...
- [[../29 - VR/Subject_Plan]]
- [[../32 - Robotics/Subject_Plan]] (volumetric capture overlap)
- [[../23 - AI & Machine Learning Systems/Subject_Plan]] (neural CGH)
- [[../07 - Math and Physics/09 - Quantum Mechanics & Quantum Field Theory/Subject_Plan]] (photon-level layer)
...
*Track 31 capstone complete. Continue to [[../29 - VR/Subject_Plan|29 - VR]] — the applied / business VR track that ties holographics, 3D modelling, and immersive systems together.*
