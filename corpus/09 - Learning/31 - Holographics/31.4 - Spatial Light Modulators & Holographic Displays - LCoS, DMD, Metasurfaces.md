...
mission: "The hardware that *plays* a computer-generated hologram — LCoS-SLMs, DMDs, AOMs, MEMS, and the 2026 metasurface-based SLMs that are reshaping AR/VR/LiDAR."
status: skeleton
tags: [holographics, slm, lcos, dmd, mems, metasurface, holographic-display, hardware]
chapter: "31.4"
prev: "[[31.3 - Computer-Generated Holography - Algorithms, FFT, Neural CGH]]"
next: "[[31.5 - Light-Field Displays & Volumetric Capture - Looking Glass, NeRF, 3D Gaussian Splatting]]"
...
- HoloLens 2 (waveguide combiners — see [[31.6 - Holographic AR - HoloLens, Magic Leap, Waveguides & the Marketing-vs-Physics Gap|31.6]]).
- Heads-up displays.
- Solar concentrators.
...
1. Compute a phase mask in NumPy (from [[31.3 - Computer-Generated Holography - Algorithms, FFT, Neural CGH|31.3]]).
...
- [[../30 - Electronics/21.6 - Motherboards & Computer Architecture - CPU, RAM, Chipset, PCIe, UEFI]] — driver electronics
