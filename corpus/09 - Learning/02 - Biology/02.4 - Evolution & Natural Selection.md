...
chapter: 02.4
prev: "[[02.3 - DNA, RNA & Protein Synthesis]]"
next: "[[02.5 - Ecology & Ecosystems]]"
tags: [biology, evolution, natural-selection, hardy-weinberg, population-genetics, molecular-evolution, genetic-drift, neutral-theory]
status: complete
type: chapter
---
...
- [[02.2 - Genetics & Inheritance]] — Mendelian genetics as the mechanism of inheritance
- [[02.3 - DNA, RNA & Protein Synthesis]] — Mutations in DNA provide raw material for evolution
- [[02.5 - Ecology & Ecosystems]] — Ecological context of natural selection
- [[02.8 - Modern Biology - Genomics, CRISPR, Synthetic Biology]] — Directed evolution and synthetic biology
- [[05.2 - Action Potentials & Ion Channels]] — Ion channel evolution and channelopathies
...
> **Cross-link [[10.7 - Reinforcement Learning]]:** Evolutionary game theory provides the theoretical foundation for multi-agent RL. Nash equilibria in games correspond to evolutionary stable strategies; the replicator dynamic is the continuous-time limit of policy gradient methods in self-play.
