...
mission: "Visual roadmap and progression guide for the Chemistry track"
status: active
tags: [chemistry, learning-path, roadmap, progression]
type: learning-path
...
1. **Orbitals aren't memorization** — they're solutions to the hydrogen Schrödinger equation you already solved in [[9.4 - Angular Momentum, Spin & Fine Structure]]
2. **The periodic table isn't arbitrary** — it's the filling order of quantum states ($n$, $\ell$, $m_\ell$, $m_s$)
3. **Equilibrium isn't magic** — it's the state that minimizes Gibbs free energy, which you derived from the partition function in [[5.6 - The Partition Function & Free Energy]]
...
*Next: [[03.1 - Atomic Structure & The Periodic Table]] — Where quantum mechanics becomes chemistry*
...
- [[03.5 - Acids, Bases & Equilibrium]] - Same Chemistry folder
