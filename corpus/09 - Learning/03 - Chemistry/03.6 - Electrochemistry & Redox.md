...
mission: "Connect Gibbs free energy to electrical work; master galvanic/electrolytic cells, Nernst equation, and battery chemistry"
status: complete
tags: [chemistry, electrochemistry, redox, nernst-equation, galvanic-cell, electrolysis, batteries, corrosion]
chapter: "03.6"
prev: "[[03.5 - Acids, Bases & Equilibrium]]"
next: "[[03.7 - Organic Chemistry Foundations]]"
...
|---|---|---|
| $\Delta G = -nFE$ | [[5.3 - Thermodynamic Potentials & Maxwell Relations]] | Gibbs free energy as maximum work |
| Nernst equation | [[5.6 - The Partition Function & Free Energy]] | $\Delta G = \Delta G^\circ + RT\ln Q$ |
| Battery chemistry | [[03.8 - Biochemistry & Modern Topics]] | Materials science, Li-ion design |
| Faraday's laws | [[7.1 - Electrostatics & Coulomb's Law]] | Charge and current |
| Corrosion | [[03.2 - Chemical Bonding - Ionic, Covalent, Metallic & Intermolecular]] | Metallic bonding and reactivity |
...
- [[5.3 - Thermodynamic Potentials & Maxwell Relations]] — Gibbs free energy
- [[03.5 - Acids, Bases & Equilibrium]] — $K$ and $\Delta G^\circ$
- [[03.3 - Stoichiometry & Reactions]] — Redox balancing
- [[03.8 - Biochemistry & Modern Topics]] — Battery materials, fuel cells
...
> The Nernst equation is a direct consequence of $\Delta G = \Delta G^\circ + RT\ln Q$ from [[5.3 - Thermodynamic Potentials & Maxwell Relations]]. The connection $\Delta G = -nFE$ comes from equating electrical work ($W = qE = nFE$) with the maximum non-expansion work ($W_{\max} = -\Delta G$). Electrochemistry IS thermodynamics measured in volts instead of joules.
...
This is close to the resting membrane potential (~-70 mV), confirming that K⁺ permeability dominates at rest. See [[02 - Biology]] for the full Goldman equation with multiple ions.
...
*Previous: [[03.5 - Acids, Bases & Equilibrium]] | Next: [[03.7 - Organic Chemistry Foundations]]*
