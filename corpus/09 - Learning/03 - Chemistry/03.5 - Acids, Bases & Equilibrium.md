...
mission: "Derive chemical equilibrium from statistical mechanics; master acid-base chemistry, buffers, and Le Chatelier's principle"
status: complete
tags: [chemistry, equilibrium, acids, bases, pH, buffers, le-chatelier, partition-function, Henderson-Hasselbalch]
chapter: "03.5"
prev: "[[03.4 - Thermodynamics & Kinetics]]"
next: "[[03.6 - Electrochemistry & Redox]]"
...
Chemical equilibrium is where thermodynamics meets chemistry most directly. The equilibrium constant $K$ is not an empirical number — it's derivable from the molecular partition functions you computed in [[5.6 - The Partition Function & Free Energy]]. This chapter connects that statistical mechanics foundation to the practical chemistry of acids, bases, buffers, and solubility.
...
For the gas-phase reaction $A \rightleftharpoons B$, the equilibrium condition minimizes the Gibbs free energy. From [[5.6 - The Partition Function & Free Energy]]:
...
|---|---|---|
| $K$ from partition functions | [[5.6 - The Partition Function & Free Energy]] | $K = q_{\text{prod}}/q_{\text{react}} \times e^{-\Delta\epsilon_0/k_BT}$ |
| $\Delta G^\circ = -RT\ln K$ | [[5.3 - Thermodynamic Potentials & Maxwell Relations]] | Free energy minimization |
| Le Chatelier | [[5.6 - The Partition Function & Free Energy]] | Re-minimizing $G$ after perturbation |
| pH calculations | [[1.1 - Foundations of Calculus & Real Analysis]] | Logarithms, quadratic formula |
| Buffer chemistry | [[03.8 - Biochemistry & Modern Topics]] | Biological pH regulation |
| Solubility | [[03.6 - Electrochemistry & Redox]] | Precipitation in electrochemistry |
...
- [[5.6 - The Partition Function & Free Energy]] — Statistical derivation of $K$
- [[03.4 - Thermodynamics & Kinetics]] — $\Delta G^\circ = -RT\ln K$
- [[03.6 - Electrochemistry & Redox]] — Nernst equation uses equilibrium concepts
- [[03.8 - Biochemistry & Modern Topics]] — Biological buffers and enzyme kinetics
...
Cross-link: [[03.6 - Electrochemistry & Redox]] for the Nernst equation used in boundary calculations.
...
> Buffer systems are critical in biology: blood pH (7.35–7.45) is maintained by the bicarbonate buffer, phosphate buffer, and protein buffers. Enzyme activity depends critically on pH — most enzymes have a narrow pH optimum. See [[02 - Biology]] for the physiological integration.
...
where $\Delta E_0$ is the difference in zero-point energies (from [[5.6 - The Partition Function & Free Energy]]).
...
*Previous: [[03.4 - Thermodynamics & Kinetics]] | Next: [[03.6 - Electrochemistry & Redox]]*
