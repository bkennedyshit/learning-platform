...
title: "README — 03 - Chemistry"
---

# 03 - Chemistry — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/03 - Chemistry"
...
|---|---|---|
| 16.3_stoichiometry.py | [[03.3 - Stoichiometry & Reactions]] | `python "_practice/scripts/16.3_stoichiometry.py" --count 8 --seed 42` |
| 16.5_equilibrium_ph.py | [[03.5 - Acids, Bases & Equilibrium]] | `python "_practice/scripts/16.5_equilibrium_ph.py" --count 8 --seed 42` |
| 16.6_redox_balancer.py | [[03.6 - Electrochemistry & Redox]] | `python "_practice/scripts/16.6_redox_balancer.py" --count 8 --seed 42` |
| 16.7_organic_mechanisms.py | [[03.7 - Organic Chemistry Foundations]] | `python "_practice/scripts/16.7_organic_mechanisms.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/03 - Chemistry/Subject_Plan]]
