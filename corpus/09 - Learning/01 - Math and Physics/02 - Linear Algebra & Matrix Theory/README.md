...
title: "README — 02 - Linear Algebra & Matrix Theory"
---

# 02 - Linear Algebra & Matrix Theory — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/02 - Linear Algebra & Matrix Theory"
...
|---|---|---|
| 2.1_vectors.py | [[2.1 - Vectors & Linear Combinations]] | `python "_practice/scripts/2.1_vectors.py" --count 8 --seed 42` |
| 2.2_matrices.py | [[2.2 - Matrix Multiplication & Gaussian Elimination]] | `python "_practice/scripts/2.2_matrices.py" --count 8 --seed 42` |
| 2.3_subspaces.py | [[2.3 - Vector Spaces & Subspaces]] | `python "_practice/scripts/2.3_subspaces.py" --count 8 --seed 42` |
| 2.4_transformations.py | [[2.4 - Linear Transformations & Change of Basis]] | `python "_practice/scripts/2.4_transformations.py" --count 8 --seed 42` |
| 2.5_determinants.py | [[2.5 - Determinants & Cramer's Rule]] | `python "_practice/scripts/2.5_determinants.py" --count 8 --seed 42` |
| 2.6_eigenvalues.py | [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] | `python "_practice/scripts/2.6_eigenvalues.py" --count 8 --seed 42` |
| 2.7_inner_products.py | [[2.7 - Inner Product Spaces & Orthogonality]] | `python "_practice/scripts/2.7_inner_products.py" --count 8 --seed 42` |
| 2.8_svd_tensors.py | [[2.8 - SVD & Tensors]] | `python "_practice/scripts/2.8_svd_tensors.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/02 - Linear Algebra & Matrix Theory/Subject_Plan]]
