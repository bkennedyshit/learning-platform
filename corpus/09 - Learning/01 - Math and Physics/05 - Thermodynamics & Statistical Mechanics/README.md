...
title: "README — 05 - Thermodynamics & Statistical Mechanics"
---

# 05 - Thermodynamics & Statistical Mechanics — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/05 - Thermodynamics & Statistical Mechanics"
...
|---|---|---|
| 5.1_four_laws.py | [[5.1 - The Four Laws & Temperature]] | `python "_practice/scripts/5.1_four_laws.py" --count 8 --seed 42` |
| 5.2_entropy_engines.py | [[5.2 - Entropy & Heat Engines]] | `python "_practice/scripts/5.2_entropy_engines.py" --count 8 --seed 42` |
| 5.3_potentials_maxwell.py | [[5.3 - Thermodynamic Potentials & Maxwell Relations]] | `python "_practice/scripts/5.3_potentials_maxwell.py" --count 8 --seed 42` |
| 5.4_phase_transitions.py | [[5.4 - Chemical Potential & Phase Transitions]] | `python "_practice/scripts/5.4_phase_transitions.py" --count 8 --seed 42` |
| 5.5_microstates.py | [[5.5 - Classical Statistical Mechanics - Microstates & Ensembles]] | `python "_practice/scripts/5.5_microstates.py" --count 8 --seed 42` |
| 5.6_partition_function.py | [[5.6 - The Partition Function & Free Energy]] | `python "_practice/scripts/5.6_partition_function.py" --count 8 --seed 42` |
| 5.7_maxwell_boltzmann.py | [[5.7 - Maxwell-Boltzmann Distribution & Kinetic Theory]] | `python "_practice/scripts/5.7_maxwell_boltzmann.py" --count 8 --seed 42` |
| 5.8_quantum_statistics.py | [[5.8 - Quantum Statistics - Bose-Einstein & Fermi-Dirac]] | `python "_practice/scripts/5.8_quantum_statistics.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/05 - Thermodynamics & Statistical Mechanics/Subject_Plan]]
