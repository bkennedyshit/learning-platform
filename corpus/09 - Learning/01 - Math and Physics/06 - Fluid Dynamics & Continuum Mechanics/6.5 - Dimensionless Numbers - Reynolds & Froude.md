---
tags: [fluid-dynamics, dimensionless-numbers, reynolds-number, froude-number, buckingham-pi, similitude, dimensional-analysis]
chapter: 6.5
prev: "[[6.4 - Viscous Fluids - The Navier-Stokes Equations]]"
next: "[[6.6 - Vorticity & Potential Flow]]"
---
...
where $c = \sqrt{\gamma R T / M_w}$ for an ideal gas. $M < 0.3$: incompressible. $M > 1$: supersonic (see [[6.8 - Compressible Flow & Shock Waves]]).
...
**Proof.** The dimensionless groups correspond to vectors $\mathbf{a} = (a_1, \ldots, a_n)^T$ in the null space of $\mathbf{D}$: $\mathbf{D}\mathbf{a} = \mathbf{0}$. By the rank-nullity theorem (see [[2.3 - Null Space, Column Space & Rank]]):
...
### Internal Links
- **Prerequisites:** [[2.3 - Null Space, Column Space & Rank]] (rank-nullity theorem for Buckingham Pi), [[6.4 - Viscous Fluids - The Navier-Stokes Equations]] (non-dimensionalization)
- **Applications:** [[6.7 - Boundary Layer Theory - Blasius Solution]] (Re determines boundary layer thickness), [[6.8 - Compressible Flow & Shock Waves]] (Mach number), [[6.6 - Vorticity & Potential Flow]] (high-Re inviscid approximation)
- **Related:** [[4.2 - Lagrangian Mechanics & Generalized Coordinates]] (scaling symmetries)
...
**Connection to linear algebra:** The Buckingham Pi theorem is, at its core, the rank-nullity theorem applied to the dimensional matrix. This is why [[2.3 - Null Space, Column Space & Rank]] is a prerequisite.
