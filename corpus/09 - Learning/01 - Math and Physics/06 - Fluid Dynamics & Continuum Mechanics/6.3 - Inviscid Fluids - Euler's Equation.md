---
tags: [fluid-dynamics, euler-equation, inviscid-flow, bernoulli, pressure-gradient, momentum-conservation]
chapter: 6.3
prev: "[[6.2 - Mass Conservation - The Continuity Equation]]"
next: "[[6.4 - Viscous Fluids - The Navier-Stokes Equations]]"
---
...
By Stokes' theorem (see [[1.7 - Green's Stokes' and Divergence Theorems]]):
...
For compressible flow: $p_0 = p\left(1 + \frac{\gamma - 1}{2}M^2\right)^{\gamma/(\gamma-1)}$ (see [[6.8 - Compressible Flow & Shock Waves]]).
...
Inherited from [[6.1 - Stress & Strain Tensors in Continua]], Axiom 6.1.B: the rate of change of momentum of any material volume equals the sum of body forces and surface forces.
...
### Internal Links
- **Prerequisites:** [[6.1 - Stress & Strain Tensors in Continua]] (Cauchy's equation), [[6.2 - Mass Conservation - The Continuity Equation]] (continuity), [[1.6 - Vector Fields, Div & Curl]] (curl, divergence), [[1.7 - Green's Stokes' and Divergence Theorems]] (Stokes' theorem for circulation)
- **Extensions:** [[6.4 - Viscous Fluids - The Navier-Stokes Equations]] (adds viscous terms), [[6.6 - Vorticity & Potential Flow]] (irrotational flow theory), [[6.8 - Compressible Flow & Shock Waves]] (compressible Euler)
- **Applications:** [[4.3 - Conservation Laws & Symmetry (Noether's Theorem)]] (Lagrangian mechanics connection)
