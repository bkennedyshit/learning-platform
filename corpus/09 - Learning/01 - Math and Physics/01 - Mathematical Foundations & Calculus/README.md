...
title: "README — 01 - Mathematical Foundations & Calculus"
---

# 01 - Mathematical Foundations & Calculus — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/01 - Mathematical Foundations & Calculus"
...
|---|---|---|
| 1.2_differentiation.py | [[1.2 - Single-Variable Differentiation]] | `python "_practice/scripts/1.2_differentiation.py" --count 8 --seed 42` |
| 1.3_integration.py | [[1.3 - Single-Variable Integration]] | `python "_practice/scripts/1.3_integration.py" --count 8 --seed 42` |
| 1.4_multivariable.py | [[1.4 - Multivariable Limits & Partial Derivatives]] | `python "_practice/scripts/1.4_multivariable.py" --count 8 --seed 42` |
| 1.5_multiple_integrals.py | [[1.5 - Multiple Integrals & Jacobians]] | `python "_practice/scripts/1.5_multiple_integrals.py" --count 8 --seed 42` |
| 1.6_vector_fields.py | [[1.6 - Vector Fields, Div & Curl]] | `python "_practice/scripts/1.6_vector_fields.py" --count 8 --seed 42` |
| 1.7_integral_theorems.py | [[1.7 - Green's Stokes' and Divergence Theorems]] | `python "_practice/scripts/1.7_integral_theorems.py" --count 8 --seed 42` |
| 1.8_differential_forms.py | [[1.8 - Exterior Algebra & Differential Forms]] | `python "_practice/scripts/1.8_differential_forms.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/01 - Mathematical Foundations & Calculus/Subject_Plan]]
