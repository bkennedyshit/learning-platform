---
tags: [quantum-mechanics, perturbation-theory, energy-corrections, degenerate, variational]
chapter: 9.5
prev: "[[9.4 - Angular Momentum, Spin & Fine Structure]]"
next: "[[9.6 - Relativistic QM - Klein-Gordon & Dirac Equations]]"
...
- [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] — Degenerate PT requires diagonalizing $W$ in the degenerate subspace
- [[9.3 - The 1D Infinite Square Well & Harmonic Oscillator]] — Unperturbed systems used as $\hat{H}_0$
- [[9.4 - Angular Momentum, Spin & Fine Structure]] — Fine structure derived via PT
- [[9.6 - Relativistic QM - Klein-Gordon & Dirac Equations]] — Relativistic corrections as perturbations
...
*Next: [[9.6 - Relativistic QM - Klein-Gordon & Dirac Equations]] — When particles move near the speed of light.*
