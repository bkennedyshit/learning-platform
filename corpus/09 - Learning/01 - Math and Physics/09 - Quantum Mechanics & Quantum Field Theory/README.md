...
title: "README — 09 - Quantum Mechanics & Quantum Field Theory"
---

# 09 - Quantum Mechanics & Quantum Field Theory — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/09 - Quantum Mechanics & Quantum Field Theory"
...
- [[9.1 - Wave Functions & The Schrodinger Equation]]
...
- [[9.8 - Feynman Path Integrals & QED]]
...
|---|---|---|
| 9.1_schrodinger.py | [[9.1 - Wave Functions & The Schrodinger Equation]] | `python "_practice/scripts/9.1_schrodinger.py" --count 8 --seed 42` |
| 9.2_bra_ket.py | [[9.2 - Hilbert Space & Bra-Ket Formalism]] | `python "_practice/scripts/9.2_bra_ket.py" --count 8 --seed 42` |
| 9.3_well_oscillator.py | [[9.3 - The 1D Infinite Square Well & Harmonic Oscillator]] | `python "_practice/scripts/9.3_well_oscillator.py" --count 8 --seed 42` |
| 9.4_spin.py | [[9.4 - Angular Momentum, Spin & Fine Structure]] | `python "_practice/scripts/9.4_spin.py" --count 8 --seed 42` |
| 9.5_perturbation.py | [[9.5 - Time-Independent Perturbation Theory]] | `python "_practice/scripts/9.5_perturbation.py" --count 8 --seed 42` |
| 9.6_dirac.py | [[9.6 - Relativistic QM - Klein-Gordon & Dirac Equations]] | `python "_practice/scripts/9.6_dirac.py" --count 8 --seed 42` |
| 9.7_second_quantization.py | [[9.7 - Second Quantization & Quantum Fields]] | `python "_practice/scripts/9.7_second_quantization.py" --count 8 --seed 42` |
| 9.8_path_integrals.py | [[9.8 - Feynman Path Integrals & QED]] | `python "_practice/scripts/9.8_path_integrals.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/09 - Quantum Mechanics & Quantum Field Theory/Subject_Plan]]
