...
title: "README — 11 - Control Theory & Systems Engineering"
---

# 11 - Control Theory & Systems Engineering — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/11 - Control Theory & Systems Engineering"
...
|---|---|---|
| 11.1_transfer_functions.py | [[11.1 - Laplace Transforms & Transfer Functions]] | `python "_practice/scripts/11.1_transfer_functions.py" --count 8 --seed 42` |
| 11.2_block_diagrams.py | [[11.2 - Block Diagrams & Feedback]] | `python "_practice/scripts/11.2_block_diagrams.py" --count 8 --seed 42` |
| 11.3_time_response.py | [[11.3 - Time Domain System Response]] | `python "_practice/scripts/11.3_time_response.py" --count 8 --seed 42` |
| 11.4_routh_hurwitz.py | [[11.4 - Stability & Routh-Hurwitz Criterion]] | `python "_practice/scripts/11.4_routh_hurwitz.py" --count 8 --seed 42` |
| 11.5_root_locus.py | [[11.5 - Root Locus Analysis]] | `python "_practice/scripts/11.5_root_locus.py" --count 8 --seed 42` |
| 11.6_bode_nyquist.py | [[11.6 - Frequency Response - Bode & Nyquist]] | `python "_practice/scripts/11.6_bode_nyquist.py" --count 8 --seed 42` |
| 11.7_pid.py | [[11.7 - PID Controller Design]] | `python "_practice/scripts/11.7_pid.py" --count 8 --seed 42` |
| 11.8_state_space.py | [[11.8 - Modern Control - State-Space Representation]] | `python "_practice/scripts/11.8_state_space.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan]]
