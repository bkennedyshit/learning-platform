...
prev: "[[11.7 - PID Controller Design]]"
next: "[[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan]]"
date: 2026-05-23
title: Modern Control - State-Space Representation
mission: Formulate MIMO systems in state-space form and design controllers via pole placement and state estimation
status: complete
type: chapter-note
---
...
The system $\dot{\mathbf{x}} = A\mathbf{x}$ is asymptotically stable if and only if all eigenvalues of $A$ have negative real parts. This connects directly to [[2.6 - Eigenvalues Eigenvectors & Diagonalization]].
...
- [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] — Eigenvalues, diagonalization, matrix exponential
- [[3.4 - Systems of Linear ODEs & State Space]] — ODE systems and state-space solutions
- [[11.1 - Laplace Transforms & Transfer Functions]] — Transfer function ↔ state-space conversion
- [[11.4 - Stability & Routh-Hurwitz Criterion]] — Stability via eigenvalue locations
- [[11.5 - Root Locus Analysis]] — Pole placement visualization
...
*← [[11.7 - PID Controller Design]] | Back to [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/11 - Control Theory & Systems Engineering/Subject_Plan]]*
