---
tags: [odes, laplace-transform, transfer-function, convolution, heaviside, inverse-laplace]
chapter: 3.6
prev: "[[3.5 - Fourier Series & Boundary Value Problems]]"
next: "[[3.7 - The Heat & Wave PDEs - Separation of Variables]]"
---
...
- [[3.2 - Second-Order Linear Homogeneous ODEs]] — characteristic equation appears as denominator of $Y(s)$
- [[3.3 - Nonhomogeneous ODEs & Undetermined Coefficients]] — Laplace is an alternative to undetermined coefficients
- [[3.5 - Fourier Series & Boundary Value Problems]] — Fourier transform is the imaginary-axis restriction of Laplace
