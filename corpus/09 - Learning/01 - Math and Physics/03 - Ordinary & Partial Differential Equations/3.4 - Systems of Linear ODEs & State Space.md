---
tags: [odes, systems, state-space, matrix-exponential, phase-portrait, eigenvalues]
chapter: 3.4
prev: "[[3.3 - Nonhomogeneous ODEs & Undetermined Coefficients]]"
next: "[[3.5 - Fourier Series & Boundary Value Problems]]"
---
...
**Step 1.** Since $A = SDS^{-1}$, compute $A^k = SD^kS^{-1}$ (by [[2.6 - Eigenvalues Eigenvectors & Diagonalization|Theorem 2.6.5]]).
...
**Step 3.** This matches the scalar solution $y = c_1 e^{-x} + c_2 e^{-2x}$ from [[3.2 - Second-Order Linear Homogeneous ODEs]].
...
- [[2.6 - Eigenvalues Eigenvectors & Diagonalization]] — eigendecomposition is the core tool
- [[3.2 - Second-Order Linear Homogeneous ODEs]] — scalar equations as special case
- [[3.3 - Nonhomogeneous ODEs & Undetermined Coefficients]] — forced systems
- [[3.7 - The Heat & Wave PDEs - Separation of Variables]] — infinite-dimensional analogue
