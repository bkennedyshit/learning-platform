...
title: "README — 10 - Aerospace Engineering & Orbital Mechanics"
---

# 10 - Aerospace Engineering & Orbital Mechanics — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/10 - Aerospace Engineering & Orbital Mechanics"
...
|---|---|---|
| 10.1_two_body_kepler.py | [[10.1 - Two-Body Problem & Kepler's Laws]] | `python "_practice/scripts/10.1_two_body_kepler.py" --count 8 --seed 42` |
| 10.2_orbital_elements.py | [[10.2 - Orbital Elements & Conic Sections]] | `python "_practice/scripts/10.2_orbital_elements.py" --count 8 --seed 42` |
| 10.3_hohmann.py | [[10.3 - Orbital Maneuvers - Hohmann Transfers]] | `python "_practice/scripts/10.3_hohmann.py" --count 8 --seed 42` |
| 10.4_rocket_equation.py | [[10.4 - Rocket Equation & Propulsion Systems]] | `python "_practice/scripts/10.4_rocket_equation.py" --count 8 --seed 42` |
| 10.5_atmospheric_flight.py | [[10.5 - Atmospheric Flight Dynamics]] | `python "_practice/scripts/10.5_atmospheric_flight.py" --count 8 --seed 42` |
| 10.6_attitude_dynamics.py | [[10.6 - Rigid Body Spacecraft Attitude Dynamics]] | `python "_practice/scripts/10.6_attitude_dynamics.py" --count 8 --seed 42` |
| 10.7_patched_conics.py | [[10.7 - Interplanetary Trajectories - Patched Conics]] | `python "_practice/scripts/10.7_patched_conics.py" --count 8 --seed 42` |
...
- Syllabus & curriculum mindmap: [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/10 - Aerospace Engineering & Orbital Mechanics/Subject_Plan]]
