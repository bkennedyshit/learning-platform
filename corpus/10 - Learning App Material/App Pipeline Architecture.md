...
tags: [architecture, pipeline, app, platform, technical, ingestion, API]
type: technical-spec
...
*Cross-reference: [[Bill's Vault/05-Knowledge_Foundation/10 - Learning App Material/README]] · [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/LEARNING_PLATFORM_VISION|LEARNING_PLATFORM_VISION.md]]*
...
def resolve_wikilinks(content: str, slug_map: dict) -> str:
    """
    Convert [[Note Name]] and [[Note Name|Display Text]] to relative MDX links.
    [[Bill's Vault/05-Knowledge_Foundation/09 - Learning/40 - Anatomy/README]]
