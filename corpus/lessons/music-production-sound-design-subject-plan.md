...
**From BMX content audio to game soundtracks to AI-generated music.** Synthesis, sampling, mixing, mastering, and building custom audio tools with JUCE and Python — bridging [Track 32 (DSP theory)](Subject_Plan) and [Track 05 (AI experiments)](Subject_Plan).
...
|---|---|---|
| DSP fundamentals | [Subject_Plan](Subject_Plan) | Fourier transforms, filters, convolution — the math under every plugin |
| Python | [Subject_Plan](Subject_Plan) | Audio scripting, librosa, sounddevice, JUCE Python bindings |
| Game dev sound | [Subject_Plan](Subject_Plan) | Game audio context, FMOD/Wwise awareness |
...
- [35.7 - Audio Programming with JUCE & Python](35.7---Audio-Programming-with-JUCE-&-Python) - Shared python-audio/maybe-tier focus
- [35.8 - Generative Music & AI Audio](35.8---Generative-Music-&-AI-Audio) - Shared generative-music/maybe-tier focus
- [35.3 - DAW Workflow & Signal Chain](35.3---DAW-Workflow-&-Signal-Chain) - Shared maybe-tier/daw focus
