---
title: "README — 03 - Ordinary & Partial Differential Equations"
...
# 03 - Ordinary & Partial Differential Equations — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/03 - Ordinary & Partial Differential Equations"
...
- [3.1 - First-Order ODEs - Separable & Exact](3.1---First-Order-ODEs---Separable-&-Exact)
- [3.2 - Second-Order Linear Homogeneous ODEs](3.2---Second-Order-Linear-Homogeneous-ODEs)
- [3.3 - Nonhomogeneous ODEs & Undetermined Coefficients](3.3---Nonhomogeneous-ODEs-&-Undetermined-Coefficients)
- [3.4 - Systems of Linear ODEs & State Space](3.4---Systems-of-Linear-ODEs-&-State-Space)
- [3.5 - Fourier Series & Boundary Value Problems](3.5---Fourier-Series-&-Boundary-Value-Problems)
- [3.6 - Laplace Transforms](3.6---Laplace-Transforms)
- [3.7 - The Heat & Wave PDEs - Separation of Variables](3.7---The-Heat-&-Wave-PDEs---Separation-of-Variables)
- [3.8 - Non-linear PDEs & Solitons](3.8---Non-linear-PDEs-&-Solitons)
...
|---|---|---|
| 3.1_first_order_odes.py | [3.1 - First-Order ODEs - Separable & Exact](3.1---First-Order-ODEs---Separable-&-Exact) | `python "_practice/scripts/3.1_first_order_odes.py" --count 8 --seed 42` |
| 3.2_second_order_odes.py | [3.2 - Second-Order Linear Homogeneous ODEs](3.2---Second-Order-Linear-Homogeneous-ODEs) | `python "_practice/scripts/3.2_second_order_odes.py" --count 8 --seed 42` |
| 3.3_nonhomogeneous.py | [3.3 - Nonhomogeneous ODEs & Undetermined Coefficients](3.3---Nonhomogeneous-ODEs-&-Undetermined-Coefficients) | `python "_practice/scripts/3.3_nonhomogeneous.py" --count 8 --seed 42` |
| 3.4_systems_state_space.py | [3.4 - Systems of Linear ODEs & State Space](3.4---Systems-of-Linear-ODEs-&-State-Space) | `python "_practice/scripts/3.4_systems_state_space.py" --count 8 --seed 42` |
| 3.5_fourier_series.py | [3.5 - Fourier Series & Boundary Value Problems](3.5---Fourier-Series-&-Boundary-Value-Problems) | `python "_practice/scripts/3.5_fourier_series.py" --count 8 --seed 42` |
| 3.6_laplace.py | [3.6 - Laplace Transforms](3.6---Laplace-Transforms) | `python "_practice/scripts/3.6_laplace.py" --count 8 --seed 42` |
| 3.7_heat_wave_pdes.py | [3.7 - The Heat & Wave PDEs - Separation of Variables](3.7---The-Heat-&-Wave-PDEs---Separation-of-Variables) | `python "_practice/scripts/3.7_heat_wave_pdes.py" --count 8 --seed 42` |
| 3.8_nonlinear_pdes.py | [3.8 - Non-linear PDEs & Solitons](3.8---Non-linear-PDEs-&-Solitons) | `python "_practice/scripts/3.8_nonlinear_pdes.py" --count 8 --seed 42` |
