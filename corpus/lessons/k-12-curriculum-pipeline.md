...
*Cross-reference: [Subject Gap Manifest](Subject-Gap-Manifest) · [README](README) · [K-5 Early Elementary Pipeline](K-5-Early-Elementary-Pipeline) · [6-8 Middle School Pipeline](6-8-Middle-School-Pipeline) · [9-12 High School Pipeline](9-12-High-School-Pipeline) · [Higher Education Pipeline](Higher-Education-Pipeline)*
...
- [K-5 Early Elementary Pipeline](K-5-Early-Elementary-Pipeline) — Full K-5 subject detail
- [6-8 Middle School Pipeline](6-8-Middle-School-Pipeline) — Full 6-8 subject detail
- [9-12 High School Pipeline](9-12-High-School-Pipeline) — Full 9-12 subject detail
- [Higher Education Pipeline](Higher-Education-Pipeline) — College entry courses
- [Subject Gap Manifest](Subject-Gap-Manifest) — Prioritized build list
- [App Pipeline Architecture](App-Pipeline-Architecture) — Technical delivery spec
