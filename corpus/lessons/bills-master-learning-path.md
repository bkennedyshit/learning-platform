...
|-------|-----------|------|
| [08 - Python]() | Complete `00_Basics` → `01_Control Flow` → `02_Functions` → `03_OOP`. Then: file I/O, APIs, error handling. Build CLI tools. | `08 - Python/` |
| [07 - Math (Calculus)]() | Refresh derivatives + chain rule (backbone of backprop). Chapters 1.1–1.4. | On demand |
| [07 - Math (Linear Algebra)]() | Vectors, matrices, eigenvalues. Chapters 2.1–2.6. This is the language of neural nets. | On demand |
| [07 - Math (Probability)]() | Bayes, distributions, conditional probability. | On demand |
| [Dev Tools]() | Shell, cmd, Linux/Mac commands, Docker, Git — fold into Python workflow. | `00 - Dev_Tools/` |
...
| Track | What to do | Link |
|-------|-----------|------|
| [24 - AI Experiments](24---AI-Experiments) | Start building. Fine-tune a local model. Run inference. Train something small from scratch. | `24 - AI Experiments/` |
| [10 - AI & ML Systems]() | You wrote the theory. Now implement: backprop by hand in NumPy, train a CNN, build a transformer from scratch. | `10 - AI & ML Systems/` |
...
| Track | What to do | Link |
|-------|-----------|------|
| [25 - Game Design](25---Game-Design) | Game loops, player motivation, core mechanics. Build GDDs. | `25 - Game Design/` (build out) |
| [26 - Game Dev](26---Game-Dev) | Unity projects: 2D sim (Stardew-style), 3D prototype, VR room-scale. | `26 - Game Dev/` (build out) |
| [28 - VR 09 - VR & 3D 3D Engineering]() | Already complete (7 chapters). Revisit 9.5 (Unity/Unreal architectures) and 9.7 (spatial interaction). | `28 - VR 09 - VR & 3D 3D Engineering/` |
| [10 - C#]() | Build out for Unity scripting. You have the basics note; expand with projects. | `10 - C#/` |
...
| Track | What to do | Link |
|-------|-----------|------|
| [13 - TypeScript]() | Full language mastery. Types, generics, utility types, module systems. | `13 - TypeScript/` |
| [12 - JavaScript]() | Quick refresher — you knew this. Focus on modern ES6+ patterns. | `12 - JavaScript/` |
| [22 - App Architectures]() | Already complete (5 chapters). Revisit React/Next.js (8.1) and Vite (8.3) for SaaS builds. | `22 - App Architectures/` |
...
| [09 - C++]() | Unreal Engine, custom engines, CUDA kernels. | `09 - C++/` |
| [14 - SQL]() | Database layer for any production app. Learn when you need it. | `14 - SQL/` |
...
| [14 - Spanish](14---Spanish) | In progress. Cultural breadth + business expansion. | `14 - Spanish/` |
| [15 - Japanese](15---Japanese) | In progress. Cultural breadth + game industry. | `15 - Japanese/` |
| [05 - Neuroscience]() | Already complete (7 chapters). Personal R&D — bio neurons ↔ AI parallels. | `05 - Neuroscience/` |
| [06 - Behavioral Psych & RL]() | Already complete (6 chapters). Dopamine, RLHF, trauma-as-RL. | `06 - Behavioral Psych/` |
| [34 - Biomechanics & HCI]() | Already complete (7 chapters). BMX rotational dynamics, HRV, sensor fusion. Your body is the lab. | `34 - Biomechanics/` |
...
- [x] **Do I need linear algebra?** → Yes. Matrix ops = neural network forward pass. You have [Track 07-02](Subject_Plan) (8 chapters). Use NumPy to practice.
...
- [x] **Do I need calculus?** → Derivatives + chain rule = backpropagation. That's 80% of what you need. You have [Track 07-01](Subject_Plan) (8 chapters).
...
|---------|-----------|-------------------|
| Supervised Learning | Training with labeled data | [10.1]() |
| Neural Networks | Algorithms mimicking the brain | [10.2]() |
| Gradient Descent | Optimization during training | [10.1]() + calculus refresh |
| Transformers | The architecture behind LLMs | [10.5]() |
| RLHF | How LLMs get aligned | [10.7]() + [12.6]() |
...
## Related Notes
- [00 - 09 - Learning Index](00---09---Learning-Index) - Same Learning folder
