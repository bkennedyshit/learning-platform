...
*Back to [Subject_Plan](Subject_Plan) | [09 - Learning Index](09---Learning-Index)*
...
|-------------|----------------|--------|
| Python fluency (variables, functions, OOP, modules) | [Track 01 Python](Track-01-Python) — Chapters 1.1–1.3 | ✅ |
| Basic understanding of how computers execute code | [1.12 - Computer Architecture & How Code Becomes Execution](1.12---Computer-Architecture-&-How-Code-Becomes-Execution) | ✅ |
...
| Track | Why | When |
|-------|-----|------|
| [Track 09 VR & 3D Engineering](Track-09-VR-&-3D-Engineering) | Engine architecture context, rendering pipelines | During Phase 2–3 |
| [Track 04 Game_Dev](Track-04-Game_Dev) | Game design patterns, ECS architecture | During Phase 3 |
| [08.4 - Concurrency - asyncio, threading, multiprocessing & the GIL](08.4---Concurrency---asyncio,-threading,-multiprocessing-&-the-GIL) | Compare Python's concurrency model to C++ | During Ch 09.6 |
| [1.12 - Computer Architecture & How Code Becomes Execution](1.12---Computer-Architecture-&-How-Code-Becomes-Execution) | CPU caches, pipelines, branch prediction | During Ch 09.7 |
| [28.5 - Game Engine Architectures - Unity & Unreal](28.5---Game-Engine-Architectures---Unity-&-Unreal) | High-level engine design | During Ch 09.8 |
...
- [C++ Pointers & Memory Management](C++-Pointers-&-Memory-Management) — Raw pointer mechanics refresher
- [C++ Basics for Game Dev](C++-Basics-for-Game-Dev) — Condensed game-dev C++ syntax
...
## Related Notes
- [09.8 - Game Dev with C++ - Unreal Engine & Custom Engine Patterns](09.8---Game-Dev-with-C++---Unreal-Engine-&-Custom-Engine-Patterns) - Shared game-dev/cpp focus
- [Subject_Plan](Subject_Plan) - Shared game-dev/cpp focus
- [09.1 - Setup, Build Systems & Toolchain](09.1---Setup,-Build-Systems-&-Toolchain) - Same C++ folder
