...
- [10 - AI/ML Systems](Subject_Plan) needs deployment + cost + observability for inference.
- [18 - Cybersecurity](Subject_Plan) consumes our supply-chain signing + SBOM attestations.
- [27 - System Design](Subject_Plan) is the *what to build*; this track is the *how to ship and keep it up*.
- [21 - Cloud Platforms](Subject_Plan) is where this track's IaC and Kubernetes finally land.
- [BUILDING_AT_SCALE](BUILDING_AT_SCALE) consumes everything here for the productization story.
...
|---|---|---|
| Git fluency | [1.8 - Git & Version Control](1.8---Git-&-Version-Control) | GitOps starts with Git as source of truth |
| Docker fundamentals | [1.9 - Docker & Containers](1.9---Docker-&-Containers) | Every modern deploy is a container image |
| Operating systems | [1.10 - Operating Systems Essentials](1.10---Operating-Systems-Essentials) | Linux primitives — cgroups, namespaces, signals — are the substrate |
| Networking | [1.11 - Computer Networks Essentials](1.11---Computer-Networks-Essentials) | Service mesh, ingress, DNS, TLS termination |
| Distributed systems | [1.16 - Distributed Systems & Multi-GPU Training](1.16---Distributed-Systems-&-Multi-GPU-Training) | CAP, consensus, retries, timeouts |
| Building at scale survey | [BUILDING_AT_SCALE](BUILDING_AT_SCALE) | The bigger picture this track plugs into |

---

## 🆓 Premium-Free Resource Catalog

> Pictures, videos, and reference materials live **outside the repo** (YouTube, official docs, open-source books). Each chapter and the [README](README) hub link to them by URL. SVG diagrams that we author live inside `../_svgs/` with the `devops__<ch>-fig<n>.svg` prefix.
...
- [20.4 - Observability - Logs, Metrics, Traces](20.4---Observability---Logs,-Metrics,-Traces) - Shared observability/opentelemetry focus
- [20.5 - SLOs, SLAs, Error Budgets & Incident Response](20.5---SLOs,-SLAs,-Error-Budgets-&-Incident-Response) - Shared error-budget/devops focus
- [20.6 - Chaos Engineering & Resilience](20.6---Chaos-Engineering-&-Resilience) - Shared chaos-engineering/devops focus
