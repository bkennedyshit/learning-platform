...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/11 - Rust"
...
- [11.1 - Setup, Cargo & Project Structure](11.1---Setup,-Cargo-&-Project-Structure)
- [11.2 - Ownership, Borrowing & Lifetimes](11.2---Ownership,-Borrowing-&-Lifetimes)
- [11.3 - Type System - Enums, Traits & Generics](11.3---Type-System---Enums,-Traits-&-Generics)
- [11.4 - Error Handling - Result, Option & the Question-Mark Operator](11.4---Error-Handling---Result,-Option-&-the-Question-Mark-Operator)
- [11.5 - Concurrency - Threads, Send_Sync, async_await & Tokio](11.5---Concurrency---Threads,-Send_Sync,-async_await-&-Tokio)
- [11.6 - Memory - Box, Rc, Arc, RefCell, Mutex](11.6---Memory---Box,-Rc,-Arc,-RefCell,-Mutex)
- [11.7 - Idiomatic Rust - Patterns, Anti-patterns & Performance](11.7---Idiomatic-Rust---Patterns,-Anti-patterns-&-Performance)
- [11.8 - Production Rust - WebAssembly, FFI, Embedded & Game Dev (Bevy)](11.8---Production-Rust---WebAssembly,-FFI,-Embedded-&-Game-Dev-(Bevy))
...
|---|---|---|
| 14.2_ownership_drills.py | [11.2 - Ownership, Borrowing & Lifetimes](11.2---Ownership,-Borrowing-&-Lifetimes) | `python "_practice/scripts/14.2_ownership_drills.py" --count 8 --seed 42` |
| rust_lab_runner.py | — | `python "_practice/scripts/rust_lab_runner.py" --count 8 --seed 42` |
