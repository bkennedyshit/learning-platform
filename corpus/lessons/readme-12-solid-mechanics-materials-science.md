---
title: "README — 12 - Solid Mechanics & Materials Science"
...
# 12 - Solid Mechanics & Materials Science — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/12 - Solid Mechanics & Materials Science"
...
- [12.1 - Statics & Equilibrium](12.1---Statics-&-Equilibrium)
- [12.2 - Stress & Strain Tensors](12.2---Stress-&-Strain-Tensors)
- [12.3 - Hooke's Law & Material Properties](12.3---Hooke's-Law-&-Material-Properties)
- [12.4 - Axial Loading & Torsion](12.4---Axial-Loading-&-Torsion)
- [12.5 - Bending of Beams & Shear Stress](12.5---Bending-of-Beams-&-Shear-Stress)
- [12.6 - Principal Stresses - Mohr's Circle](12.6---Principal-Stresses---Mohr's-Circle)
- [12.7 - Yield Criteria - Von Mises & Tresca](12.7---Yield-Criteria---Von-Mises-&-Tresca)
...
|---|---|---|
| 12.1_statics.py | [12.1 - Statics & Equilibrium](12.1---Statics-&-Equilibrium) | `python "_practice/scripts/12.1_statics.py" --count 8 --seed 42` |
| 12.2_stress_strain.py | [12.2 - Stress & Strain Tensors](12.2---Stress-&-Strain-Tensors) | `python "_practice/scripts/12.2_stress_strain.py" --count 8 --seed 42` |
| 12.3_hookes_law.py | [12.3 - Hooke's Law & Material Properties](12.3---Hooke's-Law-&-Material-Properties) | `python "_practice/scripts/12.3_hookes_law.py" --count 8 --seed 42` |
| 12.4_axial_torsion.py | [12.4 - Axial Loading & Torsion](12.4---Axial-Loading-&-Torsion) | `python "_practice/scripts/12.4_axial_torsion.py" --count 8 --seed 42` |
| 12.5_beam_bending.py | [12.5 - Bending of Beams & Shear Stress](12.5---Bending-of-Beams-&-Shear-Stress) | `python "_practice/scripts/12.5_beam_bending.py" --count 8 --seed 42` |
| 12.6_mohrs_circle.py | [12.6 - Principal Stresses - Mohr's Circle](12.6---Principal-Stresses---Mohr's-Circle) | `python "_practice/scripts/12.6_mohrs_circle.py" --count 8 --seed 42` |
| 12.7_yield_criteria.py | [12.7 - Yield Criteria - Von Mises & Tresca](12.7---Yield-Criteria---Von-Mises-&-Tresca) | `python "_practice/scripts/12.7_yield_criteria.py" --count 8 --seed 42` |
