...
|---|---|---|
| Python comfort (functions, classes, modules) | Can you write a class with `__init__`, use list comprehensions, handle exceptions? | Complete [08.3 - OOP, Data Models & Pythonic Idioms](08.3---OOP,-Data-Models-&-Pythonic-Idioms) first |
| JavaScript basics (variables, functions, DOM) | Can you explain `let` vs `const`, arrow functions, `this` binding? | Refresh via [Track 05 JavaScript](Track-05-JavaScript) or MDN's [JS Guide](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide) (2–3 days) |
...
- **Subject Plan:** [Subject_Plan](Subject_Plan)
- **First Chapter:** [13.1 - Setup, Compilation & Project Structure](13.1---Setup,-Compilation-&-Project-Structure)
- **Interview Prep:** [TypeScript Essentials for Coding Tests](TypeScript-Essentials-for-Coding-Tests)
- **Related Tracks:** [Track 05 JavaScript](Track-05-JavaScript) | [22.1 - React & Next.js - Functional Components & Hooks](22.1---React-&-Next.js---Functional-Components-&-Hooks)
...
## Related Notes
- [Subject_Plan](Subject_Plan) - Shared typescript/career focus
- [13.2 - Type System - Primitives, Unions, Intersections, Generics](13.2---Type-System---Primitives,-Unions,-Intersections,-Generics) - Same TypeScript folder
- [13.3 - Advanced Types - Conditional, Mapped, Template Literal Types](13.3---Advanced-Types---Conditional,-Mapped,-Template-Literal-Types) - Same TypeScript folder
