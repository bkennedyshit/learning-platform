...
5. Build the storage layer for the indie-stack workload from [Chapter 21.8](21.8---The-Indie-&-Solo-Cloud-Stack).
...
**Total ~ $30–35/month** for the storage layer. The compute layer in [Chapter 21.2](21.2---Compute-Primitives) adds $5–25 depending on choice. **Total stack < $60/month** for the first thousand users.
...
- [21.2 - Compute Primitives](21.2---Compute-Primitives) — compute that talks to this storage
- [21.6 - Cost Optimization](21.6---Cost-Optimization) — egress is a database problem too
- [21.8 - The Indie & Solo Cloud Stack](21.8---The-Indie-&-Solo-Cloud-Stack) — the indie storage picks
- [1.16 - Distributed Systems & Multi-GPU Training](1.16---Distributed-Systems-&-Multi-GPU-Training) — replication, partitioning, consistency
- [Subject_Plan](Subject_Plan) — databases at scale, especially 27.3
- [Subject_Plan](Subject_Plan) — vector DBs in the AI stack
...
*Next: [21.4 - Networking, DNS & CDN](21.4---Networking,-DNS-&-CDN) — How packets get to your storage and compute, and how to keep the egress bill rational.*
