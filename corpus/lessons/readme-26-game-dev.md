...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/26 - Game Dev"
...
- [26.1 - Game Loop & Architecture](26.1---Game-Loop-&-Architecture)
- [26.2 - Gameplay Programming - Input, State, AI](26.2---Gameplay-Programming---Input,-State,-AI)
- [26.3 - 2D Game Patterns - Sprites, Tilemaps, Physics](26.3---2D-Game-Patterns---Sprites,-Tilemaps,-Physics)
- [26.4 - 3D Game Patterns - Transforms, Animation, Physics](26.4---3D-Game-Patterns---Transforms,-Animation,-Physics)
- [26.5 - Save Systems & Serialization](26.5---Save-Systems-&-Serialization)
- [26.6 - Multiplayer & Networking](26.6---Multiplayer-&-Networking)
- [26.7 - Performance & Optimization](26.7---Performance-&-Optimization)
- [26.8 - Building, Packaging & Distribution](26.8---Building,-Packaging-&-Distribution)
...
|---|---|---|
| 4.1_game_loop.py | [26.1 - Game Loop & Architecture](26.1---Game-Loop-&-Architecture) | `python "_practice/scripts/4.1_game_loop.py" --count 8 --seed 42` |
| 4.2_state_machines.py | [26.2 - Gameplay Programming - Input, State, AI](26.2---Gameplay-Programming---Input,-State,-AI) | `python "_practice/scripts/4.2_state_machines.py" --count 8 --seed 42` |
| 4.6_netcode_sim.py | [26.6 - Multiplayer & Networking](26.6---Multiplayer-&-Networking) | `python "_practice/scripts/4.6_netcode_sim.py" --count 8 --seed 42` |
