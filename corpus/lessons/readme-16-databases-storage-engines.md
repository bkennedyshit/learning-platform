...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/dbs__<chapter>-fig<n>.svg` and embedded inline via `![dbs__30.x-figN](dbs__30.x-figN.svg)`.
...
- [16.1 - Storage Engine Fundamentals](16.1---Storage-Engine-Fundamentals)
- [16.2 - B-Trees & Page Management](16.2---B-Trees-&-Page-Management)
- [16.3 - LSM-Trees & Write-Optimized Storage](16.3---LSM-Trees-&-Write-Optimized-Storage)
- [16.4 - Transaction Management & ACID](16.4---Transaction-Management-&-ACID)
- [16.5 - Write-Ahead Logging & Recovery](16.5---Write-Ahead-Logging-&-Recovery)
- [16.6 - Concurrency Control & MVCC](16.6---Concurrency-Control-&-MVCC)
- [16.7 - Query Processing & Execution](16.7---Query-Processing-&-Execution)
- [16.8 - Distributed Databases & Replication](16.8---Distributed-Databases-&-Replication)
...
- SQL querying fundamentals: [Subject_Plan](Subject_Plan)
- OS essentials (disk I/O, page cache): [1.10 - Operating Systems Essentials](1.10---Operating-Systems-Essentials)
- Networking essentials: [1.11 - Computer Networks Essentials](1.11---Computer-Networks-Essentials)
- Concurrency model (threads, locks): [1.4 - Concurrency - asyncio, threading, multiprocessing & the GIL](1.4---Concurrency---asyncio,-threading,-multiprocessing-&-the-GIL)
- System Design (when to choose which DB): [Subject_Plan](Subject_Plan)
- System Design — Databases at Scale: [27.3 - Databases at Scale](27.3---Databases-at-Scale)
- DevOps & SRE (autovacuum, replication monitoring): [Subject_Plan](Subject_Plan)
- Cloud Platforms (RDS, Aurora, Spanner): [Subject_Plan](Subject_Plan)
- Rust (build your own storage engine): [Subject_Plan](Subject_Plan)
- AI/ML Systems (vector indexes, pgvector): [Subject_Plan](Subject_Plan)
