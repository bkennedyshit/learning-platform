---
title: "README — 06 - Fluid Dynamics & Continuum Mechanics"
...
# 06 - Fluid Dynamics & Continuum Mechanics — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/06 - Fluid Dynamics & Continuum Mechanics"
...
- [6.1 - Stress & Strain Tensors in Continua](6.1---Stress-&-Strain-Tensors-in-Continua)
- [6.2 - Mass Conservation - The Continuity Equation](6.2---Mass-Conservation---The-Continuity-Equation)
- [6.3 - Inviscid Fluids - Euler's Equation](6.3---Inviscid-Fluids---Euler's-Equation)
- [6.4 - Viscous Fluids - The Navier-Stokes Equations](6.4---Viscous-Fluids---The-Navier-Stokes-Equations)
- [6.5 - Dimensionless Numbers - Reynolds & Froude](6.5---Dimensionless-Numbers---Reynolds-&-Froude)
- [6.6 - Vorticity & Potential Flow](6.6---Vorticity-&-Potential-Flow)
- [6.7 - Boundary Layer Theory - Blasius Solution](6.7---Boundary-Layer-Theory---Blasius-Solution)
- [6.8 - Compressible Flow & Shock Waves](6.8---Compressible-Flow-&-Shock-Waves)
...
|---|---|---|
| 6.1_stress_strain.py | [6.1 - Stress & Strain Tensors in Continua](6.1---Stress-&-Strain-Tensors-in-Continua) | `python "_practice/scripts/6.1_stress_strain.py" --count 8 --seed 42` |
| 6.2_continuity.py | [6.2 - Mass Conservation - The Continuity Equation](6.2---Mass-Conservation---The-Continuity-Equation) | `python "_practice/scripts/6.2_continuity.py" --count 8 --seed 42` |
| 6.3_euler.py | [6.3 - Inviscid Fluids - Euler's Equation](6.3---Inviscid-Fluids---Euler's-Equation) | `python "_practice/scripts/6.3_euler.py" --count 8 --seed 42` |
| 6.4_navier_stokes.py | [6.4 - Viscous Fluids - The Navier-Stokes Equations](6.4---Viscous-Fluids---The-Navier-Stokes-Equations) | `python "_practice/scripts/6.4_navier_stokes.py" --count 8 --seed 42` |
| 6.5_dimensionless.py | [6.5 - Dimensionless Numbers - Reynolds & Froude](6.5---Dimensionless-Numbers---Reynolds-&-Froude) | `python "_practice/scripts/6.5_dimensionless.py" --count 8 --seed 42` |
| 6.6_vorticity.py | [6.6 - Vorticity & Potential Flow](6.6---Vorticity-&-Potential-Flow) | `python "_practice/scripts/6.6_vorticity.py" --count 8 --seed 42` |
| 6.7_boundary_layer.py | [6.7 - Boundary Layer Theory - Blasius Solution](6.7---Boundary-Layer-Theory---Blasius-Solution) | `python "_practice/scripts/6.7_boundary_layer.py" --count 8 --seed 42` |
| 6.8_compressible.py | [6.8 - Compressible Flow & Shock Waves](6.8---Compressible-Flow-&-Shock-Waves) | `python "_practice/scripts/6.8_compressible.py" --count 8 --seed 42` |
