...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/devops__<chapter>-fig<n>.svg` and embedded inline via `![devops__26.x-figN](devops__26.x-figN.svg)`.
...
- [20.1 - CI-CD Foundations](20.1---CI-CD-Foundations)
- [20.2 - Infrastructure as Code](20.2---Infrastructure-as-Code)
- [20.3 - Containers & Orchestration](20.3---Containers-&-Orchestration)
- [20.4 - Observability - Logs, Metrics, Traces](20.4---Observability---Logs,-Metrics,-Traces)
- [20.5 - SLOs, SLAs, Error Budgets & Incident Response](20.5---SLOs,-SLAs,-Error-Budgets-&-Incident-Response)
- [20.6 - Chaos Engineering & Resilience](20.6---Chaos-Engineering-&-Resilience)
- [20.7 - Deployment Strategies](20.7---Deployment-Strategies)
- [20.8 - Cost & Capacity Engineering - FinOps](20.8---Cost-&-Capacity-Engineering---FinOps)
...
- Git fluency prerequisite: [1.8 - Git & Version Control](1.8---Git-&-Version-Control)
- Docker prerequisite: [1.9 - Docker & Containers](1.9---Docker-&-Containers)
- OS / Networking prereqs: [1.10 - Operating Systems Essentials](1.10---Operating-Systems-Essentials) · [1.11 - Computer Networks Essentials](1.11---Computer-Networks-Essentials)
- Distributed systems prereq: [1.16 - Distributed Systems & Multi-GPU Training](1.16---Distributed-Systems-&-Multi-GPU-Training)
- Cybersecurity (parallel track): [Subject_Plan](Subject_Plan)
- System design (parallel track): [Subject_Plan](Subject_Plan)
- Cloud platforms (parallel track): [Subject_Plan](Subject_Plan)
- Building at scale: [BUILDING_AT_SCALE](BUILDING_AT_SCALE)
