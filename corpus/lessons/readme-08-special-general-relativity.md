---
title: "README — 08 - Special & General Relativity"
...
# 08 - Special & General Relativity — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/07 - Math and Physics/08 - Special & General Relativity"
...
- [8.1 - Special Relativity Postulates & Lorentz Boosts](8.1---Special-Relativity-Postulates-&-Lorentz-Boosts)
- [8.2 - Minkowski Spacetime & 4-Vectors](8.2---Minkowski-Spacetime-&-4-Vectors)
- [8.3 - Covariant Relativistic Dynamics](8.3---Covariant-Relativistic-Dynamics)
- [8.4 - Equivalence Principle & Curved Spacetime](8.4---Equivalence-Principle-&-Curved-Spacetime)
- [8.5 - Differential Geometry - Manifolds & Metrics](8.5---Differential-Geometry---Manifolds-&-Metrics)
- [8.6 - Covariant Derivative & Christoffel Symbols](8.6---Covariant-Derivative-&-Christoffel-Symbols)
- [8.7 - Geodesics & Curvature - Riemann & Ricci Tensors](8.7---Geodesics-&-Curvature---Riemann-&-Ricci-Tensors)
- [8.8 - Einstein Field Equations & Schwarzschild Black Holes](8.8---Einstein-Field-Equations-&-Schwarzschild-Black-Holes)
...
|---|---|---|
| 8.1_lorentz_boosts.py | [8.1 - Special Relativity Postulates & Lorentz Boosts](8.1---Special-Relativity-Postulates-&-Lorentz-Boosts) | `python "_practice/scripts/8.1_lorentz_boosts.py" --count 8 --seed 42` |
| 8.2_minkowski.py | [8.2 - Minkowski Spacetime & 4-Vectors](8.2---Minkowski-Spacetime-&-4-Vectors) | `python "_practice/scripts/8.2_minkowski.py" --count 8 --seed 42` |
| 8.3_covariant_dynamics.py | [8.3 - Covariant Relativistic Dynamics](8.3---Covariant-Relativistic-Dynamics) | `python "_practice/scripts/8.3_covariant_dynamics.py" --count 8 --seed 42` |
| 8.4_equivalence.py | [8.4 - Equivalence Principle & Curved Spacetime](8.4---Equivalence-Principle-&-Curved-Spacetime) | `python "_practice/scripts/8.4_equivalence.py" --count 8 --seed 42` |
| 8.5_manifolds_metrics.py | [8.5 - Differential Geometry - Manifolds & Metrics](8.5---Differential-Geometry---Manifolds-&-Metrics) | `python "_practice/scripts/8.5_manifolds_metrics.py" --count 8 --seed 42` |
| 8.6_christoffel.py | [8.6 - Covariant Derivative & Christoffel Symbols](8.6---Covariant-Derivative-&-Christoffel-Symbols) | `python "_practice/scripts/8.6_christoffel.py" --count 8 --seed 42` |
| 8.7_riemann_ricci.py | [8.7 - Geodesics & Curvature - Riemann & Ricci Tensors](8.7---Geodesics-&-Curvature---Riemann-&-Ricci-Tensors) | `python "_practice/scripts/8.7_riemann_ricci.py" --count 8 --seed 42` |
| 8.8_einstein_schwarzschild.py | [8.8 - Einstein Field Equations & Schwarzschild Black Holes](8.8---Einstein-Field-Equations-&-Schwarzschild-Black-Holes) | `python "_practice/scripts/8.8_einstein_schwarzschild.py" --count 8 --seed 42` |
