...
*Back to [Python Reference & Cheatsheets](Python-Reference-&-Cheatsheets) | Part of [09 - Learning Index](09---Learning-Index)*
...
Referenced in chapters via: `![python__1.5-fig1](python__1.5-fig1.svg)`
...
|---------------|-----------------|
| [Python Variables & Data Types](Python-Variables-&-Data-Types) | → 08.2 Core Language |
| [Python String Manipulation](Python-String-Manipulation) | → 08.2 Core Language |
| [Python Lists & Tuples](Python-Lists-&-Tuples) | → 08.2 Core Language |
| [Python Dictionaries & Sets](Python-Dictionaries-&-Sets) | → 08.2 Core Language |
| [List Comprehensions Deep Dive](List-Comprehensions-Deep-Dive) | → 08.2 / 08.3 Pythonic Idioms |
| [Python Conditionals & Logic](Python-Conditionals-&-Logic) | → 08.2 Core Language |
| [Python Loops & Iteration](Python-Loops-&-Iteration) | → 08.2 Core Language |
| [Python Functions Essentials](Python-Functions-Essentials) | → 08.2 / 08.3 Functions & OOP |
| [Python Error Handling](Python-Error-Handling) | → 08.5 Testing & Debugging |
| [Python File IO Essentials](Python-File-IO-Essentials) | → 08.6 Standard Library |
| [Working with APIs in Python](Working-with-APIs-in-Python) | → 08.6 / 08.11 Networks |
| [Common Algorithms for Coding Tests](Common-Algorithms-for-Coding-Tests) | → 08.13 Algorithms & DS |
| [Debugging Strategies for Coding Tests](Debugging-Strategies-for-Coding-Tests) | → 08.5 Testing & Debugging |
...
## Related Notes
- [LEARNING_PATH](LEARNING_PATH) - Shared curriculum/python focus
- [08.1 - Setup, Tooling & Project Structure](08.1---Setup,-Tooling-&-Project-Structure) - Same Python folder
- [08.10 - Operating Systems Essentials](08.10---Operating-Systems-Essentials) - Same Python folder
- [08.11 - Computer Networks Essentials](08.11---Computer-Networks-Essentials) - Same Python folder
- [08.12 - Computer Architecture - Performance Intuition](08.12---Computer-Architecture---Performance-Intuition) - Same Python folder
