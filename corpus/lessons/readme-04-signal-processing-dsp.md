...
> - **SVG diagrams** (small, theme-responsive, in-vault) → `../_svgs/dsp__32.x-fig1.svg` and embedded inline via `![dsp__32.x-fig1](dsp__32.x-fig1.svg)`.
...
- [04.1 - Signals, Systems & Sampling Theory](04.1---Signals,-Systems-&-Sampling-Theory)
- [04.2 - Fourier Series & Fourier Transform](04.2---Fourier-Series-&-Fourier-Transform)
- [04.3 - Discrete Fourier Transform & FFT](04.3---Discrete-Fourier-Transform-&-FFT)
- [04.4 - Digital Filters - FIR & IIR](04.4---Digital-Filters---FIR-&-IIR)
- [04.5 - Audio Signal Processing & Psychoacoustics](04.5---Audio-Signal-Processing-&-Psychoacoustics)
- [04.6 - Image Processing & 2D Transforms](04.6---Image-Processing-&-2D-Transforms)
- [04.7 - Speech & Voice Processing (ASR-TTS Foundations)](04.7---Speech-&-Voice-Processing-(ASR-TTS-Foundations))
- [04.8 - Spectral Analysis & Applications in AI](04.8---Spectral-Analysis-&-Applications-in-AI)
...
- Track 07 — Math & Physics (complex analysis prerequisite): [Subject_Plan](Subject_Plan)
- Track 21 — Electronics (ADC/DAC hardware): [Subject_Plan](Subject_Plan)
- Track 23 — Holographics (Fourier optics, angular spectrum): [Subject_Plan](Subject_Plan)
- Track 05 — AI Experiments (Whisper, XTTS applications): [Subject_Plan](Subject_Plan)
- Track 10 — AI & ML Systems (foundation model architecture): [Subject_Plan](Subject_Plan)
- Track 09 — VR & 3D (spatial audio, HRTF): [Subject_Plan](Subject_Plan)
- Track 22 — Robotics (sensor signal processing): [Subject_Plan](Subject_Plan)
