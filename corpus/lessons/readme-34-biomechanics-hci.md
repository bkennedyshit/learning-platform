---
title: "README — 34 - Biomechanics & HCI"
...
# 34 - Biomechanics & HCI — Subject Hub
...
```bash
cd "C:/Obsidian Vault/Bill's Vault/05-Knowledge_Foundation/09 - Learning/34 - Biomechanics & HCI"
...
- [34.1 - Kinematics of Human Movement](34.1---Kinematics-of-Human-Movement)
- [34.2 - Rotational Dynamics in Extreme Sports](34.2---Rotational-Dynamics-in-Extreme-Sports)
- [34.3 - Cardiovascular Bioenergetics & VO2 Max](34.3---Cardiovascular-Bioenergetics-&-VO2-Max)
- [34.4 - Autonomic Nervous System Telemetry - HRV](34.4---Autonomic-Nervous-System-Telemetry---HRV)
- [34.5 - Sensor Fusion - Accelerometers & Gyroscopes](34.5---Sensor-Fusion---Accelerometers-&-Gyroscopes)
- [34.6 - Human-Computer Interfaces - HCI Design](34.6---Human-Computer-Interfaces---HCI-Design)
- [34.7 - Building Bio-metric Software Applications](34.7---Building-Bio-metric-Software-Applications)
...
|---|---|---|
| 13.1_kinematics.py | [34.1 - Kinematics of Human Movement](34.1---Kinematics-of-Human-Movement) | `python "_practice/scripts/13.1_kinematics.py" --count 8 --seed 42` |
| 13.2_bmx_dynamics.py | [34.2 - Rotational Dynamics in Extreme Sports](34.2---Rotational-Dynamics-in-Extreme-Sports) | `python "_practice/scripts/13.2_bmx_dynamics.py" --count 8 --seed 42` |
| 13.3_vo2_max.py | [34.3 - Cardiovascular Bioenergetics & VO2 Max](34.3---Cardiovascular-Bioenergetics-&-VO2-Max) | `python "_practice/scripts/13.3_vo2_max.py" --count 8 --seed 42` |
| 13.4_hrv_analysis.py | [34.4 - Autonomic Nervous System Telemetry - HRV](34.4---Autonomic-Nervous-System-Telemetry---HRV) | `python "_practice/scripts/13.4_hrv_analysis.py" --count 8 --seed 42` |
| 13.5_sensor_fusion.py | [34.5 - Sensor Fusion - Accelerometers & Gyroscopes](34.5---Sensor-Fusion---Accelerometers-&-Gyroscopes) | `python "_practice/scripts/13.5_sensor_fusion.py" --count 8 --seed 42` |

---

## 📚 Source materials & references

_Pulled verbatim from `Subject_Plan.md §2 — Web-Verified Authoritative Learning Catalog`. Source of truth is the Subject_Plan; this section is a convenience copy._
