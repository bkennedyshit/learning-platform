...
|---|---|---|
| 3D modelling fundamentals | [Subject_Plan](Subject_Plan) | You already think in 3D space — this adds fabrication constraints |
| Architecture/AET background | Your degree | Drawing conventions, tolerances, construction-grade thinking already wired |
| Electronics basics | [Subject_Plan](Subject_Plan) | Understanding PCB form factors needed for enclosure design |
| Robotics | [Subject_Plan](Subject_Plan) | The mechanical subsystem of your robotics builds |
...
## Related Notes
- [33.1 - Engineering Drawing & GD&T](33.1---Engineering-Drawing-&-GD&T) - Shared tolerancing/maybe-tier focus
...
- [33.6 - Tolerancing, Fits & Assemblies](33.6---Tolerancing,-Fits-&-Assemblies) - Shared tolerancing/maybe-tier focus
- [33.7 - FreeCAD & Parametric Modelling](33.7---FreeCAD-&-Parametric-Modelling) - Shared maybe-tier/freecad focus
