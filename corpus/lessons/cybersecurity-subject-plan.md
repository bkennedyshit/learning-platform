...
This track is the **systems-level immune layer** for everything else in the vault. It feeds directly into the four-track 2026 stack: [20 - DevOps & SRE](Subject_Plan), [27 - System Design](Subject_Plan), and [21 - Cloud Platforms](Subject_Plan). It is the single most important prerequisite for shipping anything described in [BUILDING_AT_SCALE](BUILDING_AT_SCALE) — particularly its §5 on AI / LLM systems.
...
|---|---|---|
| Python fluency | [Subject_Plan](Subject_Plan) | Most security tooling, CTF scripts, and exploit PoCs are Python |
| Docker & containers | [1.9 - Docker & Containers](1.9---Docker-&-Containers) | Every cloud-native control surface lives at the container boundary |
| Operating systems | [1.10 - Operating Systems Essentials](1.10---Operating-Systems-Essentials) | Privilege boundaries, syscalls, capabilities, namespaces |
| Computer networks | [1.11 - Computer Networks Essentials](1.11---Computer-Networks-Essentials) | TLS, OSI layers, firewalls, DNS, BGP — the substrate of network security |
| SQL fundamentals | [Subject_Plan](Subject_Plan) | SQL injection, parameterized queries, row-level security |
| AI/ML systems | [Subject_Plan](Subject_Plan) | You cannot defend what you don't understand — required for 18.8 |
| Distributed systems | [1.16 - Distributed Systems & Multi-GPU Training](1.16---Distributed-Systems-&-Multi-GPU-Training) | Multi-tenant isolation, byzantine fault thinking |

---

## 🆓 Premium-Free Resource Catalog

> Pictures, videos, and reference materials live **outside the repo** — see [README](README) for the canonical link list. SVG diagrams that we author live inside `../_svgs/` with the `cyber__<ch>-fig<n>.svg` prefix.
...
## Related Notes
- [18.2 - OWASP Top 10 2025 Deep Dive](18.2---OWASP-Top-10-2025-Deep-Dive) - Shared cybersecurity/supply-chain focus
- [18.3 - Authentication, Authorization & Identity](18.3---Authentication,-Authorization-&-Identity) - Shared cybersecurity/identity focus
- [18.5 - Secure SDLC & Supply Chain](18.5---Secure-SDLC-&-Supply-Chain) - Shared cybersecurity/supply-chain focus
- [18.8 - AI Security & Adversarial ML](18.8---AI-Security-&-Adversarial-ML) - Shared prompt-injection/adversarial-ml focus
