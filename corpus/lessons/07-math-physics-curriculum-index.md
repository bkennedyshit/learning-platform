...
All notes follow the rules established in `[AGENT_MANUAL](AGENT_MANUAL)`:
...
| # | Subject | Status |
|---|---|---|
| 01 | [Mathematical Foundations & Calculus]() | ✅ Complete (Chs 1.1–1.8 + practice scripts) |
| 02 | [Linear Algebra & Matrix Theory]() | ✅ Complete (Chs 2.1–2.8 + practice scripts) |
| 03 | [Ordinary & Partial Differential Equations]() | ✅ Complete (Chs 3.1–3.8 all ≥30 KB + practice scripts) |

## ⚛️ Classical & Modern Physics

| # | Subject | Status |
|---|---|---|
| 04 | [Classical Mechanics & Dynamical Systems]() | ✅ Complete (Chs 4.1–4.8 all ≥30 KB + practice scripts) |
| 05 | [Thermodynamics & Statistical Mechanics]() | ✅ Complete (Chs 5.1–5.8 all ≥30 KB + practice scripts) |
| 06 | [Fluid Dynamics & Continuum Mechanics]() | ✅ Complete (Chs 6.1–6.8 all ≥30 KB + practice scripts) |
| 07 | [Electrodynamics & Classical Field Theory]() | ✅ Complete (Chs 7.1–7.8 all ≥30 KB + practice scripts) |
| 08 | [Special & General Relativity]() | ✅ Complete (Chs 8.1–8.8 all ≥30 KB + practice scripts) |
| 09 | [Quantum Mechanics & Quantum Field Theory]() | ✅ Complete (Chs 9.1–9.8 all ≥30 KB + practice scripts) |

## 🚀 Mathematical Engineering

| # | Subject | Status |
|---|---|---|
| 10 | [Aerospace Engineering & Orbital Mechanics]() | ✅ Complete (Chs 10.1–10.7 all ≥30 KB + practice scripts) |
| 11 | [Control Theory & Systems Engineering]() | ✅ Complete (Chs 11.1–11.8 all ≥30 KB + practice scripts) |
| 12 | [Solid Mechanics & Materials Science]() | ✅ Complete (Chs 12.1–12.7 all ≥30 KB + practice scripts) |

---

## 🛠️ Local C++ Computational Tools

These chapter notes are designed to be paired with hands-on numerical experimentation through the local Qt/C++ tools located at `[00 - Learning_Tools](00---Learning_Tools)`:
...
## Related Notes
- [Subject_Plan](Subject_Plan) - Shared mathematics/learning focus
- [AGENT_MANUAL](AGENT_MANUAL) - Shared mathematics/learning focus
- [SVG_TEMPLATES](SVG_TEMPLATES) - Shared mathematics/learning focus
- [00 - MAT-111_Technical_Mathematics Index](00---MAT-111_Technical_Mathematics-Index) - Related mathematics topic
- [4495-Physics-and-Electronics-Formulas](4495-Physics-and-Electronics-Formulas) - Related learning topic
