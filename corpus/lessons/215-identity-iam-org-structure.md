...
- [21.2 - Compute Primitives](21.2---Compute-Primitives) — workloads consuming the IAM
- [21.4 - Networking, DNS & CDN](21.4---Networking,-DNS-&-CDN) — zero-trust, the other half of the perimeter
- [21.6 - Cost Optimization](21.6---Cost-Optimization) — IAM enables billing-account separation, which is the foundation of FinOps
- [21.8 - The Indie & Solo Cloud Stack](21.8---The-Indie-&-Solo-Cloud-Stack) — applied IAM for solo founders
- [Subject_Plan](Subject_Plan) — broader threat-model context
...
*Next: [21.6 - Cost Optimization](21.6---Cost-Optimization) — Spot, savings plans, autoscaling, and the FinOps maturity ladder.*
