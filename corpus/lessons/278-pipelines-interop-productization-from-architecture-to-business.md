...
6. **Build Vision Pro app** in RealityKit ([→ ch 24 VR track](Subject_Plan)).
...
- [Subject_Plan](Subject_Plan) — applied immersive
- [Subject_Plan](Subject_Plan) — volumetric end-points
- [Subject_Plan](Subject_Plan) — URDF + mech CAD ties
- [9.6 - AEC to VR Pipelines - BIM Data](9.6---AEC-to-VR-Pipelines---BIM-Data) — math/engineering side of the same pipeline
...
*Subject capstone complete. Continue to [30 - Electronics](Subject_Plan) for the bridge into hardware → robotics.*
