...
- [30.3 - Semiconductors - Diodes, BJTs, MOSFETs, Op-Amps](30.3---Semiconductors---Diodes,-BJTs,-MOSFETs,-Op-Amps)
- [30.4 - Digital Logic & Boolean Algebra - Gates, Flip-Flops, FSMs](30.4---Digital-Logic-&-Boolean-Algebra---Gates,-Flip-Flops,-FSMs)
- [30.5 - Microcontrollers & Embedded Systems - Arduino, ESP32, RP2040, STM32](30.5---Microcontrollers-&-Embedded-Systems---Arduino,-ESP32,-RP2040,-STM32)
- [30.6 - Motherboards & Computer Architecture - CPU, RAM, Chipset, PCIe, UEFI](30.6---Motherboards-&-Computer-Architecture---CPU,-RAM,-Chipset,-PCIe,-UEFI)
- [30.7 - Power Electronics & Motor Drivers - PWM, H-Bridges, BLDC, Regulators](30.7---Power-Electronics-&-Motor-Drivers---PWM,-H-Bridges,-BLDC,-Regulators)
- [30.8 - From Electronics to Robotics - I2C, SPI, UART, CAN, Sensors & Actuators](30.8---From-Electronics-to-Robotics---I2C,-SPI,-UART,-CAN,-Sensors-&-Actuators)
...
- Direct downstream: [32 - Robotics](Subject_Plan)
- Hardware-side of holographic displays: [Subject_Plan](Subject_Plan)
- VR hardware understanding: [Subject_Plan](Subject_Plan)
- Foundations: [Subject_Plan](Subject_Plan)
