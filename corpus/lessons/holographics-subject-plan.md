...
- Builds on [Math/Phys 07 — Electrodynamics](Subject_Plan) and [QM](Subject_Plan) for wave physics.
- Provides asset workflows for [27 - 3D Modelling](Subject_Plan) (volumetric capture, USD pipelines).
- Feeds [29 - VR](Subject_Plan) (holography vs traditional stereoscopic VR).
...
|---|---|---|
| Calculus + Fourier | [Subject_Plan](Subject_Plan) | Diffraction = Fourier transform of aperture |
| Linear algebra | [Subject_Plan](Subject_Plan) | SLMs are pixel matrices; Jones / Mueller calculus |
| ODEs / PDEs | [Subject_Plan](Subject_Plan) | The wave equation underneath |
| Electrodynamics | [Subject_Plan](Subject_Plan) | Maxwell → optics |
| QM (light + matter) | [Subject_Plan](Subject_Plan) | Photons, coherence |
| 3D math + rendering pipeline | [Subject_Plan](Subject_Plan) | Light fields = generalized rendering |
| Python | [Subject_Plan](Subject_Plan) | NumPy + PyTorch for CGH |
| Electronics | [Subject_Plan](Subject_Plan) | SLM driver electronics |
...
## Related Notes
- [31.5 - Light-Field Displays & Volumetric Capture - Looking Glass, NeRF, 3D Gaussian Splatting](31.5---Light-Field-Displays-&-Volumetric-Capture---Looking-Glass,-NeRF,-3D-Gaussian-Splatting) - Shared looking-glass/holographics focus
- [31.6 - Holographic AR - HoloLens, Magic Leap, Waveguides & the Marketing-vs-Physics Gap](31.6---Holographic-AR---HoloLens,-Magic-Leap,-Waveguides-&-the-Marketing-vs-Physics-Gap) - Shared holographics/magic-leap focus
- [LEARNING_PATH](LEARNING_PATH) - Shared holographics/light-field focus
- [31.1 - Optics Foundations - Interference, Diffraction, Coherence, Fourier Optics](31.1---Optics-Foundations---Interference,-Diffraction,-Coherence,-Fourier-Optics) - Shared holographics/optics focus
