---
title: "README — 11 - Discrete Mathematics"
...
# 11 - Discrete Mathematics — Subject Hub
...
```bash
cd "Subjects/11 - Discrete Mathematics"
...
- [11.1 - Propositional Logic](11.1---Propositional-Logic)
- [11.2 - Predicate Logic & Proof Techniques](11.2---Predicate-Logic-&-Proof-Techniques)
- [11.3 - Sets, Functions & Relations](11.3---Sets,-Functions-&-Relations)
- [11.4 - Combinatorics & Counting](11.4---Combinatorics-&-Counting)
- [11.5 - Probability & Discrete Distributions](11.5---Probability-&-Discrete-Distributions)
- [11.6 - Number Theory & Cryptography](11.6---Number-Theory-&-Cryptography)
- [11.7 - Graph Theory](11.7---Graph-Theory)
- [11.8 - Automata & Formal Languages](11.8---Automata-&-Formal-Languages)
