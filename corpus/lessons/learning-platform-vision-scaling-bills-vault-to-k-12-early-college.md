...
*Part of [Learning Index](00---09---Learning-Index) · Companion to [BUILDING_AT_SCALE.md](BUILDING_AT_SCALE)*
...
- **AI study companion** — per-chapter AI tutor that can answer questions about the chapter content, generate additional examples, quiz the learner Socratically (using the chapter note as context for a RAG pipeline — see [Track 10.5 Transformers](10.5---Transformer-Architectures-&-LLMs))
- **Mobile app** — Flutter/Dart (see [Track 22.5 Flutter](8.5---Flutter-&-Dart---Widget-Tree,-Isolates-&-Custom-Painters)) — offline-first; download chapters for offline study; daily drill notifications
...
Vault markdown files
  ...
  - Convert [wikilinks](wikilinks) → relative URLs
...
- [BUILDING_AT_SCALE.md](BUILDING_AT_SCALE) — engineering architecture for production-grade systems; the technical foundation for Tier 2–3
- [Learning Master Index](00---09---Learning-Index) — the full curriculum that becomes the product
- [Track 10.5 Transformers](10.5---Transformer-Architectures-&-LLMs) — technical foundation for the AI study companion
- [Track 22.5 Flutter](8.5---Flutter-&-Dart---Widget-Tree,-Isolates-&-Custom-Painters) — mobile app foundation
- [Track 19 System Design](Subject_Plan) — architecture for Tier 2–3 backend
- [Track 20 Business](Subject_Plan) — GTM strategy, pricing, fundraising
