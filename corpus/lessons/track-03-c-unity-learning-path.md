...
|-------------|-----------------|--------------|
| Python comfort (OOP, generators, decorators) | [08.3 - OOP, Data Models & Pythonic Idioms](08.3---OOP,-Data-Models-&-Pythonic-Idioms) | Can you write a `@dataclass` with custom `__eq__`? |
| Basic game dev concepts (game loop, ECS idea) | Track 04 — Game Development | Know what Update() vs FixedUpdate() means? |
| Git fundamentals | [git_cheatsheet](git_cheatsheet) | Can you branch, merge, resolve conflicts? |
...
- [28.5 - Game Engine Architectures - Unity & Unreal](28.5---Game-Engine-Architectures---Unity-&-Unreal) — Engine lifecycle context
...
- [26.6 - Multiplayer & Networking](26.6---Multiplayer-&-Networking) — Game networking theory
- [08.13 - Algorithms & Data Structures in Python](08.13---Algorithms-&-Data-Structures-in-Python) — Data structure parallels
- [C# Basics for Unity](C#-Basics-for-Unity) — Quick-reference cheatsheet
...
## Related Notes
- [Subject_Plan](Subject_Plan) - Shared game-dev/csharp focus
...
- [10.3 - OOP & Design Patterns](10.3---OOP-&-Design-Patterns) - Shared csharp/unity focus
