...
1. **[13 - TypeScript](13---TypeScript)** — Add type safety to everything you've learned (natural next step)
2. **[Track 08 App Architectures](Track-08-App-Architectures)** — Deep framework mastery (React hooks, Next.js, Vue Composition API)
3. **[10 - AI & ML Systems](10---AI-&-ML-Systems)** — Use JS/TS for AI tooling (LangChain.js, Vercel AI SDK)
...
## Related Notes
- [Subject_Plan](Subject_Plan) - Shared javascript/curriculum focus
- [12.2 - Core Language - ES2024+, Closures, Prototypes](12.2---Core-Language---ES2024+,-Closures,-Prototypes) - Shared javascript/es2024 focus
- [JavaScript Essentials for Coding Tests](JavaScript-Essentials-for-Coding-Tests) - Same JavaScript folder
- [12.1 - Setup, Runtime & Tooling](12.1---Setup,-Runtime-&-Tooling) - Same JavaScript folder
- [12.3 - Async - Promises, Async_Await, Event Loop](12.3---Async---Promises,-Async_Await,-Event-Loop) - Same JavaScript folder
